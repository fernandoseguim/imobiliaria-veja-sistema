...
<form name="doublecombo"  onSubmit="return isValidDigitNumber(this);" method="post" action="atualizar_permuta22.asp?varCodPermuta=<%=varCodPermuta%>"><table width="590" border="0" cellspacing="0" cellpadding="0"> 
  ...
  <tr>
    <td width="590" height="120"><div align="center"><img src="simbol_permuta02.jpg"></img></div></td>
  </tr>
  
  
  <tr>
      <td width="590" height="50">
<div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong><a href="imprimir_permuta22.asp?varCodPermuta=<%=varCodPermuta%>" style="color:#FFFFFF">Visualizar 
...
rs444Imovel.ActiveConnection = Conexao3
	...
	if  not rs444Imovel.eof then
				...
				While not rs444Imovel.eof  
				  %>
                    <div align="center"><a href="javascript:newWindow444('visualizar_imovel22.asp?varCod_imovel=<%=rs444Imovel("cod_imovel")%>')"><img src="bt_foto22imovel.jpg" width="290" height="18" border="0"></a></div>
...
rs444Comprador.ActiveConnection = Conexao3
	...
	if  not rs444Comprador.eof then
				  ...
				  %>
					...
					<div align="center"><a href="javascript:newWindow555('visualizar_compradores22.asp?varCodCompradores=<%=rs444Comprador("cod_compradores")%>')"><img src="bt_foto22Compr.jpg" width="290" height="18" border="0"></a></div>
        ...
        <tr>
          ...
          <td><table width="580" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
                      ...
                      <td height="18" bgcolor="<%=claro%>" style="border:1px solid #FFFFFF;"><input name="" type="text" class="inputBox" id="" style="HEIGHT: 18px; WIDTH: 290px; background:<%=claro%>;" value="<%if rs9("dataLastEmail") <> "" then response.write rs9("dataLastEmail") else response.write "não informado" end if%>" size="38" maxlength="50" align="left"></td>
              </tr>
			   ...
			   <tr>
                      ...
                      <td height="18" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><textarea name="" class="inputBox" id="" style="HEIGHT: 100px; WIDTH: 290px; background:<%=medio%>; " onKeyPress="return limitfield(this, 800)"><%if rs9("textoLastEmail") <> "" then response.write rs9("textoLastEmail") else response.write "não informado" end if%></textarea></td>
              </tr>   
			  ...
			  <tr>
                      <td bgcolor="<%=claro%>" style="border:1px solid #FFFFFF;"> 
                        <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Valor 
                          do im&oacute;vel atual</font></div></td>
                  <td bgcolor="<%=claro%>" style="border:1px solid #FFFFFF;"><font color="#FFFFFF">
                          <input name="txt_valor_vend" type="text" class="inputBox" id="txt_valor_vend" style="HEIGHT: 18px; WIDTH: 150px; background:<%=claro%>" value="<%=FormatNumber(rs9("valor_vend"),2)%>" size="12" maxlength="13">
                    </font></td>
              </tr>
                <tr> 
                      <td bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"> 
...
%>
			  ...
			  <tr>
				...
				<tr>
                  ...
                  <td bgcolor="<%=claro%>" style="border:1px solid #FFFFFF;"><font color="#FFFFFF">
                          <input name="txt_valor_comp" type="text" class="inputBox" id="txt_valor_comp" style="HEIGHT: 18px; WIDTH: 150px; background:<%=claro%>" value="<%=FormatNumber(rs9("valor_comp"),2)%>" size="12" maxlength="13">
                    </font> </td>
              </tr>
