...
SQL = "Select email.cod_email,email.nome,email.email,email.assunto,email.mensagem,email.data,email.cod_imovel,email.telefone,email.clique,email.atendimento,email.origem,email.origem_franquia from email where origem_franquia like '"&session("vOrigem_Franquia")&"'  ORDER BY cod_email DESC"
else

SQL = "select email.cod_email,email.nome,email.email,email.assunto,email.mensagem,email.data,email.cod_imovel,email.telefone,email.clique,email.atendimento,email.origem,email.origem_franquia  from email where origem_franquia like '"&session("vOrigem_Franquia")&"' and  "
