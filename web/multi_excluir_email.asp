...
<%
Dim Conexao,strSQL,rs,varCod_email,vcheck01,SearchFor



SearchFor = request.Querystring("SearchFor")
 varCod_email = request.form("varCod_email")
 vcheck01 = request.form("check01")                                                           
	
	if varCod_email = "" and vcheck01 = "" then
	response.Redirect "archive_email.asp?SearchFor="&SearchFor&""
	end if														  
	...
	Conexao.execute"delete from email where cod_email in ("& request.form("check01") &")"
