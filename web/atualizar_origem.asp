...
vOrigem = request.form("txt_origem")
	...
	Conexao.Open dsn
	 ...
	 Conexao.execute"update origem set origem='"&vOrigem&"' where id_origem="&varCodOrigem
	 
	
	  response.Redirect "visualizar_origem.asp?varSucessoOrigem="&vOrigem&"&varCodOrigem="&varCodOrigem&""
