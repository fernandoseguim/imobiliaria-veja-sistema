...
<div align="center"><font color="<%=escuro%>" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Para 
        verificar se existem permutantes indicados para voc&ecirc;, digite seu 
...
<form action="acessoLink01.asp" onSubmit="return isValidDigitNumber(this);" Method="Post" name="doublecombo">
...
<tr>
            <td width="280" align="center" bgcolor="<%=claro%>"> 
