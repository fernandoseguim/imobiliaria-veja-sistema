...
Conexao.execute"Insert into imoveis(proprietario)values('"& vProprietario &"')"	 
...
dim ConexaoPermuta
 ...
 SQLImovel = "select * from imoveis ORDER BY cod_imovel ASC" 
	...
	if vPergunta = "sim" then
	 ...
	 Conexao.execute"update imoveis set cod_permuta='"&varCodPermuta555&"',cod_comprador='"&varCodComprador &"' where cod_imovel="&varCodImovel444
	 
	 
	 Conexao.execute"update compradores set cod_imovel='"&varCodImovel444&"',cod_permuta='"&varCodPermuta555&"' where cod_compradores="&varCodComprador
	 
	 
	  
	 Conexao.execute"update permuta set cod_imovel='"&varCodImovel444&"',cod_comprador='"&varCodComprador&"' where cod_permuta="&varCodPermuta555
