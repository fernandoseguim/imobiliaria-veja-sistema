...
vAssunto_ligar_urgente = " Um imóvel foi incluído e gerou uma indicação para esse cliente , ligue para ele  imediatamente."
...
if rs444Ultimo22("cidade") <> "qualquer um" and rs444Ultimo22("cidade") <> "não informado" and  rs444Ultimo22("cidade") <> ""  then
...
if rs444Ultimo22("bairro") <> "qualquer um" and rs444Ultimo22("bairro") <> "não informado" and rs444Ultimo22("bairro") <> "" then
...
if rs444Ultimo22("tipo") <> "qualquer um" and rs444Ultimo22("tipo") <> "tqualquer" and rs444Ultimo22("tipo") <> "" then
...
if  rs444Ultimo22("negociacao") <> "qualquer um" and rs444Ultimo22("negociacao") <> "" then
stringNegociacao2 = " and negociacao='"&vNegocio&"'"
else
stringNegociacao2 = ""
end if
...
if  rs444Ultimo22("quartos") <> 0 and rs444Ultimo22("quartos") <> "" then
...
if  rs444Ultimo22("vagas") <> 0 and rs444Ultimo22("vagas") <> "" then
...
dim strSQL444
	...
	strSQL444 = "SELECT compradores.cod_compradores,compradores.email  FROM compradores"&stringIndex2&stringCidade2&stringBairro2&stringTipo2&stringNegociacao2&stringQuartos2&stringVagas2&stringValor2&stringStandby
	...
	varMensagem = "Nosso banco de dados automático encontrou um imóvel que tem as características que você deseja, clique no link abaixo e veja se corresponde ao que você está procurando:<br>"&"http://www.imobiliariaveja.com.br/mostrar_imovel2.asp?varCodimovel="&rs444Ultimo22("cod_imovel")&""
	
	
	dim RsAutomatico
	
	 Set RsAutomatico = Server.CreateObject("ADODB.RecordSet")
	 
	
	 
		
RsAutomatico.CursorLocation = 3
'a propriedade CursorLocation do objeto recordset indica onde o cursor é criado
'se no cliente ou no servidor.

RsAutomatico.CursorType = 3
'indica o tipo de cursor utilizado, se somente de leitura ou se de leitura e gravação.
 
	 
	 RsAutomatico.Open strSQL444,Conexao 
	
	dim Mailer
	dim varParaTeste
	
	do while not RsAutomatico.eof 

varParaTeste = RsAutomatico("email")
 Set Mailer = Server.CreateObject("SMTPsvg.Mailer")
Mailer.FromName = "Imobiliária Veja"
Mailer.FromAddress= LCase(session("nome_id"))&"imobiliariaveja.com.br"
Mailer.RemoteHost = "smtp2.locaweb.com.br"
Mailer.AddRecipient "Imobiliária Veja", varParaTeste
Mailer.Subject = "Indicação de imóvel"
Mailer.BodyText = "Ligue para a Imobiliária Veja, pois acabou de chegar um imóvel para você!"
If Mailer.SendMail Then
Response.Write "<br><br><center><strong><font color='#FFFFFF' size='2' face='Verdana, Arial, Helvetica, sans-serif'>Mensagem enviada para "&RsAutomatico("email")&"</font> </strong></center>"
Else
Response.Write "<br><br><center><strong><font color='#FFFFFF' size='2' face='Verdana, Arial, Helvetica, sans-serif'>"&"Erro " & Mailer.Response & "</font> </strong></center>"
End If

Set Mailer = Nothing
 
 RsAutomatico.movenext
loop
...
'Mailer.FromAddress= LCase(session("nome_id"))&"imobiliariaveja.com.br"
'Mailer.RemoteHost = "smtp2.locaweb.com.br"
'Mailer.AddRecipient "Imobiliária Veja", RsAutomatico("email")
'Mailer.Subject = "Indicação de imóvel"
'Mailer.BodyText = "Ligue para a Imobiliária Veja, pois acabou de chegar um imóvel para você!"
'If Mailer.SendMail Then
'Response.Write "<br><br><center><strong><font color='#FFFFFF' size='2' face='Verdana, Arial, Helvetica, sans-serif'>Mensagem enviada para "&RsAutomatico("email")&"</font> </strong></center>"
