...
<form method="post" action="imovel_proposta_incluir.asp?varCodImovel=<%=varCodImovel%>" onSubmit="return isValidDigitNumber(this);" name="b2">
  ...
  <tr>
    <td width="590" height="170"><table width="590" height="170" border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="580" height="170"><table width="580" height="170" border="0" cellpadding="0" cellspacing="0" style="border:1px solid #FFFFFF;">
              <tr>
                <td width="290" height="170" bgcolor="#f7ecbf"></td>
                <td width="290" height="170" bgcolor="<%=claro%>"><% If objFSO.FileExists(Server.MapPath(rs("foto_grande"))) = True Then%><img src="<%=rs("foto_grande")%>" width="290" height="170"></img><% else %><div align="center"><font color="#9d9249" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Foto 
            ...
            <td width="5" height="170" bgcolor="#f7ecbf">&nbsp;</td>
        </tr>
      </table></td>
  </tr>
  <tr>
              ...
              <tr bgcolor="355A63"> 
                ...
                <td width="290" bgcolor="#f7ecbf" height="18"> 
                  <div align="center">
                      ...
                      <option value="Permutar imóvel">Permutar um imóvel</option>
                    </select>
                  </div></td>
              </tr>
            </table></td>
                      ...
                      <tr> 
                        <td width="290" height="18" bgcolor="<%=claro%>" style="border:1px solid #FFFFFF; border-right:2px solid #FFFFFF;"> 
                          <div align="center"><font color="#9d9249" size="1" face="Verdana, Arial, Helvetica, sans-serif">Informe 
                            o dia e a hora para a visita ao im&oacute;vel</font></div></td>
                    </tr>
                    <tr> 
