...
if (doublecombo.stage22.value == "0,00") {
        alert("Você precisa informar o valor que o cliente deseja!");
...
if (doublecombo.txt_condominio.value == "") {
        alert("Você precisa informar qual o valor do condomínio desejado!");
...
<form name="doublecombo"  onSubmit="return isValidDigitNumber(this);" method="post" action="incluir_compradores33.asp">
<table width="1000" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    <td><table width="1000" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="192" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><input name="txt_data_futuro_contato_comprador" type="text" class="inputBox" id="txt_data_futuro_contato_comprador" style="HEIGHT: 18px; WIDTH: 190px; background:<%=medio%>" value="<%=now()%>" size="38" maxlength="50" align="left"></td>
          <td width="10">&nbsp;</td>
          <td width="798" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><input name="txt_assunto_futuro_contato_comprador" type="text" class="inputBox" id="txt_assunto_futuro_contato_comprador" style="HEIGHT: 18px; WIDTH: 760px; background:<%=medio%>" size="38" maxlength="50" align="left"></td>
  ...
  <tr> 
	...
	<tr> 
          <td width="192" bgcolor="<%=escuro%>"><font color="<%=letra%>" size="1" face="Verdana, Arial, Helvetica, sans-serif">C&oacute;digo 
        ...
        <tr> 
          ...
          <td width="10">&nbsp;</td>
            <td width="192" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><select name="txt_ocupacao" id="txt_ocupacao" class="inputBox" style="HEIGHT: 18px; WIDTH: 190px; background:<%=medio%>">
                ...
                <option value="ocupado pelo proprietário">Ocupado por pelo proprietário</option>
              </select></td>
        </tr>
        <tr> 
        ...
        <tr> 
            <td width="192" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><input name="txt_proprietario_vend" type="text" id="txt_proprietario_vend2" size="38" maxlength="50" align="left" class="inputBox" style="HEIGHT: 18px; WIDTH: 190px; background:<%=medio%>"></td>
          <td width="10">&nbsp;</td>
            <td width="192" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><input name="txt_telefone_vend" type="text" id="txt_telefone_vend2" size="38" maxlength="20" align="left" class="inputBox" style="HEIGHT: 18px; WIDTH: 190px; background: <%=medio%>"></td>
          <td width="10">&nbsp;</td>
            <td width="192" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><input name="txt_telefone03_vend" type="text" id="txt_telefone03_vend2" size="38" maxlength="20" align="left" class="inputBox" style="HEIGHT: 18px; WIDTH: 190px; background: <%=medio%>"></td>
          <td width="10">&nbsp;</td>
            <td width="192" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><input name="txt_telefone02_vend" type="text" id="txt_telefone02_vend2" size="38" maxlength="20" align="left" class="inputBox" style="HEIGHT: 18px; WIDTH: 190px; background: <%=medio%>"></td>
          <td width="10">&nbsp;</td>
            <td width="192" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><input name="txt_email_vend" type="text" id="txt_email_vend2" size="38" maxlength="50" align="left" class="inputBox" style="HEIGHT: 18px; WIDTH: 190px ; background:<%=medio%>"></td>
        </tr>
        <tr> 
        ...
        <tr> 
          ...
          <td width="10">&nbsp;</td>
          <td width="192" bgcolor="<%=medio%>" valign="top" style="border:1px solid #FFFFFF;"><select name="txt_tipo"  size="8" multiple class="inputBox" id="txt_tipo" style="HEIGHT: 130px; WIDTH: 190px; background: <%=medio%>" >
  ...
  <tr> 
        ...
        <tr> 
          ...
          <td width="10">&nbsp;</td>
            <td width="192" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><input name="txt_condominio" type="text" class="inputBox" id="txt_condominio" style="HEIGHT: 18px; WIDTH: 190px; background:<%=medio%>" value="0,00" size="12" maxlength="50"></td>
          <td width="10">&nbsp;</td>
    ...
    <td><table width="1000" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="495" height="224" bgcolor="<%=medio%>" ><table width="495" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="102" style="border:1px solid #FFFFFF;"><textarea name="txt_obs_forma_pagamento_comp" cols=20 rows=10 class="inputBox" id="fdfdfd" style="HEIGHT: 100px; WIDTH: 493px; background:<%=medio%>" onKeyPress="return limitfield(this, 800)"></textarea></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td height="102" style="border:1px solid #FFFFFF;"><textarea name="txt_descricao_confi" class="inputBox" id="txt_descricao_confi" style="HEIGHT: 100px; WIDTH: 493px; background:<%=medio%>" onKeyPress="return limitfield(this, 800)"></textarea></td>
                </tr>
              </table> 
            </td>
          <td width="10">&nbsp;</td>
          <td width="495" height="80" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><textarea name="txt_descricao" COLS=20 ROWS=10 class="inputBox" id="txt_descricao" style="HEIGHT: 222px; WIDTH: 493px; background:<%=medio%>" onKeyPress="return limitfield(this, 800)"></textarea></td>
        </tr>
      </table></td>
  </tr>
  ...
  <tr> <td height="300"><div align="center">
    ...
    <td><table width="1000" border="0" cellspacing="0" cellpadding="0">
        <tr> 
            <td width="192" ><font color="<%=letra%>" size="1" face="Verdana, Arial, Helvetica, sans-serif">Data 
              futuro contato</font></td>
          <td width="10">&nbsp;</td>
            <td width="798" ><font color="<%=letra%>" size="1" face="Verdana, Arial, Helvetica, sans-serif">Assunto 
              futuro contato</font></td>
  ...
  <tr> 
    <td> <table width="1000" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          ...
          <td width="10">&nbsp;</td>
          <td width="192" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><input name="txt_data_captacao" type="text" class="inputBox" id="txt_data_captacao" style="HEIGHT: 18px; WIDTH: 190px; background:<%=medio%>" value="<%=now()%>" size="38" maxlength="50" align="left"></td>
          <td width="10">&nbsp;</td>
          <td width="192" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><input name="txt_origem_captacao_vend" value="" type="text" id="txt_origem_captacao_vend" size="38" maxlength="50" align="left" class="inputBox" style="HEIGHT: 18px; WIDTH: 190px; background:<%=medio%>"></td>
        </tr>
        <tr> 
  ...
  <tr> 
    <td> <table width="1000" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          ...
          <td width="10">&nbsp;</td>
          <td width="192" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><input name="txt_condominio_vend" type="text" class="inputBox" id="txt_condominio_vend" style="HEIGHT: 18px; WIDTH: 190px; background:<%=medio%>" value="0,00" size="12" maxlength="50"></td>
          <td width="10">&nbsp;</td>
        ...
        <tr> 
          ...
          <td width="10">&nbsp;</td>
            <td width="192" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><input name="txt_nome_edificio_vend" type="text" class="inputBox" id="txt_nome_edificio_vend" style="HEIGHT: 18px; WIDTH: 190px; background: <%=medio%>" size="12" maxlength="50"></td>
        </tr>
      </table></td>
  </tr>
  ...
  <tr> 
    <td><table width="1000" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="495" height="224" bgcolor="<%=medio%>" ><table width="495" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="102" style="border:1px solid #FFFFFF;"><textarea name="txt_obs_forma_pagamento_vend" class="inputBox" id="textarea4" style="HEIGHT: 100px; WIDTH: 493px; background:<%=medio%>" onKeyPress="return limitfield(this, 800)"></textarea></td>
                </tr>
                <tr>
                  <td height="20" bgcolor="<%=escuro%>"><font color="<%=letra%>" size="1" face="Verdana, Arial, Helvetica, sans-serif">Observa&ccedil;&otilde;es 
                ...
                <tr>
                  <td height="102" style="border:1px solid #FFFFFF;"><textarea name="txt_obs_proprietario_vend" class="inputBox" id="txt_obs_proprietario_vend" style="HEIGHT: 100px; WIDTH: 493px; background:<%=medio%>" onKeyPress="return limitfield(this, 800)"></textarea></td>
                </tr>
              </table></td>
          <td width="10">&nbsp;</td>
            <td width="495" height="80" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><textarea name="txt_obs_imovel_vend" class="inputBox" id="txt_obs_imovel_vend" style="HEIGHT: 222px; WIDTH: 493px; background:<%=medio%>" onKeyPress="return limitfield(this, 800)"></textarea></td>
        </tr>
      </table></td>
  </tr>
...
<div align="center"> 
  ...
  <tr>
    <td width="145"><input name="image" type="image"  src="bt_enviar0011.jpg" width="145" height="18" border="0"></td>
