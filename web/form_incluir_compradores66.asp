...
if (doublecombo.txt_quartos.value == "00" || doublecombo.txt_quartos.value == "") {
...
<table width="1000" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    <td><table width="1000" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="192" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><input name="txt_data_futuro_contato_vend" type="text" class="inputBox" id="txt_data_futuro_contato_vend" style="HEIGHT: 18px; WIDTH: 190px; background:<%=medio%>" value="0/0/2007 00:00:00" size="38" maxlength="50" align="left"></td>
          <td width="10">&nbsp;</td>
  ...
  <tr> 
    <td> <table width="1000" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          ...
          <td width="10">&nbsp;</td>
          <td width="192" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><input type="text" class="inputBox" style="HEIGHT: 18px; WIDTH: 190px; background:<%=medio%>" value="n&atilde;o informado"  size="38" maxlength="50" align="left"></td>
          <td width="10">&nbsp;</td>
          <td width="192" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><input type="text" class="inputBox" style="HEIGHT: 18px; WIDTH: 190px; background:<%=medio%>" value="<%=now()%>" size="38" maxlength="50" align="left"></td>
          <td width="10">&nbsp;</td>
