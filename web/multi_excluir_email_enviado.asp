...
<%
Dim Conexao,strSQL,rs,varCod_email_enviado,vcheck01,SearchFor
dim page

page = request.querystring("page")
SearchFor = request.Querystring("SearchFor")
 varCod_email_enviado = request.form("varCod_email_enviado")
 vcheck01 = request.form("check01")                                                           
	
	if varCod_email_enviado = "" and vcheck01 = "" then
	response.Redirect "archive_email_enviado.asp?SearchFor="&SearchFor&""
	end if														  
	...
	Conexao.execute"delete from email_enviado where cod_email_enviado in ("& request.form("check01") &")"
