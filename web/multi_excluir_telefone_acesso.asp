...
SearchFor = request.Querystring("SearchFor")
 varCod_telefone_acesso = request.form("varCod_telefone_acesso")
 vcheck01 = request.form("check01")
 
 if varCod_telefone_acesso = "" and vcheck01 = "" then
 response.Redirect "archive_telefone_acesso.asp?SearchFor="&SearchFor&""
	...
	Conexao.execute"delete from telefone_acesso where cod_telefone_acesso in ("& request.form("check01") &")"
