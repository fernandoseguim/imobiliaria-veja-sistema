...
//------------------------------acertar valor do imóvel---------------------



if (doublecombo.txt_valor_vend.value == "0,00" && doublecombo.txt_pergunta.value == "sim" ) {
        alert("O formulário valor do seu imóvel precisa ter um valor!");
        doublecombo.txt_valor_vend.focus();
		doublecombo.txt_valor_vend.select();
        return false;
    }
...
{
alert("O formulário valor do seu imóvel só pode conter números!");
doublecombo.txt_valor_vend.focus();
doublecombo.txt_valor_vend.select();
return false;
}
...
<table width="590" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td width="590" height="50"><div align="center"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Essa é a ficha de atualização de compradores</strong></font></div></td>
  </tr>
...
<%end if%>
			  ...
			  <tr>
                  ...
                  <td height="20" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><input name="" value="<%if rs9("quem_atualizou") <> "" then response.write rs9("quem_atualizou") else response.write "não informado" end if%>" type="text" id="txt_responsavel_cadastramento_comprador" size="38" maxlength="50" align="left" class="inputBox" style="HEIGHT: 18px; WIDTH: 290px; background:<%=medio%>"></td>
              </tr>
			 ...
			 <tr>
                  ...
                  <td height="20" bgcolor="<%=claro%>" style="border:1px solid #FFFFFF;"><input name="txt_responsavel_cadastramento_comprador" value="<%if rs9("responsavel_cadastramento") <> "" then response.write rs9("responsavel_cadastramento") else response.write "não informado" end if%>" type="text" id="txt_responsavel_cadastramento_comprador" size="38" maxlength="50" align="left" class="inputBox" style="HEIGHT: 18px; WIDTH: 290px; background:<%=claro%>"></td>
              </tr>
			  ...
			  <tr>
                  ...
                  <td height="20" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><input name="txt_data_ultimo_acesso" value="<%if rs9("data_ultimo_acesso") <> "" then response.write rs9("data_ultimo_acesso") else response.write "não informado" end if%>" type="text" id="txt_data_ultimo_acesso" size="38" maxlength="50" align="left" class="inputBox" style="HEIGHT: 18px; WIDTH: 290px; background:<%=medio%>"></td>
              </tr>
			  ...
			  <tr>
                  ...
                  <td height="20" bgcolor="<%=claro%>" style="border:1px solid #FFFFFF;"><select name="txt_melhor_horario_visita_comprador" size="1" class="inputBox" id="txt_melhor_horario_visita_comprador"  style="HEIGHT: 18px; WIDTH: 149px ; font-size : 10px;  color:FFFFFF; background: <%=claro%>">
                      <option value="<%if rs9("melhor_horario_visita") <> "" then response.write rs9("melhor_horario_visita") else response.write "não informado" end if%>" selected><%if rs9("melhor_horario_visita") <> "" then response.write rs9("melhor_horario_visita") else response.write "não informado" end if%></option>
			...
			<tr>
                  ...
                  <td width="290" bgcolor="<%=claro%>" style="border:1px solid #FFFFFF;"> 
                    <select name="txt_origem" id="txt_origem" class="inputBox" style="HEIGHT: 18px; WIDTH: 150px; background: <%=claro%>">
					 ...
					 <option value="<% if rs9("origem") <> "" then response.write rs9("origem") else response.write "não informado" end if %>" selected><% if rs9("origem") <> "" then response.write rs9("origem") else response.write "não informado" end if %></option>
...
<input name="txt_telefone" type="<%if session("permissao") <> "4"  and  session("permissao") <> "5" and  session("permissao") <> "6" then %><% if  UCase(rs9("atendimento")) <> UCase(Session("Admin_ID")) then response.write "Hidden" else response.write "text" end if %><%else%><%response.write "text" end if %>" class="inputBox" id="txt_telefone" style="HEIGHT: 18px; WIDTH: 290px ; background:<%=claro%>;" value="<%if rs9("telefone") <> "" then response.write rs9("telefone") else response.write "não informado" end if%>" size="38" maxlength="50" align="left"></td>
              </tr>
			 ...
			 <tr>
                ...
                <td bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><input name="txt_telefone02" value="<%if rs9("telefone02") <> "" then response.write rs9("telefone02") else response.write "não informado" end if%>" type="text" id="txt_telefone02" size="38" maxlength="20" align="left" class="inputBox" style="HEIGHT: 18px; WIDTH: 290px; background: <%=medio%>">
                  </td>
              </tr>
			   ...
			   <tr>
                  <td bgcolor="<%=claro%>" style="border:1px solid #FFFFFF;"> 
                    <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Telefone 
                      celular</font></div></td>
                <td bgcolor="<%=claro%>" style="border:1px solid #FFFFFF;"><input name="txt_telefone03" value="<%if rs9("telefone03") <> "" then response.write rs9("telefone03") else response.write "não informado" end if%>" type="text" id="txt_telefone03" size="38" maxlength="20" align="left" class="inputBox" style="HEIGHT: 18px; WIDTH: 290px; background: <%=claro%>">
                  </td>
              </tr> 
...
<input name="txt_email" type="<%if session("permissao") <> "4" and  session("permissao") <> "5" and  session("permissao") <> "6" then %><% if  UCase(rs9("atendimento")) <> UCase(Session("Admin_ID")) then response.write "Hidden" else response.write "text" end if %><%else%><%response.write "text" end if %>" class="inputBox" id="txt_email" style="HEIGHT: 18px; WIDTH: 290px ; background:<%=medio%>;" value="<%if rs9("email") = "" then response.write "não informado" else response.write rs9("email") end if%>" size="38" maxlength="50" align="left"></td>
              </tr>
                  ...
                  <td width="290" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><font color="#FFFFFF"> 
                    <select name="txt_tipo" size="1" id="txt_tipo" class="inputBox" style="HEIGHT: 18px; WIDTH: 150px; background: <%=medio%>">
                     <option value="<%=rs9("tipo")%>" selected>
					  <% if rs9("tipo") = "tqualquer" then response.write "não informado" else response.write rs9("tipo") end if%>
                     </option>
			  ...
			  <tr> 
                  ...
                  <td width="290" bgcolor="<%=claro%>" style="border:1px solid #FFFFFF;"> 
                    <select name="txt_ocupacao" id="txt_ocupacao" class="inputBox" style="HEIGHT: 18px; WIDTH: 150px; background:<%=claro%>">
					  ...
					  <% if rs9("ocupacao") = "oqualquer" then response.write "não informado" else response.write rs9("ocupacao") end if%>
                     </option>
                      <option value="não informado">não informado</option>
			  ...
			  <tr> 
                  ...
                  <td bgcolor="<%=claro%>" style="border:1px solid #FFFFFF;"> 
                    <select name="txt_suites" id="txt_suites" class="inputBox" style="HEIGHT: 18px; WIDTH: 150px; background:<%=claro%>">
                      <option value="00" selected>não informado</option>
                   <option value="00">00</option>
				    <option value="01">01</option>
                    <option value="02">02</option>
                    <option value="03">03</option>
...
'Agora entramos com o banco de dados! Temos que joga??????r aqui todas as opções de carro!
