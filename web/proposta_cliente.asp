...
<html>
<head>
<title>Cadastrar seu imóvel</title>
<script>
...
<form method="post" action="incluir_proposta_cliente.asp" onSubmit="return isValidDigitNumber(this);" name="b2">
<table width="590" border="0" cellspacing="0" cellpadding="0" bgcolor="<%=escuro%>">
  ...
  <tr>
    <td width="590" height="18"><div align="center"><% if varSucesso = "" then%><% else %><font size="1" color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif"><%=varSucesso%></font> <%end if %></div></td>
  </tr>
  <tr>
              ...
              <tr bgcolor="#537497"> 
                ...
                <td width="290" height="18" > 
                  <div align="center">
                      ...
                      <option value="Alugar o meu imóvel">Aluguel</option>
                      <option value="Comprar o meu imóvel">Compra</option>
...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Descri&ccedil;&atilde;o 
                  ...
                  <td width="291" ><textarea name="txtProposta" rows="8" cols="32"  OnKeyPress="return limitfield(this, 500)" style="HEIGHT: 120px; WIDTH: 292px; background: <%=claro%>; border: 1px solid #FFFFFF" class="inputBox"></textarea></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
