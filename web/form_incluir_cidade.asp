...
<%
dim varSucesso_cidade,varExistente
...
<form name="doublecombo"   method="post" action="incluir_cidade.asp">
  <table width="345" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td width="345" height="18"><div align="center">
          <% if varSucesso_cidade = "" then%>
          
          <%else%>
          <font size="1" face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF"><%=varSucesso_cidade%> 
          ...
          <tr>
            ...
            <td><table width="335" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="235" bgcolor="7B9AB9" style="border:1px solid #FFFFFF;"><input name="txt_cidade" type="text" id="txt_cidade" size="38" maxlength="23" align="left" class="inputBox" style="HEIGHT: 18px; WIDTH: 235px; background: <%=claro%>"></td>
                </tr>
                <tr>
                  <td width="100">&nbsp;</td>
