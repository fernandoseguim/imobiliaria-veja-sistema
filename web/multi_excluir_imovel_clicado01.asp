...
SearchFor = request.Querystring("SearchFor")
 ...
 response.Redirect "archive_imovel_clicado_corretor.asp?searchFor="&searchFor&"&searchWhere="&searchWhere&""
 end if
	...
	Conexao.execute"delete from imovel_clicado where cod_clicado in ("& request.form("check01") &")"
	 ...
	 response.redirect "archive_imovel_clicado_corretor.asp?page="&cInt(Page)&"&SearchFor="&SearchFor&"&SearchWhere="&SearchWhere&"&varCidade="&varCidade&"&varBairro="&varBairro&"&varNegociacao="&varNegociacao&"&varQuartos="&varQuartos&"&varValor1="&varValor1&"&varValor2="&varValor2&"&varValor="&varValor&""
