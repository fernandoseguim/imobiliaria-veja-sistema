...
strSQL ="SELECT imoveis.cod_imovel,imoveis.foto_grande,imoveis.cidade,imoveis.bairro,imoveis.tipo,imoveis.area_total,imoveis.area_construida,imoveis.quartos,imoveis.banheiros,imoveis.vagas,imoveis.negociacao,imoveis.valor,imoveis.link_foto,imoveis.proprietario,imoveis.endereco,imoveis.data,imoveis.telefone,imoveis.email,imoveis.obs_imovel,imoveis.obs_proprietario,imoveis.foto_pequena,imoveis.presenca_primeira,imoveis.titulo_anuncio,imoveis.texto_anuncio,imoveis.foto_grande1,imoveis.foto_grande2,imoveis.foto_grande3,imoveis.foto_grande4,imoveis.foto_grande5,imoveis.StandBy,imoveis.foto_gigante,imoveis.ocupacao,imoveis.data_atualizacao,imoveis.captacao,imoveis.vila,imoveis.qualidade,imoveis.foto_grande6,imoveis.foto_grande7,imoveis.foto_grande8,imoveis.foto_grande9,imoveis.foto_grande10,imoveis.cod_permuta,imoveis.cod_comprador,imoveis.condominio,imoveis.placa,imoveis.dataLastEmail,imoveis.textoLastEmail,imoveis.data_futuro_contato,imoveis.assunto_futuro_contato,imoveis.telefone02,imoveis.telefone03,imoveis.suites,imoveis.chaves_do_imovel,imoveis.melhor_horario_visita,imoveis.imovel_em_negociacao,imoveis.metros_de_frente,imoveis.metros_de_fundo,imoveis.metros_lateral_esquerda,imoveis.metros_lateral_direita,imoveis.origem_captacao,imoveis.responsavel_cadastramento,imoveis.data_ultimo_acesso,imoveis.saldo_devedor,imoveis.ja_pago_devedor,imoveis.devendo_devedor,imoveis.quem_atualizou  FROM imoveis Where   (imovel_em_negociacao<>'Imóvel inexistente' and  imovel_em_negociacao<>'Suspenso' and imovel_em_negociacao<>'Com proposta' and imovel_em_negociacao<>'Vendido por outros' and imovel_em_negociacao<>'alugado pela Veja' and imovel_em_negociacao<>'Vendido pela Veja'  and captacao <> 'internet' and captacao <> 'avaliação') and cod_imovel = "&varCodImovel
...
EnderecoIP = request.ServerVariables("REMOTE_ADDR")
 ...
 Conexao3.execute"Insert into referencia_procurados(referencia,enderecoIP,data) values( '"& varCodImovel &"','"& enderecoIP &"','"& now() &"')"
...
<div align="center">
                                        ...
                                        <tr> 
                                          <td><div align="center"> 
                                              <table width="202" border="0" cellspacing="0" cellpadding="0">
												...
												<tr> 
                                                  <td height="20"><input name="txt_nome" onFocus="doublecombo.txt_nome.value=''"  type="text" class="inputBox" id="txt_nome"  style="HEIGHT: 18px; WIDTH: 202px; ; font-size : 9px; background: #e0a94e; color:#FFFFFF;" value="<%=session("nome")%>"></td>
                                                </tr>
                                                <tr> 
                                                  <td height="20"><input name="txt_telefone" onFocus="doublecombo.txt_telefone.value=''"  type="text" class="inputBox" id="txt_nome2"  style="HEIGHT: 18px; WIDTH: 202px; ; font-size : 9px; background: #e0a94e; color:#FFFFFF;" value="<%=session("telefone")%>"></td>
                                                </tr>
                                                <tr> 
                                                  <td height="20"><input name="txt_email" onFocus="doublecombo.txt_email.value=''"  type="text" class="inputBox" id="txt_nome3"  style="HEIGHT: 18px; WIDTH: 202px; ; font-size : 9px; background: #e0a94e; color:#FFFFFF;" value="<%=session("email")%>"></td>
                                                </tr>
                                                <tr> 
                                                  <td height="20"><select name="combo1" id="combo1" onChange="javascript:atualizacarros(this.form);" size="1"  class="inputBox" style="HEIGHT: 18px; font-size : 9px;  WIDTH: 202px ;background: #e0a94e; color:#FFFFFF;">
				 ...
				 <% = Rs303("nome_combo1") %> </option>
                  ...
                  <%end if%>
                                                ...
                                                <tr> 
                                                  <td height="20"><select name="combo2" id="combo2"   size="1"  class="inputBox" style="HEIGHT: 18px; font-size : 9px;  WIDTH: 202px ;background: #e0a94e; color:#FFFFFF;">
                  ...
                  <% end if %>
												 ...
												 <tr> 
                                                  <td height="20"><select name="txt_tipo" id="txt_tipo" size="1"  class="inputBox" style="HEIGHT: 18px; font-size : 9px;  WIDTH: 202px ;background: #e0a94e; color:#FFFFFF;">
                                                ...
                                                <tr> 
                                                  <td height="20"><select name="txt_quartos" id="txt_quartos" size="1"  class="inputBox" style="HEIGHT: 18px; font-size : 9px;  WIDTH: 202px ;background: #e0a94e; color:#FFFFFF;">
                                                ...
                                                <tr> 
                                                  <td height="20"><select name="txt_garagem" id="txt_garagem" size="1"  class="inputBox" style="HEIGHT: 18px; font-size : 9px;  WIDTH: 202px ;background: #e0a94e; color:#FFFFFF;">
                                                ...
                                                <tr> 
                                                  <td height="20"><select name="example2" id="example2" onChange="redirect2(this.options.selectedIndex)" size="1"  class="inputBox" style="HEIGHT: 18px; font-size : 9px;  WIDTH: 202px ;background: #e0a94e; color:#FFFFFF;">
                                                ...
                                                <tr> 
                                                  <td height="20"><select name="stage22" id="stage22" size="1"  class="inputBox" style="HEIGHT: 18px; font-size : 9px;  WIDTH: 202px ;background: #e0a94e; color:#FFFFFF;">
...
<table width="794" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="200" style="border:1px solid #ddddc5;"><table width="784" height="190" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                        ...
                        <td><table width="774" height="180" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              <td width="299" height="180" style="border:1px solid #FFFFFF;" bgcolor="#f7ecbf"> 
                                ...
                                <a href="javascript:newWindow2('mostrar_imovel2.asp?varCodimovel=<%=varCodimovel%>&nome=<%=session("nome")%>&telefone=<%=session("telefone")%>&email=<%=session("email")%>')"><img src="<%=rs("foto_grande1")%>" width="299" height="178" border="0"></img></a> 
                                <%else%>
...
<div align="center"><font color="#9d9249" face="Verdana, Arial, Helvetica, sans-serif" size="1"><%=rs("cidade")%></font></div> 
                                            </td>
                                          <td width="117" height="18" style="border:1px solid #e9dca8;">
<div align="center"><font color="#9d9249" face="Verdana, Arial, Helvetica, sans-serif" size="1"><%=rs("bairro")%></font></div> 
                                            </td>
                                          <td width="117" height="18" style="border:1px solid #e9dca8;">
<div align="center"><font color="#9d9249" face="Verdana, Arial, Helvetica, sans-serif" size="1"><%if rs("tipo") <> "tqualquer" then response.write rs("tipo") else response.write "não informado" end if%></font></div> 
                                            </td>
                                          <td width="117" height="18" style="border:1px solid #e9dca8;">
<div align="center"><font color="#9d9249" face="Verdana, Arial, Helvetica, sans-serif" size="1"><%=formatnumber(rs("valor"),2)%></font></div> 
                                            </td>
                                        </tr>
                                      </table></td>
                                  </tr>
                                  <tr>
                                    <td width="469" height="164"><% if rs("qualidade") = "bom negócio" and rs("imovel_em_negociacao") <> "Vendido pela Veja" then%>
									
									<table width="469" height="164" border="0" cellpadding="0" cellspacing="0">
        <tr>
                                          <td width="379">
<div align="center"><font color="#9d9249" face="Verdana, Arial, Helvetica, sans-serif" size="1"><a href="javascript:newWindow2('mostrar_imovel2.asp?varCodimovel=<%=varCodimovel%>&nome=<%=session("nome")%>&telefone=<%=session("telefone")%>&email=<%=session("email")%>')" style="text-decoration:none;color:#9d9249"><%=rs("obs_imovel")%></a><br>
                                            <br>
...
<div align="center"><font color="#9d9249" face="Verdana, Arial, Helvetica, sans-serif" size="1"><a href="javascript:newWindow2('mostrar_imovel2.asp?varCodimovel=<%=varCodimovel%>&nome=<%=session("nome")%>&telefone=<%=session("telefone")%>&email=<%=session("email")%>')" style="text-decoration:none;color:#9d9249"><%=rs("obs_imovel")%></a><br>
          ...
          <td width="90"><table width="90" height="164" border="0" cellpadding="0" cellspacing="0">
              <tr>
                                                <td height="90" ><table width="80" height="80" border="0" align="center" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                      <td bgcolor="#ecdf94" style="border:1px solid #d7c971;"><div align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif" color="#9d9249"><a href="javascript:newWindow2('mostrar_imovel2.asp?varCodimovel=<%=varCodimovel%>')" style="text-decoration:none;color:#9d9249"><img src="bt_sorriso02.jpg" border="0"></img></a></font></div></td>
                                                    </tr>
                                                  </table></td>
              </tr>
              <tr>
	  ...
	  <%else%>
	                                ...
	                                <div align="center"><font color="#9d9249" face="Verdana, Arial, Helvetica, sans-serif" size="1"><a href="javascript:newWindow2('mostrar_imovel2.asp?varCodimovel=<%=varCodimovel%>')" style="text-decoration:none;color:#9d9249"><%=rs("obs_imovel")%></a><br>
                                      <br>
                                      Atualizado em:<%=rs("data_atualizacao")%><br>
                                      <br>
