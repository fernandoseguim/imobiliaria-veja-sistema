          ...
          <tr>
            ...
            <td><table width="335" border="0" cellspacing="0" cellpadding="0">
               <tr>
                  ...
                  <td width="235" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><input name="txt_ip" type="text" class="inputBox" id="txt_ip" style="HEIGHT: 18px; WIDTH: 235px; background: <%=medio%>" size="38" maxlength="23" align="left"></td>
                </tr>
				<tr>
                  <td width="100" bgcolor="<%=claro%>" style="border:1px solid #FFFFFF;"> 
                    <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Origem 
                      Franquia </font></div></td>
                  <td width="235" bgcolor="<%=claro%>" style="border:1px solid #FFFFFF;"><input name="txt_origem_franquia" type="text" class="inputBox" id="txt_origem_franquia" style="HEIGHT: 18px; WIDTH: 235px; background: <%=claro%>" value="<%=session("vOrigem_Franquia")%>" size="38" maxlength="23" align="left"></td>
                </tr>
				
				<tr>
                  <td width="100" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"> 
                    <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Quem 
                      Incluiu </font></div></td>
                  <td width="235" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><input name="txt_quem_incluiu" type="text" class="inputBox" id="txt_quem_incluiu" style="HEIGHT: 18px; WIDTH: 235px; background: <%=medio%>" size="38" maxlength="23" align="left"></td>
                </tr>
				
				<tr>
                  <td width="100" bgcolor="<%=claro%>" style="border:1px solid #FFFFFF;"> 
                    <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Senha</font></div></td>
                  <td width="235" bgcolor="<%=claro%>" style="border:1px solid #FFFFFF;"><input name="txt_senha" type="text" class="inputBox" id="txt_senha" style="HEIGHT: 18px; WIDTH: 235px; background: <%=claro%>" size="38" maxlength="23" align="left"></td>
                </tr>
