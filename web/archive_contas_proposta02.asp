        ...
        <table width="300" height="120" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td height="20" bgcolor="#f7ecbf"><font color="#9d9249" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Nome 
              : <a href="proposta_oficial03.asp?varCod_proposta_oficial=<%=rs("cod_proposta_oficial")%>" target="_blank" style="color:#9d9249;text-decoration:none;"><%=rs("Nome")%></a></strong></font></td>
          </tr>
		  <tr>
            <td height="20" bgcolor="#f7ecbf"><font color="#9d9249" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Atendimento:<a href="proposta_oficial03.asp?varCod_proposta_oficial=<%=rs("cod_proposta_oficial")%>" target="_blank" style="color:#9d9249;text-decoration:none;"><%=rs("atendimento")%></a>
          ...
          <tr>
            <td><div align="center"><font color="#9d9249" size="2" face="Verdana, Arial, Helvetica, sans-serif"><a href="proposta_oficial03.asp?varCod_proposta_oficial=<%=rs("cod_proposta_oficial")%>" target="_blank" style="color:#9d9249;text-decoration:none;"><%=rs("obs_proposta_oficial")%></a></font></div></td>
          </tr>
        </table>
      </div></td>
    </tr>
...
<table width="537" border="0" cellspacing="0" cellpadding="0">
    ...
    <td bgcolor="#FFFFFF"> 
      <div align="center"><font face="Verdana, arial" size="1" color="#003366"> 
        ...
        <!-- se a página atual for maior que "1" então o link anteriro é colocado na 
			  na tela .-->
      <a href="?page=<%=intPage - 1%>&varCodimovel=<%=varCod_imovel%>" style="color:#000000">
    ...
    <td bgcolor="#FFFFFF"> 
      <div align="center"><font face="Verdana, arial" size="1" color="#000000" > 
        ...
        <a href="?page=<%=intPage + 1%>&varCodimovel=<%=varCod_imovel%>" style="color:#000000"><font face="Verdana, arial" size="1" color="#000000"><b>Próximo</b></font> 
        </a> 
        <%End If%>
        </font></div></td>
        </tr>
