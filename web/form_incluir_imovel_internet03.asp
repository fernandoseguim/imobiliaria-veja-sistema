...
<body bgcolor="<%=escuro%>" onload=doublecombo.txt_telefone.focus(); topmargin="0" bottommargin="10" leftmargin="0" rightmargin="0" marginheight="0" marginwidth="0">
<form name="doublecombo" ENCTYPE="multipart/form-data" onSubmit="return isValidDigitNumber(this);" method="post" action="outFile003.asp">
<table width="590" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="590" height="48"><img src="top_resultado.jpg" width="590" height="48"></td>
  </tr>
   <tr>
      <td width="590" height="100"><div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Este 
          formul&aacute;rio &eacute; utilizado para voc&ecirc; cadastrar o seu 
          im&oacute;vel no nosso banco de dados, assim o im&oacute;vel fica dispon&iacute;vel 
          para qualquer um que queira comprar, com exce&ccedil;&atilde;o &eacute; 
          claro dos dados pessoais como email , telefone e endere&ccedil;o se 
          voc&ecirc; aceitar fazer permuta informe no cadastro abaixo.Voc&ecirc; 
          pode cadastrar seu im&oacute;vel com foto ou sem foto, se quiser cadastrar 
          com foto clique em cadastramento com foto. Al&eacute;m disso ser&aacute; 
          criada uma conta de vendedor de im&oacute;vel para voc&ecirc;,nessa 
          conta nosso sistema vai indicar v&aacute;rios compradores interessados 
          no seu im&oacute;vel que poderam ser contatos a qualquer momento. &quot;OBS: 
          As conta s&atilde;o gratuitas&quot;</strong></font></div></td>
  </tr>
...
<table width="590" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td><table width="580" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td><a href="form_incluir_imovel_internet02.asp"><img src="bt_foto0.jpg" width="290" height="18" border="0"></a></td>
            <td><img src="bt_foto1.jpg" width="290" height="18" border="0"></td>
        </tr>
        <tr>
          <td style="border:1px solid #FFFFFF; background:<%=claro%>"><div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Seu 
              nome </font></div></td>
          <td style="border:1px solid #FFFFFF; background:<%=claro%>" ><input name="txt_proprietario" value="Click aqui e comece a digitar..." type="text" id="txt_proprietario" size="38" maxlength="35" align="left" class="inputBox" style="HEIGHT: 18px; WIDTH: 290px; background:<%=claro%>" onfocus="doublecombo.txt_proprietario.value=''"></td>
        </tr>
        <tr>
          <td style="border:1px solid #FFFFFF; background:<%=medio%>" ><div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Seu 
...
<br><div align="center">
    ...
    abaixo os dados do seu im&oacute;vel</font></strong></div>
<br>
<table width="590" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td width="5">&nbsp;</td>
    <td><div align="center"> 
          <table width="580" border="0" cellspacing="0" cellpadding="0">
            ...
            <td width="290"style="border:1px solid #FFFFFF; background:<%=medio%>" > <input type="file" size="40" align="left" name="blob"  class="inputBox" style="HEIGHT: 18px; WIDTH: 290px; background:<%=medio%>" ></td>
          </tr>
		  ...
		  <tr> 
            ...
            <td width="290"style="border:1px solid #FFFFFF; background:<%=claro%>" > <input name="txt_endereco" type="text" id="txt_endereco" size="38" maxlength="80" align="left" class="inputBox" style="HEIGHT: 18px; WIDTH: 290px ; background:<%=claro%>"></td>
          </tr>
          <tr> 
              <td width="290" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF; background:<%=medio%>">
...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Bairro 
                do im&oacute;vel</font></div></td>
            <td width="290" style="border:1px solid #FFFFFF; background:<%=claro%>"> <select name="combo2" onChange="javascript:atualizacarros888(this.form);" class="inputBox" style="HEIGHT: 18px; WIDTH: 150px; background:<%=claro%>">
...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">&Aacute;rea 
            ...
            <td width="290" style="border:1px solid #FFFFFF; background:<%=medio%>"><font color="#FFFFFF">
                <input name="txt_a_total" type="text" class="inputBox" id="txt_a_total" style="HEIGHT: 18px; WIDTH: 150px; background:<%=medio%>" value="00" size="12" maxlength="20">
          ...
          <tr> 
              <td width="290" bgcolor="<%=claro%>" style="border:1px solid #FFFFFF; background:<%=claro%>">
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">&Aacute;rea 
                  constru&iacute;da (para casas) ou &uacute;til (para apto)</font></div></td>
            <td width="290" style="border:1px solid #FFFFFF; background:<%=claro%>"><input name="txt_a_constr" type="text" class="inputBox" id="txt_a_constr" style="HEIGHT: 18px; WIDTH: 150px; background: <%=claro%>" value="00" size="12" maxlength="20"> 
...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Banheiros</font></div></td>
            <td width="290" style="border:1px solid #FFFFFF; background:<%=claro%>"><select name="txt_banheiros" id="txt_banheiros" class="inputBox" style="HEIGHT: 18px; WIDTH: 150px; background: <%=claro%>">
                <option value="não informado" selected>não informado</option>
                <option value="01">01</option>
                <option value="02">02</option>
                <option value="03">03</option>
...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Vagas 
            ...
            <td width="290" style="border:1px solid #FFFFFF; background:<%=medio%>"><select name="txt_vagas" id="txt_vagas" class="inputBox" style="HEIGHT: 18px; WIDTH: 150px; background:<%=medio%>">
                <option value="não informado" selected>não informado</option>
                <option value="01">01</option>
                <option value="02">02</option>
                <option value="03">03</option>
...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Ocupa&ccedil;&atilde;o</font></div></td>
            <td width="290" style="border:1px solid #FFFFFF; background:<%=medio%>"><select name="txt_ocupacao" id="txt_ocupacao" class="inputBox" style="HEIGHT: 18px; WIDTH: 150px; background:<%=medio%>">
                <option value="não informado" selected>não informado</option>
...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Valor</font></div></td>
            <td width="290" style="border:1px solid #FFFFFF; background:<%=claro%>"><input name="txt_valor" type="text" class="inputBox" id="txt_valor" style="HEIGHT: 18px; WIDTH: 150px; background:<%=claro%>" value="0,00" size="12" maxlength="20"></td>
          </tr>
          <tr> 
            <td width="290" style="border:1px solid #FFFFFF; background:<%=medio%>"><div align="center">
...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Descri&ccedil;&atilde;o 
            ...
            <td width="290" style="border:1px solid #FFFFFF; background:<%=medio%>"><textarea name="obs_imovel" class="inputBox" id="obs_imovel" style="HEIGHT: 100px; WIDTH: 290px; background: <%=medio%> " onKeyPress="return limitfield(this, 200)"></textarea></td>
          </tr>
...
<div align="center"><br>
    ...
    voc&ecirc; aceite im&oacute;vel como parte de pagamento, preencha os campos 
    abaixo: </font></strong></div>
<br>
<table width="590" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="5">&nbsp;</td>
...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Voc&ecirc; 
                  aceita im&oacute;vel como parte de pagamento?</font></div></td>
...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Tipo 
              ...
              <td width="290" style="border:1px solid #FFFFFF; background:<%=medio%>"><font color="#FFFFFF">
                <select name="txt_tipo_comp" size="1" id="txt_tipo_comp" class="inputBox" style="HEIGHT: 18px; WIDTH: 150px; background: <%=medio%>">
                  <option value="Apartamento">Apartamento </option>
				   <option value="Térrea/Sobrado">Térrea/Sobrado</option>
				   <option value="Chácara">Chácara</option>
                  <option value="Flat">Flat</option>
...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">N&uacute;mero 
                  de dormit&oacute;rios</font></div></td>
              <td width="290" style="border:1px solid #FFFFFF; background:<%=claro%>"><select name="txt_quartos_comp" id="txt_quartos_comp" class="inputBox" style="HEIGHT: 18px; WIDTH: 150px; background:<%=claro%>">
                  <option value="não informado" selected>não informado</option>
                  <option value="01">01</option>
                  <option value="02">02</option>
                  <option value="03">03</option>
			...
			<tr> 
                  <td bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"> 
                    <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Vagas 
                      na garagem do im&oacute;vel pretendido</font></div></td>
                  <td bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"> 
                    <select name="txt_vagas_comp" id="txt_vagas_comp" class="inputBox" style="HEIGHT: 18px; WIDTH: 150px; background:<%=medio%>">
                  <option value="não informado" selected>não informado</option>
                    <option value="01">01</option>
                    <option value="02">02</option>
                    <option value="03">03</option>
...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Valor 
                  do im&oacute;vel pretendido</font></div></td>
              <td width="290" style="border:1px solid #FFFFFF; background:<%=claro%>"><input name="txt_valor_comp" type="text" class="inputBox" id="txt_valor_comp" style="HEIGHT: 18px; WIDTH: 150px; background:<%=claro%>" value="0,00" size="12" maxlength="20"></td>
            </tr>
...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Descri&ccedil;&atilde;o 
                  do im&oacute;vel pretendido</font></div></td>
              <td width="290" style="border:1px solid #FFFFFF; background:<%=medio%>"><input name="txt_descricao_comp" type="text" id="txt_descricao_comp" size="38" maxlength="200" align="left" class="inputBox" style="HEIGHT: 18px; WIDTH: 290px; background:<%=medio%>"></td>
            </tr>
			<tr> 
              <td width="290" bgcolor="<%=claro%>" style="border:1px solid #FFFFFF; background:<%=escuro%>"> 
                <div align="center"></div></td>
              <td width="290" style="border:1px solid #FFFFFF; background:<%=escuro%>"><table width="290" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="145"><input name="image" type="image"  src="bt_enviar001.jpg" width="145" height="18" border="0"></td>
