...
if len(vdata2) = 17 then
 ...
 vdata = left(now(),11)
	...
	dim vNome,var_telefone_acesso,vSenha,vPermissao
	
	
	var_telefone_acesso = request.form("txt_telefone_acesso")
	 
	
	Conexao.execute"Insert into telefone_acesso(telefone_acesso,quem_incluiu,origem_franquia) values('"& var_telefone_acesso &"','"&session("Admin_id")&"','"&session("vOrigem_Franquia")&"')"
	 
	 dim varCidade
	 response.Redirect "form_incluir_telefone_acesso.asp?varSucesso_telefone_acesso="&var_telefone_acesso&""
