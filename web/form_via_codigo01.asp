...
<html>
<head>
<title>Mudança de atendente</title>
...
if ( doublecombo.txt_numero.value == "") {
        alert("Você precisa informar quantos clientes quer transferir");
       
		doublecombo.txt_numero.focus();
		 doublecombo.txt_numero.select();
        return false;
    }
...
for (nCount=0; nCount < doublecombo.txt_numero.value.length; nCount++) 
		{
strTempChar8_ja=doublecombo.txt_numero.value.substring(nCount,nCount+1);
if (strValidNumber8_ja.indexOf(strTempChar8_ja,0)==-1) 
{
alert("O item número de clientes transferidos precisa ser numérico!");
doublecombo.txt_numero.focus();
doublecombo.txt_numero.select();
return false;
}
...
<form action="atualizar_via_codigo01.asp" method="post" name="doublecombo" onSubmit="return isValidDigitNumber(this);">
<table width="700" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="30" bgcolor="<%=claro%>"><table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr bgcolor="<%=claro%>"> 
  ...
  <td height="20" align="center" width="100" bgcolor="<%=claro%>"><input name="txt_numero" type="text" class="inputBox" id="txt_numero" style="HEIGHT: 18px; WIDTH: 80px; background:<%=medio%>;border:1px solid #FFFFFF;" value="0" size="38" maxlength="50" align="left"> </td>
