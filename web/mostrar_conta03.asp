...
<br>
<br>
  <font size="1" color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif"><strong>O 
  seu imóvel para permuta foi enviado com sucesso!</strong></font> <br>

<% if varCodImovel = "" then %>
<br>
  <font size="1" color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif">A 
  partir de agora você tem uma conta de permutante de imóvel e uma de comprador, 
  nessas contas voc&ecirc; poder&aacute;<br>
  verificar poss&iacute;veis permutantes para o seu im&oacute;vel , nosso sistema 
