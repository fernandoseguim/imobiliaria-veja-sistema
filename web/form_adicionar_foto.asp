...
<form method="post" ENCTYPE="multipart/form-data" onSubmit="return isValidDigitNumber(this);" action="outFile008.asp?varCodImovel=<%=varCodImovel%>"  name="b2">
          ...
          <tr>
            ...
            <td><table width="335" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="235" bgcolor="<%=claro%>" style="border:1px solid #FFFFFF;"><input name="txtAnuncio" type="file"  size="30" maxlength="23" align="left" class="inputBox" style="HEIGHT: 18px; WIDTH: 235px; background: <%=medio%>; "></td>
                </tr>
                <tr>
                  <td width="100">&nbsp;</td>
