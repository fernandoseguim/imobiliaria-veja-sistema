...
<center>
<br>
  <a href="excluir_permuta_procurados.asp"><img src="bt_excluir002.jpg" width="95" height="18" border="0"></a><br>
  <br>
  <font size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Lista de 
  buscas por permutantes efetuadas </strong></font> 
</center>
<% end if %>
...
Set rs = Server.CreateObject("ADODB.RecordSet")
  ...
  Conexao.execute"Insert into visualiza_paginas(visualiza_pagina_nome, visualiza_pagina_pagina, visualiza_pagina_data, origem_franquia) values( '"& session("nome_id") &"','"& "Permutantes procurados" &"','"& now() &"','"& session("vOrigem_Franquia") &"')" 
	

SQL ="SELECT permuta_procurados.cod_PermutaProcurados,permuta_procurados.cidade_vend,permuta_procurados.bairro_vend,permuta_procurados.tipo_vend,permuta_procurados.quartos_vend,permuta_procurados.valor_vend,permuta_procurados.vagas_vend, permuta_procurados.cidade_comp,permuta_procurados.bairro_comp,permuta_procurados.tipo_comp,permuta_procurados.quartos_comp,permuta_procurados.valor_comp,permuta_procurados.vagas_comp, permuta_procurados.enderecoIP,permuta_procurados.nome,permuta_procurados.telefone,permuta_procurados.data,permuta_procurados.origem_franquia,permuta_procurados.clique FROM permuta_procurados where origem_franquia like '"&session("vOrigem_Franquia")&"' ORDER BY cod_PermutaProcurados DESC" 
...
%><br>
<center><font size="1" face="Verdana, Arial, Helvetica, sans-serif" color="#000000"><%rs.movelast%><strong><%=rs("data")%></strong> até  <%rs.movefirst%><strong><%=rs("data")%></strong><br><br> foram <strong><%=rs.RecordCount%></strong> acessos.</font></center>
<form  Method="Post" name="Formulario" action="multi_excluir_permuta_procurados01.asp?page=<%=cInt(intPage)%>&SearchFor=<%=SearchFor%>" >
  <table width="1860" border="0" cellspacing="0" cellpadding="0">
    <tr bgcolor="#000000"> 
	  ...
	  <td width="20" height="18" bgcolor="<%=claro%>"><% if  session("permissao") = "3" or  session("permissao") = "5" or session("permissao") = "6"  then %>
        ...
        <%end if%></td> 
		 ...
		 <td width="25" height="30" bgcolor="#000000" style="border:1px solid #FFFFFF;"></td>
		
		<td width="115" height="30" style="border:1px solid #FFFFFF;"> 
        <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Data</strong></font></div></td>
     
		
      <td width="115" height="30" bgcolor="#000000" style="border:1px solid #FFFFFF;">
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Meu 
          Nome </strong></font></div></td>
      <td width="115" height="30" style="border:1px solid #FFFFFF;">
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Meu 
          Telefone</strong></font></div></td>
     
	   
      <td width="115" height="30" bgcolor="#000000" style="border:1px solid #FFFFFF;">
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong> 
          Cidade atual</strong></font></div></td>
      <td width="115" height="30" style="border:1px solid #FFFFFF;">
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong> 
          Bairro atual</strong></font></div></td>
     
	  <td width="115" height="30" style="border:1px solid #FFFFFF;">
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Tipo 
          atual </strong></font></div></td>
      <td width="115" height="30" style="border:1px solid #FFFFFF;"> 
        <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Quartos 
          atual </strong></font></div></td>
		  <td width="115" height="30" style="border:1px solid #FFFFFF;"> 
        <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Vagas 
          atual </strong></font></div></td>
      <td width="115" height="30" style="border:1px solid #FFFFFF;"> 
	  ...
	  <td width="115" height="30" style="border:1px solid #FFFFFF;"> 
        <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Cidade 
...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Tipo 
      ...
      <td width="115" height="30" style="border:1px solid #FFFFFF;">
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Quartos 
          pretendidos </strong></font></div></td>
		  <td width="115" height="30" style="border:1px solid #FFFFFF;">
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Vagas 
          pretendidas </strong></font></div></td> 
...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Valor 
          pretendido </strong></font></div></td>
      <td width="115" height="30" style="border:1px solid #FFFFFF;"> 
        <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Endere&ccedil;o 
...
vValor2= rs("valor_comp")
 session("vValor3")=left(vValor2,10)
   session("vValor4")=right(vValor2,10)

%>
    <% session("page")=intPage%>
    <% varCod_imovel = rs("COD_PermutaProcurados") %>
    <tr>
	  <td width="20" height="18" bgcolor="<%=color1%>"><input type="checkbox" name="check01" value="<%=rs("cod_permutaprocurados")%>"></td>
	  <td width="20" height="18" bgcolor="<%=color1%>">&nbsp;</td>
	<td width="25" height="30" bgcolor="<% if rs("clique") <> "" then response.write "green" else response.write color1 end if%>" style="border:1px solid #FFFFFF;"></td>
...
<% end if%>
      ...
      <td width="115" height="30" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;">
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">
          <% if rs("cidade_vend") = "cqualquer" then response.write "qualquer uma" else response.write rs("cidade_vend") end if%>
          </font></div></td>
      <td width="115" height="30" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;">
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">
          <% if rs("bairro_vend") = "bqualquer" then response.write "qualquer um" else response.write rs("bairro_vend") end if%>
          </font></div></td>
      <td width="115" height="30" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;">
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">
          <% if rs("tipo_vend") = "tqualquer" then response.write "qualquer um" else response.write rs("tipo_vend") end if%>
          </font></div></td>
      <td width="115" height="30" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;">
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">
          <% if rs("quartos_vend") = "qqualquer" then response.write "qualquer um" else response.write rs("quartos_vend") end if%>
          </font></div></td>
       <td width="115" height="30" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;">
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">
          <% if rs("vagas_vend") = "vgqualquer" then response.write "qualquer um" else response.write rs("vagas_vend") end if%>
          </font></div></td>
	  
	  <td width="115" height="30" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;">
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
          <%if rs("valor_vend") = "vqualquer" or rs("valor_vend") = "" then response.write "qualquer um" else response.write formatnumber(int(session("vValor1")),2)&" até "&formatnumber(int(session("vValor2")),2) end if%>
          </font></div></td>
	    ...
	    <td width="115" height="30" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;">
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">
          <% if rs("cidade_comp") = "cqualquer" then response.write "qualquer uma" else response.write rs("cidade_comp") end if%>
          </font></div></td>
      <td width="115" height="30" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;">
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">
          <% if rs("bairro_comp") = "bqualquer" then response.write "qualquer um" else response.write rs("bairro_comp") end if%>
          </font></div></td>
      <td width="115" height="30" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;">
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">
          <% if rs("tipo_comp") = "tqualquer" then response.write "qualquer um" else response.write rs("tipo_comp") end if%>
          </font></div></td>
      <td width="115" height="30" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;">
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">
          <% if rs("quartos_comp") = "qqualquer" then response.write "qualquer um" else response.write rs("quartos_comp") end if%>
          </font></div></td>
		  
		   <td width="115" height="30" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;">
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">
          <% if rs("vagas_comp") = "vgqualquer" then response.write "qualquer um" else response.write rs("vagas_comp") end if%>
          </font></div></td>
      
	  
	  <td width="115" height="30" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;">
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">
          <%if rs("valor_comp") = "vqualquer" or rs("valor_comp") = "" then response.write "qualquer um" else response.write formatnumber(int(session("vValor3")),2)&" até "&formatnumber(int(session("vValor4")),2) end if%>
          </font></div></td>
    ...
    <td bgcolor="#FFFFFF"> 
      <div align="center"><font face="Verdana, arial" size="1" color="#000000"> 
        ...
        <!-- se a página atual for maior que "1" então o link anteriro é colocado na 
			  na tela .-->
      <a href="?page=<%=intPage - 1%>" style="color:#000000"><font face="Verdana, arial" size="1" color="#000000"><b>Anterior</b></font></a> 
        <%End If%>
        </font></div></td>
...
<div align="center"I><font color="<%=escuro%>">Permutantes </font><font color="<%=escuro%>"> 
...
<table width="95" border="0" cellspacing="0" cellpadding="0" align="center">
 ...
 <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif">
<div align="center"I><font color="<%=escuro%>">Permutantes n&atilde;o encontrados</font></div>
</font> 
<%
End if
%>
