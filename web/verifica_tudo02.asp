...
<form action="verifica_tudo02.asp?SearchFor=<%=SearchFor%>" onSubmit="return isValidDigitNumber2(this);" Method="GET" name="b2" >
...
<table width="750" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="100" bgcolor="#blue"><iframe src="verifica_compradores01.asp?SearchFor=<%=session("SearchFor")%>" name="meio" width="750px" height="100px" frameborder="0" scrolling="no"></iframe></td>
  </tr>
</table>
...
<table width="750" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="100" bgcolor="#green"><iframe src="verifica_imoveis01.asp?SearchFor=<%=session("SearchFor")%>" name="meio" width="750px" height="100px" frameborder="0" scrolling="no"></iframe></td>
  </tr>
</table>
...
<table width="750" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="100" bgcolor="#red"><iframe src="verifica_permuta01.asp?SearchFor=<%=session("SearchFor")%>" name="meio" width="750px" height="100px" frameborder="0" scrolling="no"></iframe></td>
  </tr>
</table>
