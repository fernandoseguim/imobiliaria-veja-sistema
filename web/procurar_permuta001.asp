...
<table width="794" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
      <td height="60" bgcolor="#e0a94e"><div align="center"><font color="#e0a94e" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong><font color="#FF0000" size="3">Est� 
          � a p�gina para voc� encontrar uma pessoa para trocar o im&oacute;vel 
           ...
           <option value="<% = Rs333("id_combo1") %>"<%if session("vCidade_vend2")<> "cqualquer" then%><%if int(rs333("id_combo1")) = int(session("vCidade_vend2")) then response.write "selected" else response.write "" end if %><%end if%>> 
			...
			<% = Rs444("nome_combo2") %>
                                      ...
                                      <tr> 
                                        <td width="372" height="22"><div align="center">
                                            <select name="txt_tipo_vend" size="1" id="txt_tipo_vend" style="HEIGHT: 18px; WIDTH: 372px; ; font-size : 12px; background: #b2802c; color:#FFFFFF;">
                                              <option value="<%=session("vTipo_vend")%>" selected><%if session("vTipo_vend") <> "tqualquer" and session("vTipo_vend") <> "" then  response.write session("vTipo_vend") else response.write "Qual o tipo do seu im�vel?" end if%></option>
					...
					<% end if %>
                                      ...
                                      <tr> 
                                        <td width="372" height="22"><div align="center">
                                           ...
                                           <option value="<%=session("vQuartos_vend")%>"><% if session("vQuartos_vend") <> "qqualquer" and session("vQuartos_vend") <> "" then response.write session("vQuartos_vend") else response.write "Quantos quartos tem o seu im�vel?" end if%></option>
                                      ...
                                      <tr> 
                                        <td width="372" height="22"><div align="center">
                                            <select name="txt_vagas_vend" size="1" id="txt_vagas_vend" class="inputBox" style="HEIGHT: 18px; WIDTH: 372px; ; font-size : 12px; background: #b2802c; color:#FFFFFF;">
											  ...
											  <option value="<%=session("vVagas_vend")%>"><% if session("vVagas_vend") <> "vgqualquer" and session("vVagas_vend") <> "" then response.write session("vVagas_vend") else response.write "Quantas vagas na garagem tem o seu im�vel" end if%></option>
              ...
              <option value="06">09</option>
			   ...
			   <option value="<%=session("vValor_vend")%>" selected><% if session("vValor_vend") <> "vqualquer" and session("vValor_vend") <> "" then response.write FormatNumber(session("vValor_vend1"),2)&" at� "&FormatNumber(session("vValor_vend2"),2) else response.write "Qual o valor do seu im�vel?" end if%></option>
                                      ...
                                      <tr> 
                                        <td width="372" height="22"><div align="center">
                                            <select name="combo4" size="1"  class="inputBox" id="combo4" style="HEIGHT: 18px; WIDTH: 372px; ; font-size : 12px; background: #b2802c; color:#FFFFFF;">
                                              <option value="bqualquer" >Em qual bairro o sr(a) quer adquirir um im�vel ?</option>
               <option value="bqualquer">Qualquer bairro</option>
			...
			<% = Rs666("nome_combo2") %>
                                      ...
                                      <tr> 
                                        <td width="372" height="22"><div align="center">
                                            <select name="txt_tipo_comp" size="1" id="txt_tipo_comp" class="inputBox" style="HEIGHT: 18px; WIDTH: 372px; ; font-size : 12px; background: #b2802c; color:#FFFFFF;">
											   ...
											   <option value="<%=session("vTipo_comp")%>" selected><%if session("vTipo_comp") <> "tqualquer" and session("vTipo_comp") <> "" then  response.write session("vTipo_comp") else response.write "Qual o tipo do  im�vel que o sr(a) deseja?" end if%></option>
                                      ...
                                      <tr> 
                                        <td width="372" height="22"><div align="center">
                                            <select name="txt_quartos_comp" size="1" id="txt_quartos_comp" class="inputBox" style="HEIGHT: 18px; WIDTH: 372px; ; font-size : 12px; background: #b2802c; color:#FFFFFF;">
                                             <option value="<%=session("vQuartos_comp")%>"><% if session("vQuartos_comp") <> "qqualquer" and session("vQuartos_comp") <> "" then response.write session("vQuartos_comp") else response.write "Quantos quartos tem o im�vel que sr(a) deseja?" end if%></option>
                                      ...
                                      <tr> 
                                        <td width="372" height="22"><div align="center">
                                            <select name="txt_vagas_comp" size="1" id="txt_vagas_comp" class="inputBox"  style="HEIGHT: 18px; WIDTH: 372px; ; font-size : 12px; background: #b2802c; color:#FFFFFF;">
                                              <option value="<%=session("vVagas_comp")%>"><% if session("vVagas_comp") <> "vgqualquer" and session("vVagas_comp") <> "" then response.write session("vVagas_comp") else response.write "Quantas vagas na garagem tem o  im�vel que sr(a) deseja?" end if%></option>
              ...
              <option value="06">09</option>
								 ...
								 <option value="<%=session("vValor_comp")%>" selected><% if session("vValor_comp") <> "vqualquer" and session("vValor_comp") <> "" then response.write FormatNumber(session("vValor_comp1"),2)&" at� "&FormatNumber(session("vValor_comp2"),2) else response.write "Qual o valor do im�vel que sr(a) deseja comprar ou alugar?" end if%></option>
          ...
          <table width="785" height="290" border="0" cellpadding="0" cellspacing="0">
            <tr>
			  ...
			  <% if vCidade_vend <> "" then %>
                  N�o foi encontrado nenhum permutante para voc�. 
                  <%else%>
                  Preencha os dados acima para encontrar algu�m para permutar(Trocar) de im�vel com voc�. 
                  <%end if%>
				  </strong></font>
