...
'----------------------------cadastrar como comprador-------------------------------
	...
	Conexao.execute"Insert into compradores(nome,telefone,email,cidade,bairro,tipo,quartos,negociacao,valor,data,descricao,descricao_confi,atendimento,data_atualizacao,vila,vagas,ocupacao,standby,origem,responsavel_cadastramento,data_ultimo_acesso,data_futuro_contato,assunto_futuro_contato,melhor_horario_visita,telefone02,telefone03,quem_atualizou,data_ligar_urgente,assunto_ligar_urgente) values( '"& vProprietario_vend &"','"& vTelefone_vend &"','"& vEmail_vend &"','"& vCidade2 &"','"& vBairro2 &"','"& vTipo &"','"& vQuartos &"','"& vExample2 &"','"& int(vStage22) &"','"& now() &"','"& vDescricao &"','"& vDescricao_confi &"','"& vAtendimento &"','"& now() &"','"& vVila2 &"','"& vVagas &"','"& vOcupacao &"','"& vStandBy &"','"& vOrigem &"','"& vResponsavel_cadastramento_comprador &"','"& now() &"','"& vData_futuro_contato_comprador &"','"& vAssunto_futuro_contato_comprador &"','"& vMelhor_horario_visita_comprador &"','"& vTelefone02_vend &"','"& vTelefone03_vend &"','"& session("nome_id") &"','"& now() &"','"& "Comprador incluído hoje" &"')"
