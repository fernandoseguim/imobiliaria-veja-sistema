...
dim varCodFranquia,varCodIP

SearchFor = request.Querystring("SearchFor")
 varCodIP = request.form("varCodIP")
 vcheck01 = request.form("check01")
 
 if varCodFranquia = "" and vcheck01 = "" then
 response.Redirect "archive_franquia.asp?SearchFor="&SearchFor&""
	...
	Conexao.execute"delete from franquia where id_franquia in ("& request.form("check01") &")"
