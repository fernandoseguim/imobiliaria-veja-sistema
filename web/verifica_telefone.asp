...
<br>
  ...
  aqui se o telefone do comprador j&aacute; est&aacute; cadastrado em compradores.</font></strong><br>
<br>
<%
Dim orderBy
...
dim rsCompradores22,strSQLCompradores22
	...
	strSQLCompradores22 = "SELECT compradores.telefone,compradores.telefone02,compradores.telefone03,compradores.cod_compradores FROM compradores where cod_compradores='0'  ORDER BY cod_compradores" 		
	end if
...
dim rsImovel22,strSQLImovel22
	...
	strSQLImovel22 = "SELECT imoveis.telefone,imoveis.telefone02,imoveis.telefone03,imoveis.cod_imovel FROM imoveis where cod_imovel='0'  ORDER BY cod_imovel" 		
	end if
...
response.write "existe um registro de imóveis"
...
<table width="750" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="300" bgcolor="#green">&nbsp;</td>
  </tr>
</table>
...
dim rsPermuta22,strSQLPermuta22
	...
	strSQLPermuta22 = "SELECT permuta.telefone,permuta.cod_permuta FROM permuta where  cod_permuta='0'  ORDER BY cod_permuta" 		
	end if
...
response.write "existe um registro de permuta"
...
%>
	...
	<tr> 
	 ...
	 <td width="240" height="18" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;"> 
        <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=rs("telefone")%></font></div></td>
