...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong><a href="archive_email_enviado.asp" target="_blank">Emails 
          ...
          <td width="136" height="20" bgcolor="<%=medio%>" style="color:#FFFFFF;border:1px solid #FFFFFF;"> 
            <% if session("permissao") = "6" and (Lcase(session("vOrigem_Franquia"))) = (Lcase(session("vOrigem_Franquia02"))) then%>
            <div align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong><a href="archive_visualiza_paginas.asp" target="_blank" style="color:#FFFFFF">Visualização 
              de páginas</a></strong></font></div>
			<%else%>
...
SQL = "Select visualiza_paginas.id_visualiza_pagina,visualiza_paginas.visualiza_pagina_nome,visualiza_paginas.visualiza_pagina_pagina,visualiza_paginas.visualiza_pagina_data,visualiza_paginas.origem_franquia from visualiza_paginas  where origem_franquia like '"&session("vOrigem_Franquia")&"' ORDER BY id_visualiza_pagina DESC"
...
SQL = "select visualiza_paginas.id_visualiza_pagina,visualiza_paginas.visualiza_pagina_nome,visualiza_paginas.visualiza_pagina_pagina,visualiza_paginas.visualiza_pagina_data,visualiza_paginas.origem_franquia  from visualiza_paginas where origem_franquia like '"&session("vOrigem_Franquia")&"' and "
do until instr(session("SearchFor"), " ") = 0
		SQL = SQL & "visualiza_pagina_data like '%" _
	...
	if len(session("SearchFor")) > 1 then
		SQL = SQL & "visualiza_pagina_data like '%" & session("SearchFor") & "%'"
	else
...
SQL = "select visualiza_paginas.id_visualiza_pagina,visualiza_paginas.visualiza_pagina_nome,visualiza_paginas.visualiza_pagina_pagina,visualiza_paginas.visualiza_pagina_data,visualiza_paginas.origem_franquia  from visualiza_paginas where origem_franquia like '"&session("vOrigem_Franquia")&"' and "
do until instr(session("SearchFor"), " ") = 0
		SQL = SQL & "visualiza_pagina_nome like '%" _
			& left(session("SearchFor"), instr(session("SearchFor")," ") - 1) & "%' or "
		session("SearchFor") = Right(session("SearchFor"), len(session("SearchFor")) - instr(session("SearchFor")," "))
	loop
	if len(session("SearchFor")) > 1 then
		SQL = SQL & "visualiza_pagina_nome like '%" & session("SearchFor") & "%'"
	else
		SQL = left(SQL, len(SQL) - 4)
	end if
...
%>
<form action="archive_visualiza_paginas.asp?SearchFor=<%=SearchFor%>&SearchWhere=<%=SearchWhere%>" Method="GET" name="b2" >
...
<font size="1" face="Verdana, Arial, Helvetica, sans-serif" color="#000000"><strong>Foram encontrados  <%=intRecordCount%> registros na busca.</strong></font>
   ...
   <center>      
 <form  Method="Post" name="Formulario" action="multi_excluir_visualiza_paginas.asp?SearchFor=<%=SearchFor%>&page=<%=intpage%>" >           
...
<input type="checkbox" name="selTodos" onclick="check(true);"></td>
            <td width="95" height="18"><% if  session("permissao") = ""  or session("permissao") = "4"  or session("permissao") = "5" or session("permissao") = "6" then %><input name="image" type="image" src="bt_excluir002.jpg" width="95" height="18" border="0"><%else%><img src="bt_excluir002.jpg" width="95" height="18" border="0"></img><%end if%></td>
		      ...
		      <td width="140" height="20" bgcolor="#000000" style="border:1px solid #FFFFFF;"><div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>P&aacute;gina 
                  visualizada </strong></font></div></td>
...
%>
	...
	%>
		...
		<tr>
		<% varCodVisualiza_Paginas = rs("id_visualiza_pagina") %>
                <td width="20" height="18" bgcolor="<%=color1%>"><input type="checkbox" name="check01" value="<%=rs("id_visualiza_pagina")%>"></td>
                    <td width="95" height="18" bgcolor="<%=color1%>"> 
                      ...
                      <a href="excluir_visualiza_paginas.asp?varCodVisualiza_Paginas=<%=varCodVisualiza_Paginas%>&SearchFor=<%=SearchFor%>&page=<%=intpage%>"><img src="bt_excluir001.jpg" width="95" height="18" border="0"></img></a> 
                      <%else%>
              ...
              <td width="140" height="20" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;"> 
                ...
                <div align="center"> <font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=rs("visualiza_pagina_pagina")%> 
                  </font> </div>
				  ...
				  <td width="250" height="18" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;"><div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=rs("visualiza_pagina_nome")%></font></div></td>
                <td width="140" height="18" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;"><div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=rs("visualiza_pagina_data")%></font></div></td>
              </tr>
			   <%
'-----------------------------------------------
