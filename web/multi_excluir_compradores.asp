...
SearchFor = request.Querystring("SearchFor")
 varCodCompradores = request.form("varCodCompradores")
 session("varCodCompradores") = varCodCompradores
 
 vcheck01 = request.form("check01")
 session("vcheck01") = vcheck01
 
 if varCodCompradores = "" and vcheck01 = "" then
 response.Redirect "archive_compradores.asp?searchFor="&searchFor&"&searchWhere="&searchWhere&""
 end if
	...
	Conexao.execute"delete from compradores where cod_compradores in ("& request.form("check01") &")"
