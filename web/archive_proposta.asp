...
SQL = "Select proposta.Cod_proposta,proposta.proposta_proposta,proposta.foto_proposta,proposta.foto_proposta,proposta.nome_proposta,proposta.telefone_proposta,proposta.email_proposta,proposta.data_proposta,proposta.horario_proposta,proposta.interesse_proposta,proposta.cod_imovel_proposta,proposta.clique,proposta.origem_franquia  from proposta  where origem_franquia like '"&session("vOrigem_Franquia")&"' ORDER BY cod_proposta DESC"
if session("SearchFor") = "" then
SQL = "Select proposta.Cod_proposta,proposta.proposta_proposta,proposta.foto_proposta,proposta.foto_proposta,proposta.nome_proposta,proposta.telefone_proposta,proposta.email_proposta,proposta.data_proposta,proposta.horario_proposta,proposta.interesse_proposta,proposta.cod_imovel_proposta,proposta.clique,proposta.origem_franquia  from proposta where origem_franquia like '"&session("vOrigem_Franquia")&"' ORDER BY cod_proposta DESC"
else

SQL = "select proposta.Cod_proposta,proposta.proposta_proposta,proposta.foto_proposta,proposta.foto_proposta,proposta.nome_proposta,proposta.telefone_proposta,proposta.email_proposta,proposta.data_proposta,proposta.horario_proposta,proposta.interesse_proposta,proposta.cod_imovel_proposta,proposta.clique,proposta.origem_franquia  from proposta where origem_franquia like '"&session("vOrigem_Franquia")&"' and "
...
%>
<form action="archive_proposta.asp?SearchFor=<%=SearchFor%>" Method="GET" name="b2" >
...
<input type="checkbox" name="selTodos" onclick="check(true);"></td>
            ...
            <td width="95" height="18"><img src="bt_incluir001.jpg" width="95" height="18" border="0"></img></td>
              <td width="20" height="20" bgcolor="#000000" style="border:1px solid #FFFFFF;"></td>
           
		      <td width="140" height="20" bgcolor="#000000" style="border:1px solid #FFFFFF;"><div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Atendimento 
                  </strong></font></div></td>
...
%>
	...
	%>
		...
		<% varCodProposta = rs("COD_proposta") %>
                <td width="20" height="18" bgcolor="<%=color1%>"><input type="checkbox" name="check01" value="<%=rs("COD_proposta")%>"></td>
                    <td width="95" height="18" bgcolor="<%=color1%>"> 
                      <% if  session("permissao") = "4" or session("permissao") = "5" or session("permissao") = "6"  then%>
                      <a href="excluir_proposta.asp?varCodProposta=<%=varCodProposta%>&SearchFor=<%=SearchFor%>&page=<%=intpage%>"><img src="bt_excluir001.jpg" width="95" height="18" border="0"></img></a> 
                      <%else%>
	 ...
	 rs444VerificaAtendimento.Open strSQL444VerificaAtendimento, Conexao
				 ...
				 if not rs444VerificaAtendimento.eof  then
				  ...
				  %>
                    ...
                    <div align="center"><a href="javascript:newWindow2('visualizar_proposta.asp?varCodProposta=<%=varCodProposta%>')"><img src="bt_visualizar_fade002.jpg" width="95" height="18" border="0"></img></a> 
                      <%else%>
                      <%  if  UCase(rs444VerificaAtendimento("atendimento")) <> UCase(Session("Admin_ID")) and (session("permissao") = "2" or session("permissao") = "4") then   %>
                      <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Não 
                        disponível</strong></font> </div>
                      <%else%>
                      <a href="javascript:newWindow2('visualizar_proposta.asp?varCodProposta=<%=varCodProposta%>')"><img src="bt_visualizar_fade002.jpg" width="95" height="18" border="0"></img></a> 
                      <%end if%>
				  ...
				  %>
                      ...
                      <a href="javascript:newWindow2('visualizar_proposta.asp?varCodProposta=<%=varCodProposta%>')"><img src="bt_visualizar002.jpg" width="95" height="18" border="0"></img></a> 
                     <%else%>
              ...
              <td width="20" height="20" bgcolor="<% if rs("clique") <> "" then response.write "green" else response.write color1 end if%>" style="border:1px solid #FFFFFF;"></td>
...
rs444VerificaAtendimento02.ActiveConnection = Conexao
	 ...
	 rs444VerificaAtendimento02.Open strSQL444VerificaAtendimento02, Conexao
				 ...
				 if not rs444VerificaAtendimento02.eof  then
				  ...
				  %>
            <div align="center">  <font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><%if trim(rs444VerificaAtendimento02("atendimento")) <> "" then response.write rs444VerificaAtendimento02("atendimento") else response.write "não informado" end if %></font>
					  
                    </div>
				  
				  <%else%>
				  <div align="center">  <font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Não informado</font>
            ...
            <%end if%>
            <%
				  rs444VerificaAtendimento02.close
				  set rs444VerificaAtendimento02 = nothing
				  ...
				  <td width="250" height="18" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;"><div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=rs("nome_proposta")%></font></div></td>
                <td width="140" height="18" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;"><div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=rs("data_proposta")%></font></div></td>
              </tr>
			   <%
'-----------------------------------------------
