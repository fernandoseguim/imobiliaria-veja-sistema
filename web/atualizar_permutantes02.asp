...
dim rs444,SQL444
 ...
 vVila2_comp = rs444("nome_combo3")
	...
	varCodimovel2 = "não informado"
	 ...
	 Conexao.execute"update permuta set cod_imovel='"&varCodImovel&"',nome='"&vProprietario&"',telefone='"&vTelefone&"',email='"&vEmail&"',endereco_vend='"&vEndereco&"',cidade_vend='"&vCidade2_vend&"',cidade_comp='"&vCidade2_comp&"',bairro_vend='"&vbairro2_vend&"',bairro_comp='"&vbairro2_comp&"',tipo_vend='"&vTipo_vend&"',tipo_comp='"&vTipo_comp&"',quartos_vend='"&vQuartos_vend&"',quartos_comp='"&vQuartos_comp&"',valor_vend='"&vValor_vend&"',valor_comp='"&vValor_comp&"',descricao_vend='"&vDescricao_vend&"',descricao_comp='"&vDescricao_comp&"',data_atualizacao='"&vData2&"',vila_vend='"&vVila2_vend&"',vila_comp='"&vVila2_comp&"',vagas_vend='"&vVagas_vend&"',vagas_comp='"&vVagas_comp&"' where cod_permuta="&varCodPermuta
	 
	
	  response.Redirect "acesso_permutantes01.asp?varSucesso_imovel="&vProprietario&"&varCodPermuta="&varCodPermuta&""
