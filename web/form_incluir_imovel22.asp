...
if (doublecombo.txt_data_futuro_contato.value == "0/0/2007 00:00:00") {
        alert("Você precisa indicar a data para o futuro contato !");
        doublecombo.txt_data_futuro_contato.focus();
		doublecombo.txt_data_futuro_contato.select();
        return false;
    }	
  ...
  <tr>
   ...
   <tr>
    <td width="590" height="30"><div align="center"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Formulário 
          de inclusão de imóveis</strong></font></div></td>
  </tr>
