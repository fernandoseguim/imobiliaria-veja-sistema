    ...
    <td width="135" style="color:#FFFFFF;border:1px solid #FFFFFF;"> 
	  ...
	  <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong><a href="archive_tipo.asp" target="_blank">Tipos de imóveis</a></strong></font></div>
        <% end if %>  
		    ...
		    <td width="135" height="20" bgcolor="<%=claro%>" style="color:#FFFFFF;border:1px solid #FFFFFF;"><div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong><a href="archive_email_enviado.asp" target="_blank">Emails 
...
SQL = "Select email.cod_email,email.nome,email.email,email.assunto,email.mensagem,email.data,email.cod_imovel,email.telefone,email.clique,email.atendimento,email.origem  from email  ORDER BY cod_email DESC"
else

SQL = "select email.cod_email,email.nome,email.email,email.assunto,email.mensagem,email.data,email.cod_imovel,email.telefone,email.clique,email.atendimento,email.origem  from email where  "
...
%>
<form action="archive_email.asp?SearchFor=<%=SearchFor%>" Method="GET" name="b2" >
...
<center>
 ...
 <form  Method="Post" name="Formulario" action="multi_excluir_email.asp?SearchFor=<%=SearchFor%>" >           
...
<input type="checkbox" name="selTodos" onclick="check(true);"></td>
          ...
          <td width="140" height="18" bgcolor="#000000" style="border:1px solid #FFFFFF;"><div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Atendimento</strong></font></div></td>
			...
			<td width="100" height="18" bgcolor="#000000" style="border:1px solid #FFFFFF;"><div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
              <strong>Origem</strong></font></div></td>
...
%>
	...
	%>
	    ...
	    <tr>
          <% varCod_email = rs("COD_email") %>
         
                
                <td width="20" height="18" bgcolor="<%=color1%>"><input type="checkbox" name="check01" value="<%=rs("COD_email")%>"></td>
                  <td width="95" height="18" bgcolor="<%=color1%>"><% if  session("permissao") = "4" or session("permissao") = "5" or session("permissao") = "6" then %><a href="excluir_email.asp?varCod_email=<%=varCod_email%>&SearchFor=<%=SearchFor%>"><img src="bt_excluir001.jpg" width="95" height="18" border="0"></img></a><%else%><img src="bt_excluir001.jpg" width="95" height="18" border="0"></img><%end if%></td>
	 ...
	 rs444VerificaAtendimento.Open strSQL444VerificaAtendimento, Conexao
				 ...
				 if not rs444VerificaAtendimento.eof  then
				  ...
				  %>
                    ...
                    <div align="center"><a href="javascript:newWindow2('visualizar_email.asp?varCod_email=<%=varCod_email%>')"><img src="bt_visualizar_fade002.jpg" width="95" height="18" border="0"></img></a> 
                      <%else%>
				  ...
				  %>
					 ...
					 <td width="20" bgcolor="<% if rs("clique") <> "" then response.write "green" else response.write color1 end if%>" height="20" style="border:1px solid #FFFFFF;"></td>
          ...
          <td width="140" height="18" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;"><div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=rs("atendimento")%></font> 
			...
			<td width="100" height="18" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;"><div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=rs("origem")%></font> 
            </div></td>
			
			<td width="150" height="18" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;"><div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=rs("nome")%></font> 
            </div></td>
