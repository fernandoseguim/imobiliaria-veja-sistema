...
vOrigem = request.form("txt_origem_comprador")
...
vAssunto_ligar_urgente = " Este comprador foi incluído pelo suporte hoje e você deve ligar imediatamente para esse cliente."
  
 
 
 
	Conexao.execute"Insert into compradores(nome,telefone,email,cidade,bairro,tipo,quartos,negociacao,valor,data,descricao,descricao_confi,atendimento,data_atualizacao,vila,vagas,ocupacao,standby,origem,responsavel_cadastramento,data_ultimo_acesso,data_futuro_contato,assunto_futuro_contato,melhor_horario_visita,telefone02,telefone03,data_ligar_urgente,assunto_ligar_urgente,quem_atualizou) values( '"& vProprietario &"','"& vTelefone &"','"& vEmail &"','"& vCidade2 &"','"& vBairro2 &"','"& vTipo &"','"& vQuartos &"','"& vNegociacao &"','"& int(vValor) &"','"& vdata &"','"& vDescricao &"','"& vDescricao_confi &"','"& vAtendimento &"','"& vData &"','"& vVila2 &"','"& vVagas &"','"& vOcupacao &"','"& vStandBy &"','"& vOrigem &"','"& vResponsavel_cadastramento_comprador &"','"& now() &"','"& vData_futuro_contato_comprador &"','"& vAssunto_futuro_contato_comprador &"','"& vMelhor_horario_visita_comprador &"','"& vTelefone02 &"','"& vTelefone03 &"','"& now() &"','"& vAssunto_ligar_urgente &"','"& session("nome_id") &"')"
...
stringCidade2 = " and (cidade like '"&vCidade2_vend&"' or cidade like '"&"não informado"&"')"
else
stringCidade2 = " and cidade like '"&"não informado"&"'"
end if
...
if vTipo_vend <> "qualquer um" then
...
dim vValorMaior
   ...
   Porcentual = int(vValor_vend)*20/100
...
strSQL444Indicacao = "SELECT compradores.cod_compradores,compradores.nome,compradores.telefone,compradores.email,compradores.endereco,compradores.cidade,compradores.bairro,compradores.tipo,compradores.quartos,compradores.negociacao,compradores.valor,compradores.descricao,compradores.data,compradores.data_atualizacao,compradores.atendimento,compradores.vagas,compradores.ocupacao,compradores.standby,compradores.cod_imovel,compradores.cod_permuta,compradores.acessos,compradores.descricao_confi,compradores.origem,compradores.dataLastEmail,compradores.textoLastEmail,compradores.responsavel_cadastramento,compradores.data_ultimo_acesso,compradores.data_futuro_contato,compradores.assunto_futuro_contato,compradores.melhor_horario_visita,compradores.telefone02,compradores.telefone03,compradores.data_ligar_urgente,compradores.assunto_ligar_urgente,compradores.quem_atualizou  FROM compradores"&stringIndex2&stringCidade2&stringBairro2&stringTipo2&stringNegociacao2&stringQuartos2&stringVagas2&stringValor2
	...
	rs444Indicacao.Open strSQL444Indicacao, Conexao
	 ...
	 if not rs444Indicacao.eof then 
                    ...
                    Conexao.execute"update compradores set data_atualizacao='"&now()&"' where cod_compradores="&rs444Indicacao("cod_compradores") 
...
'---------------------------------
	 ...
	 response.Redirect "form_incluir_compradores22.asp?varSucesso_imovel="&vProprietario&""
