...
SearchFor = request.Querystring("SearchFor")
 ...
 if varCodProposta = "" and vcheck01 = "" then
 response.Redirect "archive_proposta.asp?SearchFor="&SearchFor&""
 end if
  ...
  vNome=request.form("txtNome")
	...
	Conexao.execute"delete from proposta where cod_proposta in ("& request.form("check01") &")"
	 ...
	 response.redirect "archive_proposta.asp?SearchFor="&SearchFor&"&page="&cInt(Page)&""
