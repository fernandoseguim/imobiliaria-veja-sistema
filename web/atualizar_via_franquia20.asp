...
vAssunto_ligar_urgente = " Um novo imóvel foi atualizado e ocorreu uma indicação, ligue imediatamente para esse comprador"
   ...
   Conexao.Open dsn
	...
	strSQL444Indicacao = "Select senha.list_name,senha.admin_id,senha.admin_pass,senha.admin_email,senha.from_email,senha.url_dir,senha.url_home,senha.component,senha.smtp,senha.permissao,senha.id,senha.origem_franquia  from senha  ORDER BY ID DESC"
	...
	rs444Indicacao.Open strSQL444Indicacao, Conexao
	 ...
	 if not rs444Indicacao.eof then 
				   ...
				   Conexao.execute"update senha set origem_franquia='"&"Sao Bernardo"&"' where  id="&rs444Indicacao("id") 
