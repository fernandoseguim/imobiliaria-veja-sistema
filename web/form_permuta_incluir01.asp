...
<body onload=doublecombo.txt_telefone.focus(); bgcolor="<%=escuro%>" bottommargin="0" topmargin="0" leftmargin="0" rightmargin="0" marginheight="0" marginwidth="0" >
<form name="doublecombo"  onSubmit="return isValidDigitNumber(this);" method="post" action="incluir_permuta01.asp">
...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Este 
          &eacute; um formul&aacute;rio para voc&ecirc; se incluir no nosso banco 
          de dados de permuta, nesse banco de dados est&atilde;o todos os im&oacute;veis 
          dispon&iacute;veis para permuta, as informa&ccedil;&otilde;es que voc&ecirc; 
          nos enviar v&atilde;o ser cruzadas com as informa&ccedil;&otilde;es 
          dos outros im&oacute;veis dispon&iacute;veis para permuta. Se voc&ecirc; 
          quiser encontrar algu&eacute;m para fazer permuta v&aacute; na nossa 
          pesquisa de permuta e coloque os dados do seu im&oacute;vel e os dados 
          do im&oacute;vel que voc&ecirc; pretende ter. Ao enviar esse formul&aacute;rio 
          ser&aacute; criada uma conta de permutante, nessa conta, nosso sistema 
          indicar&aacute; para voc&ecirc; v&aacute;rias op&ccedil;&otilde;es de 
          permuta dispon&iacute;veis no nosso banco de dados. &quot;OBS: As conta 
          s&atilde;o gratuitas&quot;</strong></font></div></td>
  </tr>
    ...
    <td><table width="590" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td><table width="580" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
                  <td bgcolor="<%=claro%>" width="290" style="border:1px solid #FFFFFF;">
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Seu 
                      nome </font></div></td>
                <td bgcolor="<%=claro%>" width="290" style="border:1px solid #FFFFFF;"><input name="txt_proprietario" type="text" onfocus="doublecombo.txt_proprietario.value=''" value="Clique aqui e comece a digitar...." id="txt_proprietario" size="38" maxlength="35" align="left" class="inputBox" style="HEIGHT: 18px; WIDTH: 290px; background:<%=claro%>"></td>
              </tr>
              <tr>
...
<input name="txt_endereco" type="text" id="txt_endereco" size="38" maxlength="50" align="left" class="inputBox" style="HEIGHT: 18px; WIDTH: 290px ; background: <%=medio%>"></td>
              ...
              <tr>
                  <td bgcolor="<%=claro%>" style="border:1px solid #FFFFFF;"> 
                    <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
                      cidade do im&oacute;vel</font></div></td>
                  <td bgcolor="<%=claro%>" style="border:1px solid #FFFFFF;">
                ...
                <tr> 
                  <td bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"> 
                    <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
                      bairro do im&oacute;vel</font></div></td>
			  ...
			  <tr> 
                  <td bgcolor="<%=claro%>" style="border:1px solid #FFFFFF;"> 
                    <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
                      Vila do im&oacute;vel</font></div></td>
			  ...
			  <tr>
                ...
                <tr> 
                  <td bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><table width="290" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                        <td width="290" height="18" bgcolor="<%=medio%>" style="border-bottom: 2px solid #FFFFFF;"> 
                          <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Descrição do seu imóvel</font></div></td>
                    </tr>
                    <tr> 
                  ...
                  <td bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"> 
                    <textarea name="txt_descricao_vend" class="inputBox" id="txt_descricao_vend" style="HEIGHT: 100px; WIDTH: 290px; background:<%=medio%>" onKeyPress="return limitfield(this, 200)"></textarea></td>
              </tr>
			  <tr>
                  <td height="30" bgcolor="<%=escuro%>" > 
                    <div align="center"></div></td>
                  <td height="18" bgcolor="<%=escuro%>" > <font color="#FFFFFF"> 
			  ...
			  <tr>
				...
				<tr>
                  <td bgcolor="<%=claro%>" style="border:1px solid #FFFFFF;"> 
                    <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Valor 
                      do im&oacute;vel pretendido</font></div></td>
                  <td bgcolor="<%=claro%>" style="border:1px solid #FFFFFF;"><font color="#FFFFFF">
                    <input name="txt_valor_comp" type="text" class="inputBox" id="txt_valor_comp" style="HEIGHT: 18px; WIDTH: 150px; background:<%=claro%>" value="0,00" size="12" maxlength="20">
                    </font> </td>
              </tr>
			    ...
			    <tr>
                  ...
                  <td bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><font color="#FFFFFF">
                    <select name="txt_pergunta" size="1" id="txt_pergunta" class="inputBox" style="HEIGHT: 18px; WIDTH: 150px; background: <%=medio%>">
              ...
              <tr>
                <td width="290" height="100" style="border:1px solid #FFFFFF;" ><table width="290" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <td width="290" height="100" bgcolor="<%=claro%>" style="border:1px solid #FFFFFF;" ><textarea name="txt_descricao_comp" class="inputBox" id="txt_descricao_comp" style="HEIGHT: 100px; WIDTH: 290px; background:<%=claro%>" onKeyPress="return limitfield(this, 200)"></textarea></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
