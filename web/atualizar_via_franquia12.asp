...
vAssunto_ligar_urgente = " Um novo imóvel foi atualizado e ocorreu uma indicação, ligue imediatamente para esse comprador"
   ...
   Conexao.Open dsn
	...
	strSQL444Indicacao = "Select  financiamentos.cod_financiamentos,financiamentos.nome,financiamentos.telefone,financiamentos.email,financiamentos.valor,financiamentos.cod_imovel,financiamentos.data,financiamentos.origem_franquia from financiamentos  ORDER BY cod_financiamentos DESC"
	...
	rs444Indicacao.Open strSQL444Indicacao, Conexao
	 ...
	 if not rs444Indicacao.eof then 
				   ...
				   Conexao.execute"update financiamentos set origem_franquia='"&"Sao Bernardo"&"' where  cod_financiamentos="&rs444Indicacao("cod_financiamentos") 
