...
<%
Dim Conexao,strSQL,rs,varCod_bairro,vcheck01,SearchFor,SearchWhere
...
SearchWhere = request.querystring("SearchWhere")
 ...
 vcheck01 = request.form("check01")                                                           
	...
	response.Redirect "archive_bairro.asp?SearchWhere="&SearchWhere&""
	end if														  
	...
	Conexao.Open dsn
	 ...
	 Conexao.execute"delete from combo2 where id_combo2 in ("& request.form("check01") &")"
