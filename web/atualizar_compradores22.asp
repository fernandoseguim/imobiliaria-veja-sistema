...
'---------------------------------
 ...
 vVila2_vend = "não informado"
  ...
  if session("permissao") <> "2" then
	 Conexao.execute"update compradores set nome='"&vProprietario&"',telefone='"&vTelefone&"',email='"&vEmail&"',cidade='"&vCidade2&"',bairro='"&vbairro2&"',tipo='"&vTipo&"',quartos='"&vQuartos&"',valor='"&int(vValor)&"',descricao='"&vDescricao&"',descricao_confi='"&vDescricao_confi&"',negociacao='"&vNegociacao&"',atendimento='"&vAtendimento&"',data_atualizacao='"&vData2&"',vila='"&vVila2 &"',vagas='"&vVagas &"',ocupacao='"&vOcupacao &"',standby='"&vStandby &"',origem='"&vOrigem &"',responsavel_cadastramento='"&vResponsavel_cadastramento_comprador &"',data_futuro_contato='"&vData_futuro_contato_comprador &"',assunto_futuro_contato='"&vAssunto_futuro_contato_comprador &"',melhor_horario_visita='"&vMelhor_horario_visita_comprador &"',telefone02='"&vTelefone02 &"',telefone03='"&vTelefone03 &"',data_ligar_urgente='"&now()&"',assunto_ligar_urgente='"&"Esse comprador foi atualizado pelo suporte hoje e você deve entrar em contato com o cliente imediatamente."&"',quem_atualizou='"&session("nome_id")&"' where cod_compradores="&varCodCompradores
	 
	 else
	  Conexao.execute"update compradores set nome='"&vProprietario&"',telefone='"&vTelefone&"',email='"&vEmail&"',cidade='"&vCidade2&"',bairro='"&vbairro2&"',tipo='"&vTipo&"',quartos='"&vQuartos&"',valor='"&int(vValor)&"',descricao='"&vDescricao&"',descricao_confi='"&vDescricao_confi&"',negociacao='"&vNegociacao&"',atendimento='"&vAtendimento&"',vila='"&vVila2 &"',vagas='"&vVagas &"',ocupacao='"&vOcupacao &"',standby='"&vStandby &"',origem='"&vOrigem &"',responsavel_cadastramento='"&vResponsavel_cadastramento &"',data_futuro_contato='"&vData_futuro_contato_comprador &"',assunto_futuro_contato='"&vAssunto_futuro_contato_comprador &"',melhor_horario_visita='"&vMelhor_horario_visita_comprador &"',telefone02='"&vTelefone02 &"',telefone03='"&vTelefone03 &"',data_ligar_urgente='"&"0/0/2007 00:00:00"&"',assunto_ligar_urgente='"&"Não informado"&"',quem_atualizou='"&session("nome_id")&"' where cod_compradores="&varCodCompradores
	 end if
...
if  int(vQuartos_vend) <> 0 then
stringQuartos2 = " and quartos<="&int(vQuartos_vend)&""
else
stringQuartos2 = ""
end if
...
if  int(vVagas_vend) <> 0 then
stringVagas2 = " and vagas <="&int(vVagas_vend)&""
else
stringVagas2 = ""
end if
...
stringValor2 = " and Valor >="& int(vValorMenor) &" and Valor <="& int(vValorMaior) &""
...
vAssunto_ligar_urgente = " Um novo imóvel foi incluído pelo suporte e ocorreu uma indicação, ligue imediatamente para esse comprador."
...
'---------------------------------
	...
	'-------------------------------------------------------------------
	 ...
	 response.Redirect "visualizar_compradores22.asp?varSucesso_imovel="&vProprietario&"&varCodCompradores="&varCodCompradores&""
