...
if  int(session("vArea_Total")) <> 0 and  session("vArea_Total") <> "" then
...
'strSQL ="SELECT SUM(valor) as total  FROM Imoveis"&stringIndex&stringCidade&"  "
...
'----------------------------------------------------Fim da instrução SQL---------------------------------
 ...
 EnderecoIP = request.ServerVariables("REMOTE_ADDR")
  ...
  if session("vVagas") = "gqualquer" or session("vVagas") = "" then
 vVagasConta = "0"
 else
 vVagasConta = session("vVagas")
 end if
 
  if session("vQuartos") = "qqualquer" or session("vQuartos") = "" then
 vQuartosConta = "0"
 else
...
'SQL2 = "SELECT *FROM Imoveis"&stringIndex&stringCidade&stringBairro&stringTipo&stringNegociacao&string_Area_Total&"   "
...
<table width="350" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="120">
<center>
        <strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">O 
        valor aproximado do imóvel é <br>
<br><br><br><br>
        ...
        no sistema. <br>
        <br>
        OBS: Podem ocorrem variações no valor encontrado. <br>
        </font></strong> 
      </center></td>
  </tr>
</table>
