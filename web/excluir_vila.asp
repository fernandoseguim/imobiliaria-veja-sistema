...
<%
Dim Conexao,strSQL,rs,varCod_Vila,SearchFor,SearchWhere,SearchWhereFor,page
 varCod_Vila = request.QueryString("varCod_Vila")
...
SearchWhere = request.querystring("SearchWhere")
 SearchWhereFor = request.querystring("SearchWhereFor")
   page = request.querystring("page")                                                         
	...
	Conexao.execute"Delete from combo3 where id_combo3="&VarCod_Vila
	 ...
	 response.redirect "archive_vila.asp?SearchWhere="&SearchWhere&"&SearchWhereFor="&SearchWhereFor&"&SearchFor="&SearchFor&"&page="&page&""
