...
'------------------------------selecionar os tipos de imóvel para o formulário-------------------
 ...
 dim rs444Tipo22,strSQL444Tipo22
	...
	strSQL444Tipo22 = "SELECT * FROM tipo  ORDER BY id_tipo ASC" 
...
<table width="755" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td width="755" height="243"><table width="755" height="243" border="0" cellpadding="0" cellspacing="0">
        <tr>
                  <td width="176" height="243" align="center" background="fundo_primeira.jpg" bgcolor="#000000"><table width="149" border="0"  cellspacing="0" cellpadding="0" height="170">
                            <tr>
  ...
  <tr>
            <td width="755" height="50"> 
              <div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong><font color="#FF0000">Aten&ccedil;&atilde;o!!</font></strong> 
                ...
                com atendimento preferencial.</font></strong></font><strong><font size="1" face="Verdana, Arial, Helvetica, sans-serif"></font></strong></div></td>
  </tr>
</table></form>
                    ...
                    <tr>
                      <td width="173" height="100" valign="bottom"><center>
                          <table width="160" height="93" border="1" cellpadding="0" cellspacing="0" bordercolor="6C3404">
                            <tr>
                                            <td bgcolor="<%=escuro%>"><% If objFSO.FileExists(Server.MapPath(rsFrontPage("foto_pequena"))) = True Then%><a href="javascript:newWindow2('mostrar_imovel2.asp?varCodimovel=<%=rsFrontPage("cod_imovel")%>')"><img src="<%=rsFrontPage("foto_pequena")%>" width="158" height="91" border="0"></img></a><%else%><div align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF"><a href="javascript:newWindow2('mostrar_imovel2.asp?varCodimovel=<%=rsFrontPage("cod_imovel")%>')" style="color:#FFFFFF"><strong>Foto não disponível</strong></a></font></div><%end if%></td>
                            </tr>
                          </table>
                        </center>
                        </td>
