...
SearchFor = request.Querystring("SearchFor")
 varCodCompradoresProcurados = request.form("varCodCompradoresProcurados")
 session("varCompradoresProcurados") = varCodCompradoresProcurados
 
 vcheck01 = request.form("check01")
 session("vcheck01") = vcheck01
 
 if varCodCompradoresProcurados = "" and vcheck01 = "" then
 response.Redirect "archive_compradores_procurados.asp?searchFor="&searchFor&"&searchWhere="&searchWhere&""
 end if
	...
	Conexao.execute"delete from compradores_procurados where cod_compradoresprocurados in ("& request.form("check01") &")"
	 ...
	 response.redirect "archive_compradores_procurados.asp?page="&cInt(Page)&"&SearchFor="&SearchFor&""
