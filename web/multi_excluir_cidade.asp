...
<%
Dim Conexao,strSQL,rs,varCod_cidade,vcheck01,SearchFor




 varCod_cidade = request.form("varCod_cidade")
 vcheck01 = request.form("check01")                                                           
	
	if varCod_cidade = "" and vcheck01 = "" then
	response.Redirect "archive_cidade.asp"
	end if														  
	...
	Conexao.execute"delete from combo1 where id_combo1 in ("& request.form("check01") &")"
	 
	 Conexao.execute"delete from combo2 where id_combo1 in ("& request.form("check01") &")"
