...
<%
Dim Conexao,strSQL,rs,varCod_cidade,SearchFor
 varCod_cidade = request.QueryString("varCod_cidade")
	...
	Conexao.execute"Delete from combo1 where id_combo1="&VarCod_cidade 
	Conexao.execute"Delete from combo2 where id_combo1="&VarCod_cidade
