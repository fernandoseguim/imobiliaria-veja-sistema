...
SQL = "select permuta.cod_permuta,permuta.atendimento,permuta.nome,permuta.telefone,permuta.endereco_vend  from permuta where telefone like '%"&session("SearchFor")&"%' order by cod_permuta Desc "
...
SQL = "select permuta.cod_permuta,permuta.atendimento,permuta.nome,permuta.telefone,permuta.endereco_vend from permuta order by cod_permuta Desc"
...
%>
	...
	<% varCod_permuta = rs("cod_permuta") %>
	<tr> 
    
	
	 <td width="150" height="18" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;"> 
        <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><a href="javascript:newWindow1974('visualizar_permuta33.asp?varCodPermuta=<%=varCod_Permuta%>')"><%=rs("atendimento")%></a></font></div></td> 
	 
	
	 <td width="150" height="18" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;"> 
        <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><a href="javascript:newWindow1974('visualizar_permuta33.asp?varCodPermuta=<%=varCod_Permuta%>')"><%=rs("nome")%></a></font></div></td> 
	 
	 
	 <td width="240" height="18" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;"> 
        <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><a href="javascript:newWindow1974('visualizar_permuta33.asp?varCodPermuta=<%=varCod_Permuta%>')"><%=rs("telefone")%></a></font></div></td>
	 
	<td width="240" height="18" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;"> 
        <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><a href="javascript:newWindow1974('visualizar_permuta33.asp?varCodPermuta=<%=varCod_Permuta%>')"><%=rs("endereco_vend")%></a></font></div></td>
