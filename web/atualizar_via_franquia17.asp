...
vAssunto_ligar_urgente = " Um novo imóvel foi atualizado e ocorreu uma indicação, ligue imediatamente para esse comprador"
   ...
   Conexao.Open dsn
	...
	strSQL444Indicacao = "Select email_enviado.cod_email_enviado,email_enviado.nome,email_enviado.telefone,email_enviado.email,email_enviado.atendimento,email_enviado.de,email_enviado.para,email_enviado.assunto,email_enviado.mensagem,email_enviado.data,email_enviado.origem_franquia  from email_enviado   ORDER BY cod_email_enviado DESC"
	...
	rs444Indicacao.Open strSQL444Indicacao, Conexao
	 ...
	 if not rs444Indicacao.eof then 
				   ...
				   Conexao.execute"update email_enviado set origem_franquia='"&"Sao Bernardo"&"' where  cod_email_enviado="&rs444Indicacao("cod_email_enviado") 
