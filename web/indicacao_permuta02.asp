...
'else
 ...
 if varIndicacaoTipoComp <> "qualquer um" and varIndicacaoTipoComp <> "não informado" then
...
%>
  <strong><font size="1" face="Verdana, Arial, Helvetica, sans-serif">Foram encontrados<%=intRecordCount%> 
  permutantes</font></strong> 
  <br>
    ...
    <td width="568" height="153"><table width="568" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td><table width="552" height="153" border="0" cellpadding="0" cellspacing="0" bgcolor="FE9225">
              ...
              <tr> 
                              <td width="552" height="16" bgcolor="E17508"><div align="center"><a href="javascript:newWindow2('indicacao_display_permuta22.asp?varCodPermuta=<%=varCodPermuta%>')"> 
                      ...
                      <td width="173" bgcolor="FE9225"> 
                        <center>
                          <table width="160" height="93" border="1" cellpadding="0" cellspacing="0" bordercolor="6C3404">
                            <tr>
                              <td bgcolor="<%=escuro%>"><% If objFSO.FileExists(Server.MapPath(vimagem)) = True Then %><a href="indicacao_display_permuta22.asp?varCodPermuta=<%=varCodPermuta%>"><img src="<%=vimagem%>" width="158" height="90" border=0></img></a><%else%><div align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF"><a href="indicacao_display_permuta22.asp?varCodPermuta=<%=varCodPermuta%>" style="color:#FFFFFF" ><strong>Foto não disponível</strong></a></font></div><% end if %></td>
                            </tr>
                          </table>
                        </center>
