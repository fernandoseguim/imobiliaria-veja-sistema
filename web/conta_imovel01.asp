 ...
 '--------------incluir conta acessada-----------------
  ...
  dim JaComprador
	...
	JaComprador = "JaExiste"
	 ...
	 'JaComprador = "JaExiste"
	 Conexao.execute"Insert into contas_procuradas(nome,telefone,codigo_conta,tipo_conta,endereco_ip,data,atendimento,origem_franquia) values( '"& rs("proprietario") &"','"& rs("telefone") &"','"& rs("cod_imovel") &"','"& "Imóvel" &"','"& EnderecoIP2 &"','"& now() &"','"& rs("captacao") &"','"& rs("origem_franquia") &"')"
...
If NOT (RS2.BOF AND RS2.EOF) and vMostrar001 <> "não" Then
