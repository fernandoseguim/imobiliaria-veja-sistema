...
<body onload=doublecombo.txt_telefone.focus(); bgcolor="<%=escuro%>" topmargin="0" bottommargin="10" leftmargin="0" rightmargin="0" marginheight="0" marginwidth="0">
<form name="doublecombo"  onSubmit="return isValidDigitNumber(this);" method="post" action="incluir_imovel_internet02.asp">
...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Este 
          ...
          claro dos dados pessoais como email ,telefone e endere&ccedil;o se voc&ecirc; 
          aceitar fazer permuta informe no cadastro abaixo, voc&ecirc; pode cadastrar 
          seu im&oacute;vel com foto ou sem foto, se quiser cadastrar com foto 
          clique em cadastramento com foto. Al&eacute;m disso ser&aacute; criada 
          uma conta de vendedor de im&oacute;vel para voc&ecirc;,nessa conta nosso 
          sistema vai indicar v&aacute;rios compradores interessados no seu im&oacute;vel 
          que poderam ser contatos a qualquer momento. &quot;OBS: As conta s&atilde;o 
          gratuitas&quot;</strong></font></div></td>
  </tr>
  <tr>
...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Seu 
              nome </font></div></td>
          <td width="290" style="border:1px solid #FFFFFF; background:<%=claro%>" ><input name="txt_proprietario" onfocus="doublecombo.txt_proprietario.value=''" value="Clique aqui  e comece a digitar...." type="text" id="txt_proprietario" size="38" maxlength="35" align="left" class="inputBox" style="HEIGHT: 18px; WIDTH: 290px; background:<%=claro%>" ></td>
        </tr>
        <tr>
		...
		<tr>
            <td bgcolor="<%=claro%>" style="border:1px solid #FFFFFF; background:<%=claro%>">
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Seu 
              email </font></div></td>
  ...
  <tr> 
    ...
    <td><div align="center"> 
          <table width="580" border="0" cellspacing="0" cellpadding="0">
            ...
            <td width="290"style="border:1px solid #FFFFFF; background:<%=medio%>" > <input name="txt_endereco" type="text" id="txt_endereco" size="38" maxlength="50" align="left" class="inputBox" style="HEIGHT: 18px; WIDTH: 290px ; background:<%=medio%>"></td>
          </tr>
          <tr> 
              <td width="290" bgcolor="<%=claro%>" style="border:1px solid #FFFFFF; background:<%=claro%>">
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Cidade 
                  do im&oacute;vel</font></div></td>
            <td width="290" style="border:1px solid #FFFFFF; background:<%=claro%>"> <select name="combo1" onChange="javascript:atualizacarros(this.form);" class="inputBox" style="HEIGHT: 18px; WIDTH: 150px; background:<%=claro%>">
...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Bairro 
                  do im&oacute;vel</font></div></td>
            <td width="290" style="border:1px solid #FFFFFF; background:<%=medio%>"> <select name="combo2" onChange="javascript:atualizacarros888(this.form);" class="inputBox" style="HEIGHT: 18px; WIDTH: 150px; background:<%=medio%>">
...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Vila 
                  do im&oacute;vel</font></div></td>
              <td width="290" style="border:1px solid #FFFFFF; background:<%=claro%>"><select name="combo5" class="inputBox" id="combo5" style="HEIGHT: 18px; WIDTH: 150px; background:<%=claro%>">
...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">&Aacute;rea 
            ...
            <td width="290" style="border:1px solid #FFFFFF; background:<%=claro%>"><font color="#FFFFFF">
                <input name="txt_a_total" value="00" type="text" id="txt_a_total" size="12" maxlength="20" class="inputBox" style="HEIGHT: 18px; WIDTH: 150px; background:<%=claro%>">
...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">&Aacute;rea 
            ...
            <td width="290" style="border:1px solid #FFFFFF; background:<%=medio%>"><input name="txt_a_constr" type="text" value="00" id="txt_a_constr" size="12" maxlength="20" class="inputBox" style="HEIGHT: 18px; WIDTH: 150px; background: <%=medio%>"> 
...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">quartos</font></div></td>
            <td width="290" style="border:1px solid #FFFFFF; background:<%=claro%>"><select name="txt_quartos" id="txt_quartos" class="inputBox" style="HEIGHT: 18px; WIDTH: 150px; background:<%=claro%>">
...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Banheiros</font></div></td>
            <td width="290" style="border:1px solid #FFFFFF; background:<%=medio%>"><select name="txt_banheiros" id="txt_banheiros" class="inputBox" style="HEIGHT: 18px; WIDTH: 150px; background: <%=medio%>">
                <option value="não informado" selected>não informado</option>
                <option value="01">01</option>
                <option value="02">02</option>
                <option value="03">03</option>
...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Vagas 
            ...
            <td width="290" style="border:1px solid #FFFFFF; background:<%=claro%>"><select name="txt_vagas" id="txt_vagas" class="inputBox" style="HEIGHT: 18px; WIDTH: 150px; background:<%=claro%>">
                <option value="não informado" selected>não informado</option>
                <option value="01">01</option>
                <option value="02">02</option>
                <option value="03">03</option>
...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Negocia&ccedil;&atilde;o</font></div></td>
            <td width="290" style="border:1px solid #FFFFFF; background:<%=medio%>"><select name="txt_negociacao" id="txt_negociacao" class="inputBox" style="HEIGHT: 18px; WIDTH: 150px; background: <%=medio%>">
...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Ocupa&ccedil;&atilde;o</font></div></td>
            <td width="290" style="border:1px solid #FFFFFF; background:<%=claro%>"><select name="txt_ocupacao" id="txt_ocupacao" class="inputBox" style="HEIGHT: 18px; WIDTH: 150px; background:<%=claro%>">
                <option value="não informado" selected>não informado</option>
...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Descri&ccedil;&atilde;o 
            ...
            <td width="290" style="border:1px solid #FFFFFF; background:<%=medio%>"><textarea name="obs_imovel" class="inputBox" id="obs_imovel" style="HEIGHT: 100px; WIDTH: 290px; background: <%=claro%>" onKeyPress="return limitfield(this, 200)"></textarea></td>
          </tr>
		  <tr> 
...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Valor 
			...
			<tr> 
              <td width="290" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF; background:<%=medio%>"><table width="290" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <td width="290" height="18" bgcolor="<%=medio%>" style="border-bottom: 2px solid #FFFFFF; background:<%=medio%>"> 
                      <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Descrição 
                        do imóvel pretendido</font></div></td>
                    </tr>
                    <tr>
              ...
              <td width="290" style="border:1px solid #FFFFFF; background:<%=medio%>"><textarea name="txt_descricao_comp" class="inputBox" id="textarea2" style="HEIGHT: 100px; WIDTH: 290px; background: <%=medio%>" onKeyPress="return limitfield(this, 200)"></textarea></td>
            </tr>
			<tr> 
