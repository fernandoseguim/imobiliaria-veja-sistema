...
<div align="center"><br>
  ...
  <font color="#9d9249"><font face="Verdana" size="2"></font></font> </div>
<form action="procurar_avaliacao02.asp" Method="post" name="nform" onSubmit="return isValidDigitNumber(this);">
  <table border="0" cellpadding="0" cellspacing="0" align="center">
<tr>
      <td bgcolor="#f7ecbf" style="border:1px solid <%=claro%>;"> 
