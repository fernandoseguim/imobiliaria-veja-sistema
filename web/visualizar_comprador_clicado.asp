          ...
          <td><table width="580" border="0" cellspacing="0" cellpadding="0">
			   ...
			   <tr> 
                ...
                <tr> 
                  ...
                  <td bgcolor="<%=claro%>" style="border:1px solid #FFFFFF;"><input name="txt_proprietario" type="text" class="inputBox" id="txt_proprietario" style="HEIGHT: 18px; WIDTH: 290px; background:<%=medio%>" value="<%=rs9("nome")%>" size="38" maxlength="50" align="left"></td>
                </tr>
                <tr> 
                  <td bgcolor="<%=claro%>" style="border:1px solid #FFFFFF;"> 
                    <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Telefone 
                      do interessado</font></div></td>
                  <td bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><input name="txt_telefone" type="text" class="inputBox" id="txt_telefone" style="HEIGHT: 18px; WIDTH: 290px; background: <%=claro%>" value="<%=rs9("telefone")%>" size="38" maxlength="30" align="left"></td>
                </tr>
                <tr> 
                ...
                <td bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><input name="txt_telefone2" type="text" class="inputBox" id="txt_telefone2" style="HEIGHT: 18px; WIDTH: 290px; background: <%=medio%>" value="<%=rs9("email")%>" size="38" maxlength="50" align="left"></td>
                </tr>
                <tr> 
                  <td bgcolor="<%=claro%>" style="border:1px solid #FFFFFF;"> 
                  ...
                  <td bgcolor="<%=claro%>" style="border:1px solid #FFFFFF;"> 
                    <select name="combo1" onChange="javascript:atualizacarros(this.form);" class="inputBox" style="HEIGHT: 18px; WIDTH: 150px; background:<%=claro%>">
                      <option value="" select><%if rs9("cidade") = "cqualquer" then response.write "não informado" else response.write rs9("cidade") end if%></option>
                ...
                <tr> 
                  ...
                  <td bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"> 
                    <select name="combo2" class="inputBox" onChange="javascript:atualizacarros222(this.form);" style="HEIGHT: 18px; WIDTH: 150px; background:<%=medio%>">
                      <option value="" selected><%if rs9("bairro") = "bqualquer" then response.write "não informado" else response.write rs9("bairro") end if%></option>
                ...
                <tr> 
                  ...
                  <td bgcolor="<%=claro%>" style="border:1px solid #FFFFFF;"> 
                    <select name="combo5" class="inputBox" id="combo5" style="HEIGHT: 18px; WIDTH: 150px; background:<%=claro%>">
                      <option value="" selected><%if rs9("vila") = "vlqualquer" then response.write "não informado" else response.write rs9("vila") end if%></option>
                ...
                <tr> 
                  ...
                  <td bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><font color="#FFFFFF"> 
                    <select name="txt_tipo" size="1" id="select3" class="inputBox" style="HEIGHT: 18px; WIDTH: 150px; background: <%=medio%>">
                      <option value="<%=rs9("tipo")%>" selected><%if rs9("tipo") = "tqualquer" then response.write "não informado" else response.write rs9("tipo") end if%></option>
                ...
                <tr> 
                  ...
                  <td bgcolor="<%=claro%>" style="border:1px solid #FFFFFF;"> 
                    <select name="txt_ocupacao" id="txt_ocupacao" class="inputBox" style="HEIGHT: 18px; WIDTH: 150px; background:<%=claro%>">
                      <option value="<%=rs9("ocupacao")%>" selected><%if rs9("ocupacao") = "oqualquer" then response.write "não informado" else response.write rs9("ocupacao") end if%></option>
                      <option value="não informado">não informado</option>
