...
response.redirect "form_atualizar_foto02.asp?varResultado="&"Já existe uma foto com esse nome, tente outro!!!"&"&varCodImovel="&varCodImovel&""
else
...
If objFSO.FileExists(Server.MapPath(rs("Foto_grande1"))) = True  Then
  ...
  response.Redirect "form_atualizar_foto02.asp?varResultado="&"Mais uma foto atualizada!"&"&varCodImovel="&varCodImovel&""
   end if
  ...
  response.Redirect "form_atualizar_foto02.asp?varResultado="&"Mais uma foto atualizada!"&"&varCodImovel="&varCodImovel&""
   ...
   '-------------------------------------------------------------------------------
    ...
    ' response.Redirect "form_atualizar_foto02.asp?varResultado="&"Mais uma foto incluída!"&"&varCodImovel="&varCodImovel&""
