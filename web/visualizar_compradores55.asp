...
if (doublecombo.txt_email_vend.value == "" ) {
        alert("Você precisa indicar o email do cliente!");
...
if (doublecombo.txt_descricao.value == "" ) {
        alert("Você precisa fazer uma observação sobre esse cliente!");
        doublecombo.txt_descricao.focus();
		doublecombo.txt_descricao.select();
        return false;
    }

if (doublecombo.txt_descricao.value == "não informado" ) {
        alert("Você precisa fazer uma observação sobre esse cliente!");
        doublecombo.txt_descricao.focus();
		doublecombo.txt_descricao.select();
        return false;
...
if ( doublecombo.txt_telefone_vend.value == "") {
        alert("Você precisa informar o telefone do cliente");
...
var strValidNumber909_ja="1234567890,.";
for (nCount=0; nCount < doublecombo.stage22.value.length; nCount++) 
		{
strTempChar909_ja=doublecombo.stage22.value.substring(nCount,nCount+1);
if (strValidNumber909_ja.indexOf(strTempChar909_ja,0)==-1) 
{
alert("O item valor só pode conter números e uma vírgula!");
...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Que 
    ...
    <td width="200" height="20"><div align="center"><font color="<%=letra%>" size="4" face="Verdana, Arial, Helvetica, sans-serif"><strong>Compradores</strong></font><br>
                ...
                de financiamento</a></font>
				<br>
				<a href="javascript:newWindow88('imprimir_compradores22.asp?varCodCompradores=<%=varCodCompradores%>')" style="color:<%=letra%>"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Imprimir</font></a>
				<br>
				<font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong><a href="javascript:newWindow88('form_enviar_email22.asp?varIndicacaoCidade=<%=rs("cidade")%>&varIndicacaoBairro=<%=rs("bairro")%>&varIndicacaoTipo=<%=rs("tipo")%>&varIndicacaoNegociacao=<%=rs("negociacao")%>&varIndicacaoQuartos=<%=rs("quartos")%>&varIndicacaoVagas=<%=rs("vagas")%>&varIndicacaoValor=<%=rs("valor")%>&varIndicacaoCondominio=<%=rs("condominio")%>&varIndicacaoAreaTotal=<%=rs("area_total")%>&varIndicacaoSuites=<%=rs("suites")%>&varIndicacaoPiscina=<%=rs("piscina")%>&varIndicacaoPortaria=<%=rs("portaria")%>&varIndicacaoQuintal=<%=rs("quintal")%>&varIndicacaoQuadras=<%=rs("quadras")%>&varIndicacaoEdicula=<%=rs("edicula")%>&varIndicacaoOcupacao=<%=rs("ocupacao")%>&varCodCompradores=<%=rs("cod_compradores")%>')" style="color:#FFFFFF ; text-decoration:none">Email</a></strong></font> 
				</div>
      </td>
    <td width="400" height="20"><div align="center">
                <%
  ...
  <tr> 
	...
	<tr> 
        ...
        <tr> 
          ...
          <td width="10">&nbsp;</td>
            <td width="192" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"> 
              <input name="txt_telefone_vend" value="<%=rs("telefone")%>" type="<%if session("permissao") <> "4"and session("permissao") <> "3" and  session("permissao") <> "5" and  session("permissao") <> "6" then %><% if  UCase(rs("atendimento")) <> UCase(Session("Admin_ID")) then response.write "Hidden" else response.write "text" end if %><%else%><%response.write "text" end if %>" id="txt_telefone_vend" size="38" maxlength="50" align="left" class="inputBox" style="HEIGHT: 18px; WIDTH: 190px; background: <%=medio%>">
            </td>
          <td width="10">&nbsp;</td>
            <td width="192" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"> 
...
<% if not rs444Tipo23.eof then%>
  ...
  <tr> 
        ...
        <tr> 
          ...
          <td width="10">&nbsp;</td>
            <td width="192" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><input name="txt_condominio" type="text" class="inputBox" id="txt_condominio" style="HEIGHT: 18px; WIDTH: 190px; background:<%=medio%>" value="<%if rs("condominio") <> "" then response.write rs("condominio") else response.write "0" end if%>" size="12" maxlength="13"></td>
          <td width="10">&nbsp;</td>
    ...
    <td><table width="1000" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="495"><font color="<%=letra%>" size="1" face="Verdana, Arial, Helvetica, sans-serif">Observa&ccedil;&otilde;es 
              do im&oacute;vel desejado e a forma de pagamento desse cliente</font></td>
          <td width="10">&nbsp;</td>
  ...
  <tr> 
    <td><table width="1000" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="10">&nbsp;</td>
         <td width="495" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><textarea name="txt_descricao_confi" COLS=20 ROWS=10 class="inputBox" id="txt_descricao_confi" style="HEIGHT: 78px; WIDTH: 493px; background:<%=medio%>" onKeyPress="return limitfield(this, 800)"><%=rs("descricao_confi")%></textarea></td>
	    </tr>
      </table></td>
  </tr>
...
rsFichaBairro.ActiveConnection = Conexao3
  ...
  <tr>
	...
	<br><br> 
          ...
          <select name="txt_pergunta" id="txt_pergunta" class="inputBox" style="HEIGHT: 18px; WIDTH: 150px; background: <%=claro%>">
			...
			<option value="sim" <% if  ( semImovel <> "nothing" and semImovel <> "" ) then response.write "selected" end if %> >Sim</option>
  ...
  if  ( semImovel <> "nothing" and semImovel <> "" ) then
    ...
    <td> <table width="1000" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          <td width="192" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;">
			    ...
			    <option value="<%=rs444Imovel("captacao")%>" selected ><%=rs444Imovel("captacao")%></option>
					 <option value="internet">internet</option>
  ...
  <tr> 
    <td> <table width="1000" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          ...
          <td width="10">&nbsp;</td>
            <td width="192" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><input name="txt_nome_edificio_vend" type="text" class="inputBox" id="txt_nome_edificio_vend" style="HEIGHT: 18px; WIDTH: 190px; background: <%=medio%>" value="<%=rs444Imovel("nome_edificio")%>" size="12" maxlength="20"></td>
        </tr>
      </table></td>
  </tr>
        ...
        <tr> 
          ...
          <td width="10">&nbsp;</td>
            <td width="192" bgcolor="<%=escuro%>" style="border:1px solid #FFFFFF;"><select name="txt_conseguiu_proposta_vend" id="txt_conseguiu_proposta_vend" class="inputBox" style="HEIGHT: 18px; WIDTH: 190px; background: <%=medio%>">
                <option value="<%=rs444Imovel("conseguiu_proposta")%>" ><%=rs444Imovel("conseguiu_proposta")%></option>
          ...
          <td width="326"><table width="326" border="0" cellspacing="0" cellpadding="0">
              <tr>
                  <td width="50" style="border:1px solid #FFFFFF;"><select name="txt_quartos_vend" id="txt_quartos_vend" class="inputBox" style="HEIGHT: 18px; WIDTH: 50px; background: <%=medio%>">
					  ...
					  <option value="<%=rs444Imovel("quartos")%>" selected><% if rs444Imovel("quartos") = "0" then response.write "0" else response.write rs444Imovel("quartos") end if%></option>
          ...
          <td width="327"><table width="327" border="0" cellspacing="0" cellpadding="0">
              <tr>
                 <td width="50" style="border:1px solid #FFFFFF;"><select name="txt_vagas_vend" id="txt_vagas_vend" class="inputBox" style="HEIGHT: 18px; WIDTH: 50px; background: <%=medio%>">
					  ...
					  <option value="<%=rs444Imovel("vagas")%>" selected><% if rs444Imovel("vagas") = "0" then response.write "0" else response.write rs444Imovel("vagas") end if%></option>
          ...
          <td width="327"><table width="327" border="0" cellspacing="0" cellpadding="0">
              <tr>
                 <td width="50" style="border:1px solid #FFFFFF;"><select name="txt_banheiros_vend" id="txt_banheiros_vend" class="inputBox" style="HEIGHT: 18px; WIDTH: 50px; background: <%=medio%>">
					    ...
					    <option value="<%if rs444Imovel("banheiros") <> "" then response.write rs444Imovel("banheiros") else response.write "0" end if%>" selected><%if rs444Imovel("banheiros") <> "" then response.write rs444Imovel("banheiros") else response.write "0" end if%></option>
                ...
                <td width="277" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><input name="txt_obs_banheiros_vend" type="text" class="inputBox" id="txt_obs_banheiros_vend" style="HEIGHT: 18px; WIDTH: 274px; background:<%=medio%>" value="<%=rs444Imovel("obs_banheiros")%>" size="38" maxlength="40" align="left"></td>
              </tr>
            </table></td>
        </tr>
      </table></td>
  ...
  <tr>
    <td><table width="1000" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="326"><table width="326" border="0" cellspacing="0" cellpadding="0">
              <tr>
                  <td width="50" style="border:1px solid #FFFFFF;"><select name="txt_suites_vend" id="select" class="inputBox" style="HEIGHT: 18px; WIDTH: 50px; background: <%=medio%>">
                     
					   <option value="<%if rs444Imovel("suites") <> "" then response.write rs444Imovel("suites") else response.write "0" end if%>" selected><%if rs444Imovel("suites") <> "" then response.write rs444Imovel("suites") else response.write "0" end if%></option>
          ...
          <td width="327"><table width="327" border="0" cellspacing="0" cellpadding="0">
              <tr>
                 <td width="50" style="border:1px solid #FFFFFF;"><select name="txt_edicula_vend" id="txt_edicula_vend" class="inputBox" style="HEIGHT: 18px; WIDTH: 50px; background: <%=medio%>">
					  ...
					  <option value="<%if rs444Imovel("edicula") <> "" then response.write rs444Imovel("edicula") else response.write "0" end if%>" selected><%if rs444Imovel("edicula") <> "" then response.write rs444Imovel("edicula") else response.write "0" end if%></option>
          ...
          <td width="327"><table width="327" border="0" cellspacing="0" cellpadding="0">
              <tr>
                 <td width="50" style="border:1px solid #FFFFFF;"><select name="txt_entrada_lateral_vend" id="txt_entrada_lateral_vend" class="inputBox" style="HEIGHT: 18px; WIDTH: 50px; background: <%=medio%>">
					   ...
					   <option value="<%if rs444Imovel("entrada_lateral") <> "" then response.write rs444Imovel("entrada_lateral") else response.write "0" end if%>" selected><%if rs444Imovel("entrada_lateral") <> "" then response.write rs444Imovel("entrada_lateral") else response.write "0" end if%></option>
          ...
          <td width="326"><table width="326" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="50" style="border:1px solid #FFFFFF;"><select name="txt_salao_de_festas_vend" id="txt_salao_de_festas_vend" class="inputBox" style="HEIGHT: 18px; WIDTH: 50px; background: <%=medio%>">
					  ...
					  <option value="<%if rs444Imovel("salao_de_festas") <> "" then response.write rs444Imovel("salao_de_festas") else response.write "0" end if%>" selected><%if rs444Imovel("salao_de_festas") <> "" then response.write rs444Imovel("salao_de_festas") else response.write "0" end if%></option>
          ...
          <td width="327"><table width="327" border="0" cellspacing="0" cellpadding="0">
              <tr>
                 <td width="50" style="border:1px solid #FFFFFF;"><select name="txt_salao_de_jogos_vend" id="txt_salao_de_jogos_vend" class="inputBox" style="HEIGHT: 18px; WIDTH: 50px; background: <%=medio%>">
					  ...
					  <option value="<%if rs444Imovel("salao_de_jogos") <> "" then response.write rs444Imovel("salao_de_jogos") else response.write "0" end if%>" selected><%if rs444Imovel("salao_de_jogos") <> "" then response.write rs444Imovel("salao_de_jogos") else response.write "0" end if%></option>
          ...
          <td width="327"><table width="327" border="0" cellspacing="0" cellpadding="0">
              <tr>
                 <td width="50" style="border:1px solid #FFFFFF;"><select name="txt_churrasqueira_vend" id="txt_churrasqueira_vend" class="inputBox" style="HEIGHT: 18px; WIDTH: 50px; background: <%=medio%>">
					   ...
					   <option value="<%if rs444Imovel("churrasqueira") <> "" then response.write rs444Imovel("churrasqueira") else response.write "0" end if%>" selected><%if rs444Imovel("churrasqueira") <> "" then response.write rs444Imovel("churrasqueira") else response.write "0" end if%></option>
          ...
          <td width="326"><table width="326" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="50" style="border:1px solid #FFFFFF;"><select name="txt_piscina_vend" id="txt_piscina_vend" class="inputBox" style="HEIGHT: 18px; WIDTH: 50px; background: <%=medio%>">
					  ...
					  <option value="<%if rs444Imovel("piscina") <> "" then response.write rs444Imovel("piscina") else response.write "0" end if%>" selected><%if rs444Imovel("piscina") <> "" then response.write rs444Imovel("piscina") else response.write "0" end if%></option>
          ...
          <td width="327"><table width="327" border="0" cellspacing="0" cellpadding="0">
              <tr>
                 <td width="50" style="border:1px solid #FFFFFF;"><select name="txt_quintal_vend" id="txt_quintal_vend" class="inputBox" style="HEIGHT: 18px; WIDTH: 50px; background: <%=medio%>">
					  ...
					  <option value="<%if rs444Imovel("quintal") <> "" then response.write rs444Imovel("quintal") else response.write "0" end if%>" selected><%if rs444Imovel("quintal") <> "" then response.write rs444Imovel("quintal") else response.write "0" end if%></option>
          ...
          <td width="327"><table width="327" border="0" cellspacing="0" cellpadding="0">
              <tr>
                 <td width="50" style="border:1px solid #FFFFFF;"><select name="txt_quadras_vend" id="txt_quadras_vend" class="inputBox" style="HEIGHT: 18px; WIDTH: 50px; background: <%=medio%>">
					   ...
					   <option value="<%if rs444Imovel("quadras") <> "" then response.write rs444Imovel("quadras") else response.write "0" end if%>" selected><%if rs444Imovel("quadras") <> "" then response.write rs444Imovel("quadras") else response.write "0" end if%></option>
  ...
  <tr>
    <td><table width="1000" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="326"><table width="326" border="0" cellspacing="0" cellpadding="0">
              <tr>
                  <td width="50" style="border:1px solid #FFFFFF;"><select name="txt_andares_edificio_vend" id="select2" class="inputBox" style="HEIGHT: 18px; WIDTH: 50px; background: <%=medio%>">
                    
					 <option value="<%if rs444Imovel("andares_edificio") <> "" then response.write rs444Imovel("andares_edificio") else response.write "0" end if%>" selected><%if rs444Imovel("andares_edificio") <> "" then response.write rs444Imovel("andares_edificio") else response.write "0" end if%></option>
          ...
          <td width="327"><table width="327" border="0" cellspacing="0" cellpadding="0">
              <tr>
                 <td width="50" style="border:1px solid #FFFFFF;"><select name="txt_quantidade_elevadores_vend" id="txt_quantidade_elevadores_vend" class="inputBox" style="HEIGHT: 18px; WIDTH: 50px; background: <%=medio%>">
					   ...
					   <option value="<%if rs444Imovel("quantidade_elevadores") <> "" then response.write rs444Imovel("quantidade_elevadores") else response.write "0" end if%>" selected><%if rs444Imovel("quantidade_elevadores") <> "" then response.write rs444Imovel("quantidade_elevadores") else response.write "0" end if%></option>
          ...
          <td width="327"><table width="327" border="0" cellspacing="0" cellpadding="0">
              <tr>
                 <td width="50" style="border:1px solid #FFFFFF;"><select name="txt_portaria_vend" id="txt_portaria_vend" class="inputBox" style="HEIGHT: 18px; WIDTH: 50px; background: <%=medio%>">
					   ...
					   <option value="<%if rs444Imovel("portaria") <> "" then response.write rs444Imovel("portaria") else response.write "0" end if%>" selected><%if rs444Imovel("portaria") <> "" then response.write rs444Imovel("portaria") else response.write "0" end if%></option>
  ...
  <tr> 
    <td><table width="1000" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="10">&nbsp;</td>
            <td width="495"><font color="<%=letra%>" size="1" face="Verdana, Arial, Helvetica, sans-serif">Observa&ccedil;&otilde;es 
              sobre o im&oacute;vel e a forma de pagamento que o propriet&aacute;rio 
              aceita</font></td>
        </tr>
      </table></td>
  </tr>
  <tr> 
    <td><table width="1000" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="495" height="102" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><textarea name="txt_obs_proprietario_vend" class="inputBox" id="txt_obs_proprietario_vend" style="HEIGHT: 100px; WIDTH: 493px; background:<%=medio%>" onKeyPress="return limitfield(this, 800)"><%=rs444Imovel("obs_proprietario")%></textarea></td>
          <td width="10">&nbsp;</td>
          <td width="495" height="80" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><textarea name="txt_obs_imovel_vend" class="inputBox" id="txt_obs_imovel_vend" style="HEIGHT: 100px; WIDTH: 493px; background:<%=medio%>" onKeyPress="return limitfield(this, 800)"><%=rs444Imovel("obs_imovel")%></textarea></td>
        </tr>
      </table></td>
  </tr>
