...
<table width="790" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td><% if  session("permissao") = "4" or  session("permissao") = "3" or  session("permissao") = "5"   then %><div align="center"><font color="#006699" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong><a href="estatistica_compradores.asp" style="color:black">Estat&iacute;stica da busca de compradores</a></strong></font></div><%else%>
        <div align="center"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Estat&iacute;stica 
          da busca de compradores</strong></font></div>
        <%end if%></td>
    </tr>
  </table>
...
<form action="archive_compradores.asp?" Method="GET" name="b2" >
