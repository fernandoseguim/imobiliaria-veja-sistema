...
response.Redirect "sem_avaliacao.asp"
...
<table width="250" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td><div align="center"><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Selecione 
          abaixo as caracter&iacute;sticas do seu im&oacute;vel e clique no bot&atilde;o 
          &quot;AVALIAR&quot; para saber o valor de mercado do seu im&oacute;vel.</strong></font> 
        </div></td>
  </tr>
</table>
...
<br>
<br>
<form name="doublecombo" onSubmit="return isValidDigitNumber(this);"  method="post" action="listar_avaliacao.asp?nome=<%=session("nome")%>&email=<%=session("email")%>&telefone=<%=session("telefone")%>">
  <table width="250" height="120" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td width="250" height="120"><table width="250" border="0"  cellspacing="0" cellpadding="0" height="120">
                  ...
                  <option value="qqualquer" selected>Número de quartos do seu imóvel</option>
                  ...
                  <option value="gqualquer" selected>Número de vagas na garagem do seu imóvel</option>
              ...
              <td><div align="right"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Metragem 
                  ...
                  m&sup2;</font> </font></div></td>
							...
							<tr>
							<td width="250" height="20"><div align="right"><input name="image2" type="image"  src="bt_avaliar001.jpg" width="149" height="18" border="0"></div></td>
