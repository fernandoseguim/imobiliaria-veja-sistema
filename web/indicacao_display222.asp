...
<table width="590" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td width="590" height="20"><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a href="javascript:newWindow44('visualizar_imovel22.asp?varCod_imovel=<%=varCod_imovel%>')" style="color:#FFFFFF"><strong>Se você quiser atualizar os dados desse imóvel clique aqui.</strong></a></font></div></td>
  </tr>
  
  
  <tr>
    <td width="590" height="20"><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong><a href="imprimir_imovel_display222.asp?varCod_imovel=<%=varCod_imovel%>" style="color:#FFFFFF">Visualizar 
