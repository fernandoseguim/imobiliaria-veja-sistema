...
<body>
<form name="doublecombo"   onSubmit="return isValidDigitNumber(this);" method="post" action="atualizar_proposta_oficial03.asp?varCod_proposta_oficial=<%=rsProposta("cod_proposta_oficial")%>&varCod_imovel=<%=rs("cod_imovel")%>&vAtendimento=<%=rs("captacao")%>">
          ...
          <td height="30"><table width="800" height="30" border="0" cellpadding="0" cellspacing="0">
              <tr> 
                ...
                <td width="150"><div align="center">
                      <input name="txt_valor" type="text" id="txt_valor" style="HEIGHT: 30px; WIDTH: 150px;" value="<%=rsProposta("valor")%>">
                  </div></td>
...
<div align="center"><strong>Representado 
        ...
        <tr> 
          <td><table width="800" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td width="150" height="30"><div align="center">Nome completo:</div></td>
                <td width="650" height="30"><input name="txt_nome_contra" type="text" id="txt_nome_contra" style="HEIGHT: 30px; WIDTH: 650px;" value="<%=rsProposta("nome_contra")%>"></td>
              </tr>
              <tr> 
                <td width="150" height="30"><div align="center">Nacionalidade:</div></td>
                <td width="650" height="30"><input name="txt_nacionalidade_contra" type="text" id="txt_nacionalidade_contra" style="HEIGHT: 30px; WIDTH: 650px;" value="<%=rsProposta("nacionalidade_contra")%>"></td>
              </tr>
              <tr> 
                <td width="150" height="30"><div align="center">Estado Civil:</div></td>
                <td width="650" height="30"><input name="txt_estado_civil_contra" type="text" id="txt_estado_civil" style="HEIGHT: 30px; WIDTH: 650px;" value="<%=rsProposta("estado_civil_contra")%>"></td>
              </tr>
              <tr> 
                <td width="150" height="30"><div align="center">Profiss&atilde;o:</div></td>
                <td width="650" height="30"><input name="txt_profissao_contra" type="text" id="txt_profissao" style="HEIGHT: 30px; WIDTH: 650px;" value="<%=rsProposta("profissao_contra")%>"></td>
              </tr>
              <tr> 
                <td width="150" height="30"><div align="center">RG:</div></td>
                <td width="650" height="30"><input name="txt_rg_contra" type="text" id="txt_rg" style="HEIGHT: 30px; WIDTH: 650px;" value="<%=rsProposta("rg_contra")%>"></td>
              </tr>
              <tr> 
                <td width="150" height="30"><div align="center">CPF:</div></td>
                <td width="650" height="30"><input name="txt_cpf_contra" type="text" id="cpf" style="HEIGHT: 30px; WIDTH: 650px;" value="<%=rsProposta("cpf_contra")%>"   ></td>
              </tr>
              <tr> 
                <td width="150" height="30"><div align="center">Estado:</div></td>
                <td width="650" height="30"><input name="txt_estado_contra" type="text" id="txt_estado" style="HEIGHT: 30px; WIDTH: 650px;" value="<%=rsProposta("estado_contra")%>"></td>
              </tr>
              <tr> 
                <td width="150" height="30"><div align="center">Cidade:</div></td>
                <td width="650" height="30"><input name="txt_cidade_contra" type="text" id="txt_cidade" style="HEIGHT: 30px; WIDTH: 650px;" value="<%=rsProposta("cidade_contra")%>"></td>
              </tr>
              <tr> 
                <td width="150" height="30"><div align="center">Bairro:</div></td>
                <td width="650" height="30"><input name="txt_bairro_contra" type="text" id="txt_bairro" style="HEIGHT: 30px; WIDTH: 650px;" value="<%=rsProposta("bairro_contra")%>"></td>
              </tr>
              <tr> 
                <td width="150" height="30"><div align="center">Endere&ccedil;o:</div></td>
                <td width="650" height="30"><input name="txt_endereco_contra" type="text" id="txt_endereco" style="HEIGHT: 30px; WIDTH: 650px;" value="<%=rsProposta("endereco_contra")%>"></td>
              </tr>
            </table></td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td height="30"><table width="800" height="30" border="0" cellpadding="0" cellspacing="0">
              <tr> 
                ...
                <td width="150"><div align="center">
                            <input name="txt_valor_contra" type="text" id="txt_valor_contra" style="HEIGHT: 30px; WIDTH: 150px;" value="<%=rsProposta("valor_contra")%>">
                  </div></td>
                <td width="175"><div align="center">Pagamento a vista:</div></td>
                <td width="150"> <input type="radio" name="txt_pagamento_vista_contra" value="sim" <% if rsProposta("pagamento_vista_contra") = "sim" then response.write "checked" end if%>>
                  Sim</td>
                <td width="150"> <input type="radio" name="txt_pagamento_vista_contra" value="não" <% if rsProposta("pagamento_vista_contra") = "não" then response.write "checked" end if%>>
                  N&atilde;o</td>
              </tr>
            </table></td>
        </tr>
        ...
        <tr> 
          <td><table width="800" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td width="30" height="30"><div align="center"><strong>R$</strong></div></td>
                <td width="300" height="30"><input name="txt_outro_valor_contra01" type="text" id="txt_outro_valor_contra01" style="HEIGHT: 30px; WIDTH: 300px;" value="<%=rsProposta("outro_valor_contra01")%>"></td>
                <td width="170" height="30">
<div align="center"><strong>Representado 
                    por;</strong></div></td>
                <td width="300" height="30"><input name="txt_outro_forma_contra01" type="text" id="txt_outro_forma01" style="HEIGHT: 30px; WIDTH: 300px;" value="<%=rsProposta("outro_forma_contra01")%>"></td>
              </tr>
              <tr> 
                <td width="30" height="30"><div align="center"><strong>R$</strong></div></td>
                <td width="300" height="30"><input name="txt_outro_valor_contra02" type="text" id="txt_outro_valor02" style="HEIGHT: 30px; WIDTH: 300px;" value="<%=rsProposta("outro_valor_contra02")%>"></td>
                <td width="170" height="30">
<div align="center"><strong>Representado 
                    por;</strong></div></td>
                <td width="300" height="30"><input name="txt_outro_forma_contra02" type="text" id="txt_outro_forma02" style="HEIGHT: 30px; WIDTH: 300px;" value="<%=rsProposta("outro_forma_contra02")%>"></td>
              </tr>
              <tr> 
                <td width="30" height="30"><div align="center"><strong>R$</strong></div></td>
                <td width="300" height="30"><input name="txt_outro_valor_contra03" type="text" id="txt_outro_valor03" style="HEIGHT: 30px; WIDTH: 300px;" value="<%=rsProposta("outro_valor_contra03")%>"></td>
                <td width="170" height="30">
<div align="center"><strong>Representado 
                    por;</strong></div></td>
                <td width="300" height="30"><input name="txt_outro_forma_contra03" type="text" id="txt_outro_forma03" style="HEIGHT: 30px; WIDTH: 300px;" value="<%=rsProposta("outro_forma_contra03")%>"></td>
              </tr>
              <tr> 
                <td width="30" height="30"><div align="center"><strong>R$</strong></div></td>
                <td width="300" height="30"><input name="txt_outro_valor_contra04" type="text" id="txt_outro_valor04" style="HEIGHT: 30px; WIDTH: 300px;" value="<%=rsProposta("outro_valor_contra04")%>"></td>
                <td width="170" height="30">
<div align="center"><strong>Representado 
                    por;</strong></div></td>
                <td width="300" height="30"><input name="txt_outro_forma_contra04" type="text" id="txt_outro_forma04" style="HEIGHT: 30px; WIDTH: 300px;" value="<%=rsProposta("outro_forma_contra04")%>"></td>
              </tr>
              <tr> 
                <td width="30" height="30"><div align="center"><strong>R$</strong></div></td>
                <td width="300" height="30"><input name="txt_outro_valor_contra05" type="text" id="txt_outro_valor05" style="HEIGHT: 30px; WIDTH: 300px;" value="<%=rsProposta("outro_valor_contra05")%>"></td>
                <td width="170" height="30">
<div align="center"><strong>Representado 
                    por;</strong></div></td>
                <td width="300" height="30"><input name="txt_outro_forma_contra05" type="text" id="txt_outro_forma05" style="HEIGHT: 30px; WIDTH: 300px;" value="<%=rsProposta("outro_forma_contra05")%>"></td>
              </tr>
              <tr> 
                <td width="30" height="30"><div align="center"><strong>R$</strong></div></td>
                <td width="300" height="30"><input name="txt_outro_valor_contra06" type="text" id="txt_outro_valor06" style="HEIGHT: 30px; WIDTH: 300px;" value="<%=rsProposta("outro_valor_contra06")%>"></td>
                <td width="170" height="30">
<div align="center"><strong>Representado 
                    por;</strong></div></td>
                <td width="300" height="30"><input name="txt_outro_forma_contra06" type="text" id="txt_outro_forma06" style="HEIGHT: 30px; WIDTH: 300px;" value="<%=rsProposta("outro_forma_contra06")%>"></td>
              </tr>
            </table></td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td height="100"><textarea name="txt_obs_proposta_oficial_contra" id="txt_obs_proposta_oficial_contra" style="HEIGHT: 100px; WIDTH: 800px;"><%=rsProposta("obs_proposta_oficial_contra")%></textarea></td>
        </tr>
        <tr> 
		...
		<tr><td height="50"><div align="center"><a href="" onclick="javascript:print();return false;" style="color:#000000"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Imprimir</font></strong></a></div></td></tr>
