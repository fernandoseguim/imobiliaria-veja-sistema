...
<%
'linha 632 está a inclusão de visualização de imóveis
...
varCod_imovel = "0"
   ...
   Conexao.execute"Insert into corretores_fora_imoveis(corretores_fora_nome, corretores_fora_id_imovel, corretores_fora_data, origem_franquia) values( '"& session("nome_id") &"','"& varCod_imovel &"','"& now() &"','"& session("vOrigem_Franquia") &"')" 
...
if ((doublecombo.txt_imovel_em_negociacao_vend.value != "Imóvel inexistente")&&(doublecombo.txt_imovel_em_negociacao_vend.value != "Imóvel não contatado") ) {
        

if (doublecombo.txt_a_constr_vend.value == "00" || doublecombo.txt_a_constr_vend.value == "" || doublecombo.txt_a_constr_vend.value == "0" ) {
        alert("Você precisa informar a área construída do imóvel!");
        doublecombo.txt_a_constr_vend.focus();
...
if (doublecombo.txt_valor_iptu_vend.value == "0,00" || doublecombo.txt_valor_iptu_vend.value == "" ) {
        alert("Você precisa informar o valor do IPTU do imóvel!");
        doublecombo.txt_valor_iptu_vend.focus();
...
if (doublecombo.txt_ocupacao_vend.value == "não informado") {
        alert("Você precisa indicar se o imóvel  está vago ou não!");
...
if (doublecombo.txt_data_futuro_contato_vend.value == "0/0/2007 00:00:00") {
	...
	if (doublecombo.txt_tipo_vend.value == "APARTAMENTO" && doublecombo.txt_tipo_vend.value == "CASAS EM CONDOMINIO" && doublecombo.txt_tipo_vend.value == "SALA COMERCIAL"  && doublecombo.txt_condominio_vend.value == "0,00" ) {
...
if ((doublecombo.txt_quartos_vend.value == "00" || doublecombo.txt_quartos_vend.value == "" || doublecombo.txt_quartos_vend.value == "não informado" )) {
...
if ((doublecombo.txt_captacao_vend.value == "internet")&&(doublecombo.txt_pergunta.value == "sim")) {
        alert("Você precisa informar quem é o captador!");
        doublecombo.txt_captacao_vend.focus();
...
if (doublecombo.txt_area_total.value == "" && doublecombo.txt_pergunta.value == "sim" ) {
        alert("Coloque a área total do imóvel pretendido!");
        doublecombo.txt_area_total.focus();
		doublecombo.txt_area_total.select();
        return false;
    }
...
%>
 ...
 SQL444Permuta = "SELECT permuta.cod_permuta,permuta.nome,permuta.telefone,permuta.email,permuta.cidade_vend,permuta.bairro_vend,permuta.endereco_vend,permuta.tipo_vend,permuta.descricao_vend,permuta.cidade_comp,permuta.bairro_comp,permuta.tipo_comp,permuta.descricao_comp,permuta.cod_imovel,permuta.link_imovel,permuta.foto_imovel,permuta.data,permuta.quartos_comp,permuta.quartos_vend,permuta.valor_comp,permuta.valor_vend,permuta.atendimento,permuta.data_atualizacao,permuta.vila_vend,permuta.vila_comp,permuta.vagas_vend,permuta.vagas_comp,permuta.cod_comprador,permuta.standby,permuta.datalastemail,permuta.textolastemail,permuta.dados_confidenciais  FROM permuta where telefone like'"& rs("telefone")&"' and origem_franquia like '"&session("vOrigem_Franquia")&"'  order by cod_permuta DESC" 
	...
	if  ( ( not rs444Permuta.eof) and rs("captacao") = session("nome_id")) or (session("permissao") = "6") then
...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Que 
 ...
 SQL444Comprador = "SELECT compradores.cod_compradores,compradores.nome,compradores.telefone,compradores.email,compradores.endereco,compradores.cidade,compradores.bairro,compradores.tipo,compradores.quartos,compradores.negociacao,compradores.valor,compradores.descricao,compradores.data,compradores.data_atualizacao,compradores.atendimento,compradores.vila,compradores.vagas,compradores.ocupacao,compradores.standby,compradores.cod_imovel,compradores.cod_permuta,compradores.acessos,compradores.descricao_confi,compradores.origem,compradores.dataLastEmail,compradores.textoLastEmail,compradores.responsavel_cadastramento,compradores.data_ultimo_acesso,compradores.data_futuro_contato,compradores.assunto_futuro_contato,compradores.melhor_horario_visita,compradores.telefone02,compradores.telefone03,compradores.data_ligar_urgente,compradores.assunto_ligar_urgente,compradores.quem_atualizou,compradores.obs_quartos,compradores.obs_vagas,compradores.suites,compradores.obs_suites,compradores.salao_de_festas,compradores.obs_salao_de_festas,compradores.salao_de_jogos,compradores.obs_salao_de_jogos,compradores.piscina,compradores.obs_piscina,compradores.andares_edificio,compradores.obs_andares_edificio,compradores.edicula,compradores.obs_edicula,compradores.quintal,compradores.obs_quintal,compradores.banheiros,compradores.obs_banheiros,compradores.entrada_lateral,compradores.obs_entrada_lateral,compradores.churrasqueira,compradores.obs_churrasqueira,compradores.quadras,compradores.obs_quadras,compradores.portaria,compradores.obs_portaria,compradores.quantidade_elevadores,compradores.quantidade_elevadores,compradores.obs_quantidade_elevadores,compradores.area_total,compradores.area_construida,compradores.condominio,compradores.condicoes_pagamento,compradores.pergunta,compradores.obs_forma_pagamento  FROM compradores where  (telefone like'"& rs("telefone")&"' or telefone02 like'"& rs("telefone")&"' or telefone03 like'"& rs("telefone")&"') and origem_franquia like '"&session("vOrigem_Franquia")&"'   order by cod_compradores DESC" 
	...
	if  (not (rs444Comprador.eof) and rs("captacao") = session("nome_id")) or (session("permissao") = "6") then
	...
	varCod_compradores006 = rs444Comprador("cod_compradores")
              ...
              <div align="right"><a href="javascript:newWindow44('visualizar_compradores33.asp?varCodCompradores=<%=rs444Comprador("cod_compradores")%>')"><img src="bt_foto22Compr.jpg" width="290" height="18" border="0" align="middle" ID="info_icon_SAC3834" onMouseOver="show_info_popup(this,'<%=rs444Comprador("cod_compradores")%>',35)" onMouseOut="hide_info_popup(this,'<%=rs444Comprador("cod_compradores")%>')"></a>
			    ...
			    <DIV STYLE="border: #000000 0px solid;  width: 570px; background-image: url(imovel10001.jpg); visibility: hidden; position: absolute; left: 200px; right: 200px;" CLASS="smalltext" ID="<%=rs444Comprador("cod_compradores")%>">
...
<table width="1000" border="0" cellspacing="0" cellpadding="0">
  ...
  %>
      <div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a href="javascript:newWindow4354('indicacao_imoveis22.asp?varIndicacaoCidade=<%=varIndicacaoCidade%>&varIndicacaoBairro=<%=varIndicacaoBairro%>&varIndicacaoTipo=<%=varIndicacaoTipo%>&varIndicacaoNegociacao=<%=varIndicacaoNegociacao%>&varIndicacaoQuartos=<%=varIndicacaoQuartos%>&varIndicacaoVagas=<%=varIndicacaoVagas%>&varIndicacaoValor=<%=varIndicacaoValor%>&varCod_imovel=<%=varCod_imovel%>')" style="color:<%=letra%>"> 
       Indicações de email</a></font> </div></font></div></td>
...
<input name="txt_valor_vend" type="text" class="inputBox" id="txt_valor_vend" style="HEIGHT: 18px; WIDTH: 190px; background:<%=medio%>" value="<%=FormatNumber(rs("valor"),2)%>" size="12" maxlength="13"></td>
        ...
        <tr> 
          ...
          <td width="10">&nbsp;</td>
            <td width="192" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><input name="txt_nome_edificio_vend" type="text" class="inputBox" id="txt_nome_edificio_vend" style="HEIGHT: 18px; WIDTH: 190px; background: <%=medio%>" value="<%=rs("nome_edificio")%>" size="12" maxlength="50"></td>
        </tr>
      </table></td>
  </tr>
        ...
        <tr> 
          ...
          <td width="10">&nbsp;</td>
            <td width="192" bgcolor="<%=escuro%>" style="border:1px solid #FFFFFF;"><select name="txt_conseguiu_proposta_vend" id="txt_conseguiu_proposta_vend" class="inputBox" style="HEIGHT: 18px; WIDTH: 190px; background: <%=medio%>">
                <option value="<%if rs("conseguiu_proposta") <> "" then response.write rs("conseguiu_proposta") else response.write "não informado" end if %>"  ><%if rs("conseguiu_proposta") <> "" then response.write rs("conseguiu_proposta") else response.write "não informado" end if %></option>
  ...
  <tr> 
          ...
          <td width="10">&nbsp;</td>
            <td width="192" bgcolor="<%=escuro%>"><font color="<%=letra%>" size="1" face="Verdana, Arial, Helvetica, sans-serif">Franquia</font></td>
          <td width="10">&nbsp;</td>
...
RSProposta.ActiveConnection = Conexao3
	...
	RSProposta.Open SQLProposta, Conexao3
          ...
          <td width="10">&nbsp;</td>
            <td width="192" bgcolor="<%=escuro%>" style="border:1px solid #FFFFFF;"><input name="text" type="text" class="inputBox" style="HEIGHT: 18px; WIDTH: 190px; background: <%=medio%>" value="<%=rs("origem_franquia")%>" size="38" maxlength="120" align="left"></td>
          <td width="10">&nbsp;</td>
            <td width="192" bgcolor="<%=escuro%>" >&nbsp;</td>
        </tr>
          ...
          <td width="326"><table width="326" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="50" style="border:1px solid #FFFFFF;"><select name="txt_quartos_vend" id="txt_quartos_vend" class="inputBox" style="HEIGHT: 18px; WIDTH: 50px; background: <%=medio%>">
					  ...
					  <option value="<%if  rs("quartos") <> "" then response.write rs("quartos") else response.write "0" end if%>" selected> <%if  rs("quartos") <> "" then response.write rs("quartos") else response.write "0" end if%></option>
          ...
          <td width="327"><table width="327" border="0" cellspacing="0" cellpadding="0">
              <tr>
                 <td width="50" style="border:1px solid #FFFFFF;"><select name="txt_vagas_vend" id="txt_vagas_vend" class="inputBox" style="HEIGHT: 18px; WIDTH: 50px; background: <%=medio%>">
					  ...
					  <option value="<%if (rs("vagas") <> "" and rs("vagas") <> "não informado")  then response.write rs("vagas") else response.write "0" end if%>" selected><%if (rs("vagas") <> "" and rs("vagas") <> "não informado")  then response.write rs("vagas") else response.write "0" end if%></option>
          ...
          <td width="327"><table width="327" border="0" cellspacing="0" cellpadding="0">
              <tr>
                 <td width="50" style="border:1px solid #FFFFFF;"><select name="txt_banheiros_vend" id="txt_banheiros_vend" class="inputBox" style="HEIGHT: 18px; WIDTH: 50px; background: <%=medio%>">
					  ...
					  <option value="<%if (rs("banheiros") <> "" and rs("banheiros") <> "não informado")  then response.write rs("banheiros") else response.write "0" end if%>" selected><%if (rs("banheiros") <> "" and rs("banheiros") <> "não informado")  then response.write rs("banheiros") else response.write "0" end if%></option>
          ...
          <td width="326"><table width="326" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="50" style="border:1px solid #FFFFFF;"><select name="txt_suites_vend" id="txt_suites_vend" class="inputBox" style="HEIGHT: 18px; WIDTH: 50px; background: <%=medio%>">
                      <option value="<%if (rs("suites") <> "" and rs("suites") <> "não informado") then response.write rs("suites") else response.write "0" end if%>" selected><%if (rs("suites") <> "" and rs("suites") <> "não informado") then response.write rs("suites") else response.write "0" end if%></option>
          ...
          <td width="327"><table width="327" border="0" cellspacing="0" cellpadding="0">
              <tr>
                 <td width="50" style="border:1px solid #FFFFFF;"><select name="txt_edicula_vend" id="txt_edicula_vend" class="inputBox" style="HEIGHT: 18px; WIDTH: 50px; background: <%=medio%>">
					  ...
					  <option value="<%if (rs("edicula") <> "" and rs("edicula") <> "não informado")  then response.write rs("edicula") else response.write "0" end if%>" selected><%if (rs("edicula") <> "" and rs("edicula") <> "não informado")  then response.write rs("edicula") else response.write "0" end if%></option>
          ...
          <td width="327"><table width="327" border="0" cellspacing="0" cellpadding="0">
              <tr>
                 <td width="50" style="border:1px solid #FFFFFF;"><select name="txt_entrada_lateral_vend" id="txt_entrada_lateral_vend" class="inputBox" style="HEIGHT: 18px; WIDTH: 50px; background: <%=medio%>">
					   ...
					   <option value="<%if (rs("entrada_lateral") <> "" and rs("entrada_lateral") <> "não informado")  then response.write rs("entrada_lateral") else response.write "0" end if%>" selected><%if (rs("entrada_lateral") <> "" and rs("entrada_lateral") <> "não informado")  then response.write rs("entrada_lateral") else response.write "0" end if%></option>
          ...
          <td width="326"><table width="326" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="50" style="border:1px solid #FFFFFF;"><select name="txt_salao_de_festas_vend" id="txt_salao_de_festas_vend" class="inputBox" style="HEIGHT: 18px; WIDTH: 50px; background: <%=medio%>">
                      <option value="<%if (rs("salao_de_festas") <> "" and rs("salao_de_festas") <> "não informado") then response.write rs("salao_de_festas") else response.write "0" end if%>" selected><%if (rs("salao_de_festas") <> "" and rs("salao_de_festas") <> "não informado") then response.write rs("salao_de_festas") else response.write "0" end if%></option>
          ...
          <td width="327"><table width="327" border="0" cellspacing="0" cellpadding="0">
              <tr>
                 <td width="50" style="border:1px solid #FFFFFF;"><select name="txt_salao_de_jogos_vend" id="txt_salao_de_jogos_vend" class="inputBox" style="HEIGHT: 18px; WIDTH: 50px; background: <%=medio%>">
					  ...
					  <option value="<%if (rs("salao_de_jogos") <> "" and rs("salao_de_jogos") <> "não informado")  then response.write rs("salao_de_jogos") else response.write "0" end if%>" selected><%if (rs("salao_de_jogos") <> "" and rs("salao_de_jogos") <> "não informado")  then response.write rs("salao_de_jogos") else response.write "0" end if%></option>
          ...
          <td width="327"><table width="327" border="0" cellspacing="0" cellpadding="0">
              <tr>
                 <td width="50" style="border:1px solid #FFFFFF;"><select name="txt_churrasqueira_vend" id="txt_churrasqueira_vend" class="inputBox" style="HEIGHT: 18px; WIDTH: 50px; background: <%=medio%>">
					   ...
					   <option value="<%if (rs("churrasqueira") <> "" and rs("churrasqueira") <> "não informado")  then response.write rs("churrasqueira") else response.write "0" end if%>" selected><%if (rs("churrasqueira") <> "" and rs("churrasqueira") <> "não informado")  then response.write rs("churrasqueira") else response.write "0" end if%></option>
          ...
          <td width="326"><table width="326" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="50" style="border:1px solid #FFFFFF;"><select name="txt_piscina_vend" id="txt_piscina_vend" class="inputBox" style="HEIGHT: 18px; WIDTH: 50px; background: <%=medio%>">
					  ...
					  <option value="<%if (rs("piscina") <> "" and rs("piscina") <> "não informado") then response.write rs("piscina") else response.write "0" end if%>" selected><%if (rs("piscina") <> "" and rs("piscina") <> "não informado") then response.write rs("piscina") else response.write "0" end if%></option>
          ...
          <td width="327"><table width="327" border="0" cellspacing="0" cellpadding="0">
              <tr>
                 <td width="50" style="border:1px solid #FFFFFF;"><select name="txt_quintal_vend" id="txt_quintal_vend" class="inputBox" style="HEIGHT: 18px; WIDTH: 50px; background: <%=medio%>">
					  ...
					  <option value="<%if (rs("quintal") <> "" and rs("quintal") <> "não informado")  then response.write rs("quintal") else response.write "0" end if%>" selected><%if (rs("quintal") <> "" and rs("quintal") <> "não informado")  then response.write rs("quintal") else response.write "0" end if%></option>
          ...
          <td width="327"><table width="327" border="0" cellspacing="0" cellpadding="0">
              <tr>
                 <td width="50" style="border:1px solid #FFFFFF;"><select name="txt_quadras_vend" id="txt_quadras_vend" class="inputBox" style="HEIGHT: 18px; WIDTH: 50px; background: <%=medio%>">
					   ...
					   <option value="<%if (rs("quadras") <> "" and rs("quadras") <> "não informado")  then response.write rs("quadras") else response.write "0" end if%>" selected><%if (rs("quadras") <> "" and rs("quadras") <> "não informado")  then response.write rs("quadras") else response.write "0" end if%></option>
          ...
          <td width="326"><table width="326" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="50" style="border:1px solid #FFFFFF;"><select name="txt_andares_edificio_vend" id="txt_andares_edificio_vend" class="inputBox" style="HEIGHT: 18px; WIDTH: 50px; background: <%=medio%>">
					  ...
					  <option value="<%if (rs("andares_edificio") <> "" and rs("andares_edificio") <> "não informado")  then response.write rs("andares_edificio") else response.write "0" end if%>" selected><%if (rs("andares_edificio") <> "" and rs("andares_edificio") <> "não informado")  then response.write rs("andares_edificio") else response.write "0" end if%></option>
                ...
                <td width="276" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><input name="txt_obs_andares_edificio_vend" type="text" class="inputBox" id="txt_obs_andares_edificio_vend" style="HEIGHT: 18px; WIDTH: 274px; background:<%=medio%>" value="<%=rs("obs_andares_edificio")%>" size="38" maxlength="40" align="left"></td>
              </tr>
            </table></td>
          <td width="10">&nbsp;</td>
          <td width="327"><table width="327" border="0" cellspacing="0" cellpadding="0">
              <tr>
                 <td width="50" style="border:1px solid #FFFFFF;"><select name="txt_quantidade_elevadores_vend" id="txt_quantidade_elevadores_vend" class="inputBox" style="HEIGHT: 18px; WIDTH: 50px; background: <%=medio%>">
					   ...
					   <option value="<%if (rs("quantidade_elevadores") <> "" and rs("quantidade_elevadores") <> "não informado")  then response.write rs("quantidade_elevadores") else response.write "0" end if%>" selected><%if (rs("quantidade_elevadores") <> "" and rs("quantidade_elevadores") <> "não informado")  then response.write rs("quantidade_elevadores") else response.write "0" end if%></option>
          ...
          <td width="327"><table width="327" border="0" cellspacing="0" cellpadding="0">
              <tr>
                 <td width="50" style="border:1px solid #FFFFFF;"><select name="txt_portaria_vend" id="txt_portaria_vend" class="inputBox" style="HEIGHT: 18px; WIDTH: 50px; background: <%=medio%>">
					   ...
					   <option value="<%if (rs("portaria") <> "" and rs("portaria") <> "não informado")  then response.write rs("portaria") else response.write "0" end if%>" selected><%if (rs("portaria") <> "" and rs("portaria") <> "não informado")  then response.write rs("portaria") else response.write "0" end if%></option>
    ...
    <td><table width="1000" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="495"><font color="<%=letra%>" size="1" face="Verdana, Arial, Helvetica, sans-serif">Observa&ccedil;&otilde;es 
              sobre a forma de pagamento que o propriet&aacute;rio aceita</font></td>
          <td width="10">&nbsp;</td>
            <td width="495"><font color="<%=letra%>" size="1" face="Verdana, Arial, Helvetica, sans-serif">Observa&ccedil;&otilde;es 
    ...
    <td><table width="1000" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="495" height="224" bgcolor="<%=medio%>" ><table width="495" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="102" style="border:1px solid #FFFFFF;"><textarea name="txt_obs_forma_pagamento_vend" class="inputBox" id="textarea4" style="HEIGHT: 100px; WIDTH: 493px; background:<%=medio%>" onKeyPress="return limitfield(this, 800)"><%=rs("obs_forma_pagamento")%></textarea></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td height="102" style="border:1px solid #FFFFFF;"><textarea name="txt_obs_proprietario_vend" class="inputBox" id="txt_obs_proprietario_vend" style="HEIGHT: 100px; WIDTH: 493px; background:<%=medio%>" onKeyPress="return limitfield(this, 800)"><%=rs("obs_proprietario")%></textarea></td>
                </tr>
              </table></td>
          <td width="10">&nbsp;</td>
...
rsFichaBairro.ActiveConnection = Conexao3
	...
	dim Sql444Compradores
	dim rs444Compradores
	
	Sql444Compradores = "SELECT compradores.cod_compradores,compradores.nome,compradores.telefone,compradores.email,compradores.endereco,compradores.cidade,compradores.bairro,compradores.tipo,compradores.quartos,compradores.negociacao,compradores.valor,compradores.descricao,compradores.data,compradores.data_atualizacao,compradores.atendimento,compradores.vila,compradores.vagas,compradores.ocupacao,compradores.standby,compradores.cod_imovel,compradores.cod_permuta,compradores.acessos,compradores.descricao_confi,compradores.origem,compradores.dataLastEmail,compradores.textoLastEmail,compradores.responsavel_cadastramento,compradores.data_ultimo_acesso,compradores.data_futuro_contato,compradores.assunto_futuro_contato,compradores.melhor_horario_visita,compradores.telefone02,compradores.telefone03,compradores.data_ligar_urgente,compradores.assunto_ligar_urgente,compradores.quem_atualizou,compradores.obs_quartos,compradores.obs_vagas,compradores.suites,compradores.obs_suites,compradores.salao_de_festas,compradores.obs_salao_de_festas,compradores.salao_de_jogos,compradores.obs_salao_de_jogos,compradores.piscina,compradores.obs_piscina,compradores.andares_edificio,compradores.obs_andares_edificio,compradores.edicula,compradores.obs_edicula,compradores.quintal,compradores.obs_quintal,compradores.banheiros,compradores.obs_banheiros,compradores.entrada_lateral,compradores.obs_entrada_lateral,compradores.churrasqueira,compradores.obs_churrasqueira,compradores.quadras,compradores.obs_quadras,compradores.portaria,compradores.obs_portaria,compradores.quantidade_elevadores,compradores.quantidade_elevadores,compradores.obs_quantidade_elevadores,compradores.area_total,compradores.area_construida,compradores.condominio,compradores.condicoes_pagamento,compradores.pergunta,compradores.obs_forma_pagamento,compradores.origem_franquia  FROM compradores where  (telefone like'"& rs("telefone")&"' or telefone02 like'"& rs("telefone")&"' or telefone03 like'"& rs("telefone")&"')   order by cod_compradores DESC" 
	 

Set rs444Compradores = Server.CreateObject("ADODB.RecordSet")

	rs444Compradores.CursorLocation = 3
'a propriedade CursorLocation do objeto recordset indica onde o cursor é criado
'se no cliente ou no servidor.

rs444Compradores.CursorType = 3
'indica o tipo de cursor utilizado, se somente de leitura ou se de leitura e gravação.

rs444Compradores.ActiveConnection = Conexao
	
	
	rs444Compradores.Open sql444Compradores, Conexao
  ...
  <tr><td>
  <% if not rs444Compradores.eof then%>
       <input name="txt_cod_compradores" type="hidden" class="inputBox" id="txt_cod_compradores" style="HEIGHT: 18px; WIDTH: 190px; background: <%=medio%>" value="<%=rs444Compradores("cod_compradores")%>" size="38" maxlength="50" align="left">   
        <%else%>
		<input name="txt_cod_compradores" type="hidden" class="inputBox" id="txt_cod_compradores" style="HEIGHT: 18px; WIDTH: 190px; background: <%=medio%>" value="00" size="38" maxlength="50" align="left"> 
		<% end if%>  
  ...
  if ((not rs444Compradores.eof)  and (   rs("telefone") <> "00" and rs("telefone") <> ""  ) )  then
  
 ' if ( Ucase(session("nome_id")) = Ucase(rs("captacao"))) or (session("permissao") = "6") and (rs444Compradores("origem_franquia") = session("vOrigem_Franquia")) then
  if  (rs444Compradores("origem_franquia") = session("vOrigem_Franquia")) then
  ...
  <tr> 
	...
	<table width="1000" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          ...
          <td width="10">&nbsp;</td>
            <td width="192" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><input name="txt_responsavel_cadastramento_comprador" type="text" class="inputBox" id="txt_responsavel_cadastramento_comprador" style="HEIGHT: 18px; WIDTH: 190px; background:<%=medio%>" value="<%=rs444Comprador("responsavel_cadastramento")%>" size="38" maxlength="50" align="left"></td>
          <td width="10">&nbsp;</td>
          ...
          <td width="10">&nbsp;</td>
          <td width="192" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;">
              <select name="txt_melhor_horario_visita_comprador" size="1" class="inputBox" id="txt_melhor_horario_visita_comprador"  style="HEIGHT: 18px; WIDTH: 190px ; font-size : 10px;  color:FFFFFF; background: <%=medio%>">
...
%>
  ...
  <tr> 
        ...
        <tr> 
          ...
          <td width="10">&nbsp;</td>
            <td width="192" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><input name="txt_condominio" type="text" class="inputBox" id="txt_condominio" style="HEIGHT: 18px; WIDTH: 190px; background:<%=medio%>" value="<%=formatnumber(rs444Comprador("condominio"),2)%>" size="12" maxlength="50"></td>
          <td width="10">&nbsp;</td>
  ...
  <tr> 
    <td><table width="1000" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="495"><font color="<%=letra%>" size="1" face="Verdana, Arial, Helvetica, sans-serif">Observa&ccedil;&otilde;es 
              sobre forma de pagamento desse cliente</font></td>
          <td width="10">&nbsp;</td>
            <td width="495"><font color="<%=letra%>" size="1" face="Verdana, Arial, Helvetica, sans-serif">Observa&ccedil;&otilde;es 
  ...
  <tr> 
    <td><table width="1000" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="495" height="224" bgcolor="<%=medio%>" ><table width="495" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="102" style="border:1px solid #FFFFFF;"><textarea name="txt_obs_forma_pagamento_comp" cols=20 rows=10 class="inputBox" id="fdfdfd" style="HEIGHT: 100px; WIDTH: 493px; background:<%=medio%>" onKeyPress="return limitfield(this, 800)"><%=rs444Comprador("obs_forma_pagamento")%></textarea></td>
                </tr>
                <tr>
                  <td height="20" bgcolor="<%=escuro%>"><font color="<%=letra%>" size="1" face="Verdana, Arial, Helvetica, sans-serif">Observa&ccedil;&otilde;es 
                ...
                <tr>
                  <td height="102" style="border:1px solid #FFFFFF;"><textarea name="txt_descricao_confi" class="inputBox" id="txt_descricao_confi" style="HEIGHT: 100px; WIDTH: 493px; background:<%=medio%>" onKeyPress="return limitfield(this, 800)"><%=rs444Comprador("descricao_confi")%></textarea></td>
                </tr>
              </table>
            </td>
          <td width="10">&nbsp;</td>
            <td width="495" height="80" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><textarea name="txt_descricao" COLS=20 ROWS=10 class="inputBox" id="txt_descricao" style="HEIGHT: 222px; WIDTH: 493px; background:<%=medio%>" onKeyPress="return limitfield(this, 800)"><%=rs444Comprador("descricao")%></textarea></td>
        </tr>
      </table></td>
  </tr>
...
<div align="center"> 
  ...
  <tr>
              ...
              <td width="145"><a href="atualizar_imovel33.asp?varCod_imovel=<%=rs("cod_imovel")%>&varNaoContatado=sim"><img src="bt_naocontatado0011.jpg" width="145" height="18" border="0"></a></td>
  </tr>
</table>
