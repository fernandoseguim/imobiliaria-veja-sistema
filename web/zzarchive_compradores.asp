...
<select name="txt_edicula" id="txt_edicula" class="inputBox" style="HEIGHT: 16px; WIDTH: 130px; background:<%=medio%>" >
	    ...
	    <td width="200" ><select name="txt_standby" id="txt_standby" class="inputBox" style="HEIGHT: 16px; WIDTH: 200px; background:<%=medio%>" >
		   ...
		   <% if session("varStandby") <> "stanqualquer" and session("varStandby") <> "" then %>
            <option value="<%=session("varStandby")%>"><%=session("varStandby")%></option>
            <%end if%>
      ...
      <tr> 
        <td width="120" height="25" align="right" bgcolor="#FFFFFF">
<select name="txt_ocupacao" id="txt_ocupacao" class="inputBox" style="HEIGHT: 16px; WIDTH: 120px; background:<%=medio%>" >
	    ...
	    <td width="130" bgcolor="#FFFFFF">&nbsp; </td>
	    <td width="200" bgcolor="#FFFFFF" >&nbsp;</td>
        <td width="65" bgcolor="<%=claro%>"><input name="submit" type="submit" class="inputSubmit" style="background:<%=medio%>;" value="Buscar" width="80"></td>
...
SQL = "Select compradores.cod_compradores,compradores.nome,compradores.telefone,compradores.email,compradores.endereco,compradores.cidade,compradores.bairro,compradores.tipo,compradores.quartos,compradores.negociacao,compradores.valor,compradores.descricao,compradores.data,compradores.data_atualizacao,compradores.atendimento,compradores.vila,compradores.vagas,compradores.ocupacao,compradores.standby,compradores.cod_imovel,compradores.cod_permuta,compradores.acessos,compradores.descricao_confi,compradores.origem,compradores.dataLastEmail,compradores.textoLastEmail,compradores.responsavel_cadastramento,compradores.data_ultimo_acesso,compradores.data_futuro_contato,compradores.assunto_futuro_contato,compradores.melhor_horario_visita,compradores.telefone02,compradores.telefone03,compradores.data_ligar_urgente,compradores.assunto_ligar_urgente,compradores.quem_atualizou,compradores.suites,compradores.piscina,compradores.portaria,compradores.area_total,compradores.quintal,compradores.quadras,compradores.condominio,compradores.edicula,compradores.clique  from compradores ORDER BY cod_compradores DESC"
...
do until instr(session("SearchFor"), " ") = 0
 ...
 if session("SearchFor") ="" and session("SearchWhere") = "endereco" then
SQL = "Select compradores.cod_compradores,compradores.nome,compradores.telefone,compradores.email,compradores.endereco,compradores.cidade,compradores.bairro,compradores.tipo,compradores.quartos,compradores.negociacao,compradores.valor,compradores.descricao,compradores.data,compradores.data_atualizacao,compradores.atendimento,compradores.vila,compradores.vagas,compradores.ocupacao,compradores.standby,compradores.cod_imovel,compradores.cod_permuta,compradores.acessos,compradores.descricao_confi,compradores.origem,compradores.dataLastEmail,compradores.textoLastEmail,compradores.responsavel_cadastramento,compradores.data_ultimo_acesso,compradores.data_futuro_contato,compradores.assunto_futuro_contato,compradores.melhor_horario_visita,compradores.telefone02,compradores.telefone03,compradores.data_ligar_urgente,compradores.assunto_ligar_urgente,compradores.quem_atualizou  from compradores,compradores.suites,compradores.piscina,compradores.portaria,compradores.area_total,compradores.quintal,compradores.quadras,compradores.condominio,compradores.edicula,compradores.clique   ORDER BY Cod_compradores   DESC"
end if
...
SQL = "Select compradores.cod_compradores,compradores.nome,compradores.telefone,compradores.email,compradores.endereco,compradores.cidade,compradores.bairro,compradores.tipo,compradores.quartos,compradores.negociacao,compradores.valor,compradores.descricao,compradores.data,compradores.data_atualizacao,compradores.atendimento,compradores.vila,compradores.vagas,compradores.ocupacao,compradores.standby,compradores.cod_imovel,compradores.cod_permuta,compradores.acessos,compradores.descricao_confi,compradores.origem,compradores.dataLastEmail,compradores.textoLastEmail,compradores.responsavel_cadastramento,compradores.data_ultimo_acesso,compradores.data_futuro_contato,compradores.assunto_futuro_contato,compradores.melhor_horario_visita,compradores.telefone02,compradores.telefone03,compradores.data_ligar_urgente,compradores.assunto_ligar_urgente,compradores.quem_atualizou,compradores.suites,compradores.piscina,compradores.portaria,compradores.area_total,compradores.quintal,compradores.quadras,compradores.condominio,compradores.edicula,compradores.clique  from compradores where cod_compradores like '"& session("SearchFor") &"'  ORDER BY Cod_compradores   DESC"
end if
...
'indica o tipo de cursor utilizado, se somente de leitura ou se de leitura e gravação.
 ...
 %>
	  ...
	  <td width="30" bgcolor="<%=color1%>" height="18" style="border:1px solid #FFFFFF;">&nbsp;</td>
    ...
    <td bgcolor="#FFFFFF"> 
      <div align="center"><font face="Verdana, arial" size="1" color="#000000"> 
        ...
        <!-- se a página atual for maior que "1" então o link anteriro é colocado na 
			  na tela .-->
        <a href="?page=<%=intPage - 1%>&varCidade=<%=session("varCidade")%>&varCidade2=<%=session("varCidade2")%>&varBairro=<%=session("varBairro")%>&varBairro2=<%=session("varBairro2")%>&varNegociacao=<%=session("varNegociacao")%>&varTipo=<%=session("varTipo")%>&varQuartos=<%=session("varQuartos")%>&varVagas=<%=session("varVagas")%>&SearchFor=<%=session("SearchFor")%>&SearchWhere=<%=session("SearchWhere")%>&varValor=<%=session("varValor")%>&varValor1=<%=session("varValor1")%>&varValor2=<%=session("varValor2")%>&varAtendimento=<%=session("varAtendimento")%>&varOcupacao=<%=session("varOcupacao")%>" style="color:#000000"> 
