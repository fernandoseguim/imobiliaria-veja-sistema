...
dim vCod444Permuta202

if not rs444Permuta202.eof then
vCod444Permuta202 = rs444Permuta202("cod_permuta")
else
vCod444Permuta202 = "0"
			  ...
			  <tr>
			      <td height="60"><table width="584" height="60" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        ...
                        <td width="10" height="30">&nbsp;</td>
                        <td width="188" height="30"><div align="center"><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Clique 
                            aqui e adicione fotos do seu im&oacute;vel</strong></font></div></td>
                        <td width="10" height="30">&nbsp;</td>
...
rsproposta01.ActiveConnection = Conexao
	...
	rsproposta01.Open sqlproposta01, Conexao
						...
						%>
						<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong><a href="archive_contas_proposta02.asp?varCodimovel=<%=varCod_imovel%>" target="_blank" style="color:#000000;text-decoration:none;">Sim , existem <%=rsproposta01.recordcount %>  propostas para o seu imóvel, clique aqui.</a></strong></font>
						<%else%>
					 ...
					 <tr>
                      ...
                      <td width="10">&nbsp;</td>
						...
						%>
						  <div align="center"><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong><a href="javascript:newWindow2121('conta_permuta01.asp?varCodPermuta=<%=vCod444Permuta202%>')" style="color:#000000;text-decoration:none;">Veja 
                            suas indica&ccedil;&otilde;es de permuta aqui</a></strong></font></div>
							<%else%>
                      ...
                      <td width="10">&nbsp;</td>
						...
						if vCod444Permuta202 <> "0" then
						%>
						  <div align="center"><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong><a href="javascript:newWindow2121('conta_comprador01.asp?varCodCompradores=<%=vCod444Comprador202%>')" style="color:#000000;text-decoration:none;">Veja 
                            suas indica&ccedil;&otilde;es de comprador</a></strong></font></div>
							<%else%>
