...
<%
Dim Conexao,strSQL,rs,varCod_proposta_oficial,vcheck01,SearchFor



SearchFor = request.Querystring("SearchFor")
 varCod_proposta_oficial = request.form("varCod_proposta_oficial")
 vcheck01 = request.form("check01")                                                           
	
	if varCod_proposta_oficial = "" and vcheck01 = "" then
	...
	Conexao.execute"delete from proposta_oficial where cod_proposta_oficial in ("& request.form("check01") &")"
