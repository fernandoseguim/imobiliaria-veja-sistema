...
<table width="690" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="30" bgcolor="<%=claro%>"><table width="680" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr bgcolor="<%=claro%>"> 
    ...
    <%end if%>
            ...
            <td width="200" height="20" bgcolor="<%=claro%>"> 
             
                <table width="200" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="100"><div align="center">
                      <input name="txt_numero" type="text" class="inputBox" id="txt_numero" style="HEIGHT: 18px; WIDTH: 80px; background:<%=medio%>;border:1px solid #FFFFFF;" value="0" size="38" maxlength="50" align="left">
                    </div></td>
                    
                  <td width="100"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>mudar 
                    para</strong></font></td>
                  </tr>
                </table>
               </td>
