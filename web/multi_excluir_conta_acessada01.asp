...
SearchFor = request.Querystring("SearchFor")
 varCodConta = request.form("varCodConta")
 session("varConta") = varCodConta
 
 vcheck01 = request.form("check01")
 session("vcheck01") = vcheck01
 
 if varCodConta = "" and vcheck01 = "" then
 response.Redirect "archive_contas_procuradas_corretor.asp?searchFor="&searchFor&"&searchWhere="&searchWhere&""
 end if
	...
	Conexao.execute"delete from contas_procuradas where cod_conta in ("& request.form("check01") &")"
	 ...
	 response.redirect "archive_contas_procuradas_corretor.asp?page="&cInt(Page)&"&SearchFor="&SearchFor&"&SearchWhere="&SearchWhere&"&varCidade="&varCidade&"&varBairro="&varBairro&"&varNegociacao="&varNegociacao&"&varQuartos="&varQuartos&"&varValor1="&varValor1&"&varValor2="&varValor2&"&varValor="&varValor&""
