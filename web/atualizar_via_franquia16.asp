   ...
   Conexao.Open dsn
	...
	rs444Indicacao.Open strSQL444Indicacao, Conexao
	 ...
	 if not rs444Indicacao.eof then 
				   ...
				   Conexao.execute"update permuta_procurados set origem_franquia='"&"Sao Bernardo"&"' where  cod_PermutaProcurados="&rs444Indicacao("cod_PermutaProcurados") 
