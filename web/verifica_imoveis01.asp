...
function newWindow1974(abrejanela1974) {
   openWindow1974 = window.open(abrejanela1974,'openWin22','width=750,height=500,resizable=yes,scrollbars=yes')
...
SQL = "select imoveis.cod_imovel,imoveis.captacao,imoveis.proprietario,imoveis.telefone,imoveis.telefone02,imoveis.telefone03,imoveis.endereco  from imoveis where "
...
SQL = "select imoveis.cod_imovel,imoveis.captacao,imoveis.proprietario,imoveis.telefone,imoveis.telefone02,imoveis.telefone03,imoveis.endereco from compradores order by cod_imovel Desc"
  ...
  <table width="780" border="0" cellspacing="0" cellpadding="0">
    <tr> 
	 ...
	 <td width="150" height="18" bgcolor="#000000" style="border:1px solid #FFFFFF;"> 
        <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Captacao</strong></font></div></td>
...
%>
	...
	<tr> 
	 ...
	 <td width="150" height="18" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;"> 
        <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><a href="javascript:newWindow1974('visualizar_imovel33.asp?varCod_imovel=<%=varCod_imovel%>')"><%=rs("captacao")%></a></font></div></td> 
	 
	
	 <td width="150" height="18" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;"> 
        <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><a href="javascript:newWindow1974('visualizar_imovel33.asp?varCod_imovel=<%=varCod_imovel%>')"><%=rs("proprietario")%></a></font></div></td> 
	 
	 
	 <td width="240" height="18" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;"> 
        <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><a href="javascript:newWindow1974('visualizar_imovel33.asp?varCod_imovel=<%=varCod_imovel%>')"><%=rs("telefone")%></a></font></div></td>
	 
	<td width="240" height="18" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;"> 
        <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><a href="javascript:newWindow1974('visualizar_imovel33.asp?varCod_imovel=<%=varCod_imovel%>')"><%=rs("endereco")%></a></font></div></td>
    ...
    <td bgcolor="#FFFFFF"> 
      <div align="center">
        ...
        <!-- se intPage é menor que o número de páginas então colocar o botão próximo -->
         <a href="?page=<%=intPage + 1%>&SearchFor=<%=session("SearchFor")%>&SearchWhere=<%=session("SearchWhere")%>" style="color:#000000"><font face="Verdana, arial" size="1" color="#000000" > <b>Próximo</b></font> 
        </a> 
        <%End If%>
        </font></div></td>
        </tr>
