...
function xpop(){
if (confirm("Se você atualizou esse imóvel, clique OK, senão clique em cancelar e atualize?")){
window.close();
}
else {
...
<table width="1000" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    <td><table width="1000" border="0" cellspacing="0" cellpadding="0">
	   ...
	   <%end if%>
		  ...
		  <td width="10">&nbsp;</td>
          <td width="154" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><input name="txt_data_futuro_contato_vend" type="text" class="inputBox" id="txt_data_futuro_contato_vend" style="HEIGHT: 18px; WIDTH: 154px; background:<%=medio%>" value="<%if rs("data_futuro_contato") <> "" then response.write rs("data_futuro_contato") else response.write "não informado" end if%>" size="38" maxlength="50" align="left"></td>
          <td width="10">&nbsp;</td>
    ...
    <td> <table width="1000" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          <td width="192" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;">
			   ...
			   <% if rs("captacao") = "internet" or rs("captacao") = "Avaliação" or rs("captacao") = "Busca de compradores" or  session("permissao") = "6" then %>
        ...
        <tr> 
          ...
          <td width="10">&nbsp;</td>
          <td width="192" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><input name="txt_telefone03_vend" type="text" class="inputBox" id="txt_telefone03_vend" style="HEIGHT: 18px; WIDTH: 190px; background: <%=medio%>" value="<%if rs("telefone03") <> "" then response.write rs("telefone03") else response.write "não informado" end if%>" size="38" maxlength="20" align="left"></td>
          <td width="10">&nbsp;</td>
          <td width="192" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"><input name="txt_telefone02_vend" type="text" class="inputBox" id="txt_telefone02_vend" style="HEIGHT: 18px; WIDTH: 190px; background: <%=medio%>" value="<%if rs("telefone02") <> "" then response.write rs("telefone02") else response.write "não informado" end if%>" size="38" maxlength="20" align="left"></td>
          <td width="10">&nbsp;</td>
          ...
          <td width="10">&nbsp;</td>
            <td width="192" bgcolor="<%=escuro%>" ><select name="txt_quem_tirou_foto_vend" id="txt_quem_tirou_foto_vend" class="inputBox" style="HEIGHT: 18px; WIDTH: 190px; background: <%=medio%>">
			   ...
			   <% if rs("quem_tirou_foto") = "" or rs("quem_tirou_foto") = "não informado"  or  session("permissao") = "6" then %>
			    ...
			    <option value="<%if rs("quem_tirou_foto") <> "" then response.write rs("quem_tirou_foto") else response.write "não informado" end if%>" selected><%if rs("quem_tirou_foto") <> "" then response.write rs("quem_tirou_foto") else response.write "não informado" end if%></option>
  ...
  if vPerguntaPermuta = "não" or vPerguntaCompradores = "não" then
