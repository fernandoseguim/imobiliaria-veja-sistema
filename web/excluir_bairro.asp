...
<%
Dim Conexao,strSQL,rs,varCod_bairro,SearchFor,SearchWhere,page
 varCod_bairro = request.QueryString("varCod_bairro")
...
SearchWhere = request.querystring("SearchWhere")
  page = request.querystring("page")
	...
	Conexao.execute"Delete from combo2 where id_combo2="&VarCod_bairro
	 ...
	 response.redirect "archive_bairro.asp?SearchWhere="&SearchWhere&"&SearchFor="&SearchFor&"&page="&page&""
