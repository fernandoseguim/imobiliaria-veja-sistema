...
<%
Dim Conexao,strSQL,rs,varCod_financiamentos,vcheck01,SearchFor



SearchFor = request.Querystring("SearchFor")
 varCod_financiamentos = request.form("varCod_financiamentos")
 ...
 page = request.querystring("page")
	...
	if varCod_financiamentos = "" and vcheck01 = "" then
	response.Redirect "archive_financiamentos.asp?SearchFor="&SearchFor&""
	end if														  
	...
	Conexao.execute"delete from financiamentos where cod_financiamentos in ("& request.form("check01") &")"
	 ...
	 set conexao = nothing
	  ...
	  response.Redirect "archive_financiamentos.asp?page="&cInt(Page)&"&SearchFor="&SearchFor&""
