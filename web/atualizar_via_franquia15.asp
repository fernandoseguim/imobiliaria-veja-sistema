...
vAssunto_ligar_urgente = " Um novo imóvel foi atualizado e ocorreu uma indicação, ligue imediatamente para esse comprador"
   ...
   Conexao.Open dsn
	...
	strSQL444Indicacao = "SELECT referencia_procurados.cod_ReferenciaProcurados,referencia_procurados.referencia,referencia_procurados.enderecoIP,referencia_procurados.data,referencia_procurados.origem_franquia FROM referencia_procurados  ORDER BY cod_ReferenciaProcurados DESC" 
	...
	rs444Indicacao.Open strSQL444Indicacao, Conexao
	 ...
	 if not rs444Indicacao.eof then 
				   ...
				   Conexao.execute"update referencia_procurados set origem_franquia='"&"Sao Bernardo"&"' where  cod_ReferenciaProcurados="&rs444Indicacao("cod_ReferenciaProcurados") 
