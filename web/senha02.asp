...
<form action="login02.asp" Method="Post" name="senha">
              ...
              <table border="0" cellpadding="2" cellspacing="0">
			   ...
			   <tr bgcolor="<%=claro%>"> 
                  ...
                  <td bgcolor="<%=claro%>"> 
				    ...
				    <% While NOT Rs33.EoF %>
                    <option value="<% = Rs33("nome_combo1") %>" <% if lcase(Rs33("nome_combo1")) = lcase("SAO BERNARDO") then response.write "selected" end if %>>
                    <% = Rs33("nome_combo1") %>
                    </option>
                    <% Rs33.MoveNext %>
                    <% Wend %>
