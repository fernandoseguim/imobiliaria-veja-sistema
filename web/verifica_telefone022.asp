...
varFoto = request.querystring("txt_foto")
 ...
 if request.QueryString("varFoto")<>"" then
...
dim rs4,strSQL4,Conexao
   Set Conexao = Server.CreateObject("ADODB.Connection")
	...
	strSQL4 = "SELECT * FROM combo2 where id_combo1 = "&int(session("varCidade2"))&"  ORDER BY nome_combo2" 
	else
...
<br>
  ...
  aqui se o telefone do propriet&aacute;rio do im&oacute;vel est&aacute; cadastrado 
  em im&oacute;veis.</font></strong><br>
<br>
<%
Dim orderBy
...
<form action="verifica_telefone022.asp?SearchFor=<%=SearchFor%>" Method="GET" name="b2" >
  ...
  <table width="390" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td width="150" height="18" bgcolor="#000000" style="border:1px solid #FFFFFF;"> 
        <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Propriet&aacute;rio</strong></font></div></td>
...
<%
  ...
  <table width="390" border="0" cellspacing="0" cellpadding="0" align="center">
    <tr> 
      ...
      <div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Não 
        foi encontrado o telefone.</font></div>
    </td>
