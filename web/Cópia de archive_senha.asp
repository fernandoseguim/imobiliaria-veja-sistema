...
SQL = "Select senha.list_name,senha.admin_id,senha.admin_pass,senha.admin_email,senha.from_email,senha.url_dir,senha.url_home,senha.component,senha.smtp,senha.permissao,senha.id   from senha  ORDER BY ID DESC"
...
<table width="730" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="730" height="18"><table width="730" height="18" border="0" cellpadding="0" cellspacing="0">
        <tr>
...
<input type="checkbox" name="selTodos" onclick="check(true);"></td>
  ...
  <tr>
    <td><table width="730" height="18" border="0" cellpadding="0" cellspacing="0">
...
%>
	    ...
	    <tr>
          <% varCodSenha = rs("ID") %>
          <td width="95" height="18"><table width="730" height="18" border="0" cellpadding="0" cellspacing="0">
              <tr>
