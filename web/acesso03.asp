...
<div align="center"><font color="<%=escuro%>" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Para 
        verificar se existem compradores para o seu im&oacute;vel , digite seu 
        telefone e clique em entrar.</strong></font></div></td>
    </tr>
  </table><br><br>
...
<form action="acessoLink03.asp" onSubmit="return isValidDigitNumber(this);" Method="Post" name="doublecombo">
...
<tr>
            <td bgcolor="<%=claro%>" align="center" > 
              <table border="0" cellpadding="2" cellspacing="0">
                ...
                <tr bgcolor="<%=claro%>"> 
                  <td align="right" bgcolor="<%=claro%>"><font color="<%=escuro%>" size="1" face="Verdana">Seu 
                    Telefone:</font></td>
                  <td bgcolor="<%=claro%>"> 
                    <input type="text" value="<%=session("varTelefone")%>" name="telefone" size="15" class="inputBox" style="HEIGHT: 18px; WIDTH: 120px; background:<%=escuro%>" ></td>
</tr>
