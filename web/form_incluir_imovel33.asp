...
if (doublecombo.txt_edicula_vend.value == "00" || doublecombo.txt_edicula_vend.value == "" ) {
        alert("Você precisa informar se tem edícula no imóvel!");
        doublecombo.txt_edicula_vend.focus();
...
if (doublecombo.txt_a_constr_vend.value == "00" || doublecombo.txt_a_constr_vend.value == "" ) {
	...
	if (doublecombo.txt_a_total_vend.value == "00" || doublecombo.txt_a_total_vend.value == "" ) {
        alert("Você precisa informar a área total do imóvel!");
	...
	if (doublecombo.txt_metros_de_frente_vend.value == "00" || doublecombo.txt_metros_de_frente_vend.value == "" ) {
        alert("Você precisa informar quantos metros de frente tem o imóvel!");
        doublecombo.txt_metros_de_frente_vend.focus();
		
        return false;
    }
	
	
	if (doublecombo.txt_metros_de_fundo_vend.value == "00" || doublecombo.txt_metros_de_fundo_vend.value == "" ) {
        alert("Você precisa informar quantos metros de fundo tem o imóvel!");
        doublecombo.txt_metros_de_fundo_vend.focus();
		
        return false;
    }
	
	
	if (doublecombo.txt_metros_lateral_esquerda_vend.value == "00" || doublecombo.txt_metros_lateral_esquerda_vend.value == "" ) {
        alert("Você precisa informar quantos metros de lateral esquerda tem o imóvel!");
        doublecombo.txt_metros_lateral_esquerda_vend.focus();
		
        return false;
    }
	
	
	if (doublecombo.txt_metros_lateral_direita_vend.value == "00" || doublecombo.txt_metros_lateral_direita_vend.value == "" ) {
        alert("Você precisa informar quantos metros de lateral direita tem o imóvel!");
        doublecombo.txt_metros_lateral_direita_vend.focus();
...
if (doublecombo.txt_telefone_vend.value == "") {
        alert("Você precisa informar o telefone do proprietário!");
...
if (doublecombo.txt_ocupacao_vend.value == "não informado") {
        alert("Você precisa indicar se imóvel está vago ou não!");
...
if (doublecombo.txt_endereco_vend.value == "" || doublecombo.txt_endereco_vend.value == "não informado" ) {
	...
	if (doublecombo.txt_obs_imovel_vend.value == "") {
...
if (doublecombo.txt_data_futuro_contato_vend.value == "0/0/2007 00:00:00") {
	...
	if (doublecombo.txt_tipo_vend.value == "FLAT" && doublecombo.txt_condominio_vend.value == "0,00" ) {
        alert("Você precisa indicar o valor do condomínio!");
        doublecombo.txt_condominio_vend.focus();
		doublecombo.txt_condominio_vend.select();
        return false;
	...
	if (doublecombo.txt_tipo_vend.value == "KITNET" && doublecombo.txt_condominio_vend.value == "0,00" ) {
        alert("Você precisa indicar o valor do condomínio!");
        doublecombo.txt_condominio_vend.focus();
		doublecombo.txt_condominio_vend.select();
        return false;
	...
	if (doublecombo.txt_tipo_vend.value == "LOFT" && doublecombo.txt_condominio_vend.value == "0,00" ) {
        alert("Você precisa indicar o valor do condomínio!");
        doublecombo.txt_condominio_vend.focus();
		doublecombo.txt_condominio_vend.select();
        return false;
	...
	if (doublecombo.txt_tipo_vend.value == "SALA COMERCIAL" && doublecombo.txt_condominio_vend.value == "0,00" ) {
        alert("Você precisa indicar o valor do condomínio!");
        doublecombo.txt_condominio_vend.focus();
		doublecombo.txt_condominio_vend.select();
        return false;
	...
	if (doublecombo.txt_tipo_vend.value == "TERRENO EM CONDOMINIO" && doublecombo.txt_condominio_vend.value == "0,00" ) {
        alert("Você precisa indicar o valor do condomínio!");
        doublecombo.txt_condominio_vend.focus();
		doublecombo.txt_condominio_vend.select();
        return false;
