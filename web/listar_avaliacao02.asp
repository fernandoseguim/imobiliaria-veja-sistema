...
response.Redirect "sem_avaliacao02.asp"
   ...
   Set rsAvaliacao = Server.CreateObject("ADODB.RecordSet")
	...
	strSQLAvaliacao = "SELECT * FROM imoveis Where telefone like '"&session("telefone")&"' or telefone02 like '"&session("telefone")&"'or telefone02 like '"&session("telefone")&"'"
...
'strSQL ="SELECT SUM(valor) as total  FROM Imoveis"&stringIndex&stringCidade&stringBairro&stringTipo&stringNegociacao&stringVagas&stringQuartos&string_Area_Total&" and imovel_em_negociacao like 'imóvel OK'   and valor <> '0' "


strSQL ="SELECT SUM(valor) as total  FROM Imoveis"&stringIndex&stringCidade&stringBairro&stringTipo&stringNegociacao&string_Area_Total&"  and valor not like '"&int("0")&"' "
...
'rsVerificacao008.CursorType = 3
 ...
 Conexao.execute"Insert into imoveis(proprietario,endereco,telefone,email,foto_grande,foto_pequena,foto_grande1,foto_grande2,foto_grande3,foto_grande4,foto_grande5,link_foto,cidade,bairro,tipo,area_total,area_construida,quartos,banheiros,vagas,negociacao,valor,data,obs_imovel,obs_proprietario,presenca_primeira,titulo_anuncio,texto_anuncio,standby,ocupacao,captacao,data_atualizacao,vila,placa,condominio,qualidade,foto_grande6,foto_grande7,foto_grande8,foto_grande9,foto_grande10,data_futuro_contato,assunto_futuro_contato,telefone02,telefone03,suites,chaves_do_imovel,melhor_horario_visita,imovel_em_negociacao,metros_de_frente,metros_de_fundo,metros_lateral_esquerda,metros_lateral_direita,origem_captacao,responsavel_cadastramento,data_ultimo_acesso,data_captacao,cliques_no_imovel,tarja02,data01_tarja02,data02_tarja02,data_contato,origem_franquia) values( '"& session("nome") &"','"& "não informado" &"','"& session("telefone") &"','"& session("email") &"','"& vimagem &"','"& vimagem &"','"& vimagem &"','"& vimagem &"','"& vimagem &"','"& vimagem &"','"& vimagem &"','"& "icon_foto2.gif" &"','"& session("vCidade") &"','"& session("vBairro") &"','"& session("vTipo") &"','"& session("vArea_Total") &"','"& "0" &"','"& session("vQuartos") &"','"& "0" &"','"& session("vVagas") &"','"& "venda" &"','"& int("0") &"','"& now() &"','"& "não informado" &"','"& "não informado" &"','"& "excluido" &"','"& "não informado" &"','"&"não informado" &"','"& "excluido" &"','"& "não informado" &"','"& "Internet" &"','"& now() &"','"& "não informado"&"','"& "não informado" &"','"& "00"&"','"&"não informado"&"','"& vimagem &"','"& vimagem &"','"& vimagem &"','"& vimagem &"','"& vimagem &"','"& now() &"','"& "não informado" &"','"& "00" &"','"& "00" &"','"& "0" &"','"& "não informado" &"','"& "não informado" &"','"& "Imóvel não contatado" &"','"& "00" &"','"& "00" &"','"& "00" &"','"& "00" &"','"& "Avaliação" &"','"& "Avaliação" &"','"& now() &"','"& now() &"','"& "0" &"','"& "sim"&"','"& day(now())&"','"& day(DateAdd("d", 15, now()))&"','"&now()&"','"& session("vOrigem_Franquia") &"')"
...
SQL2 = "SELECT *FROM Imoveis"&stringIndex&stringCidade&stringBairro&stringTipo&stringNegociacao&string_Area_Total&"  and valor not like '"&int("0")&"' "
...
<table width="350" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="120">
<center>
<strong><font color="#9d9249" size="2" face="Verdana, Arial, Helvetica, sans-serif">O valor aproximado 
do seu imóvel é <br>
<br><br><br><br>
		...
		<br>
        <strong><font color="#9d9249" size="2" face="Verdana, Arial, Helvetica, sans-serif"><br>
        <a href="primeira01.asp"><img src="bt_entrar_avaliacao.jpg" border="0"></a></img> 
        </font></strong> 
      </center></td>
  </tr>
</table>
...
<table width="350" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="50">
      <div align="center"> <strong><font color="#9d9249" size="2" face="Verdana, Arial, Helvetica, sans-serif"></font></strong> 
        <br>
      </div></td>
  </tr>
</table>
...
<table width="250" height="120" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td><div align="center"><font color="#9d9249" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>N&atilde;o 
