...
<center>
<br>
  <a href="excluir_estatistica_permuta.asp"><img src="bt_excluir002.jpg" width="95" height="18" border="0"></a><br>
  <br>
...
SQL ="SELECT * FROM permuta_procurados ORDER BY cod_PermutaProcurados DESC" 
...
<form  Method="Post" name="Formulario" action="multi_excluir_imovel.asp?varCod_imovel=<%=varCod_imovel%>&SearchFor=<%=SearchFor%>&SearchWhere=<%=SearchWhere%>&varCidade=<%=session("varCidade")%>&varBairro=<%=session("varBairro")%>&varNegociacao=<%=session("varNegociacao")%>&varQuartos=<%=session("varQuartos")%>&page=<%=cInt(intPage)%>" >
  <table width="1835" border="0" cellspacing="0" cellpadding="0">
    <tr bgcolor="#000000"> 
...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">
      ...
      <td width="115" height="30" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;">
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=rs("telefone")%> 
          </font></div></td>
...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">
	  ...
	  <td width="115" height="30" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;">
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">
          <%if rs("valor_vend") = "vqualquer" then response.write "qualquer um" else response.write formatnumber(session("vValor1"),2)&" até "&formatnumber(session("vValor2"),2) end if%>
          </font></div></td>
...
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">
	  ...
	  <td width="115" height="30" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;">
<div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">
          <%if rs("valor_comp") = "vqualquer" then response.write "qualquer um" else response.write formatnumber(session("vValor3"),2)&" até "&formatnumber(session("vValor4"),2) end if%>
          </font></div></td>
