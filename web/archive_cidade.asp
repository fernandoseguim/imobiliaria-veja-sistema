...
function newWindow2(abrejanela) {
   openWindow = window.open(abrejanela,'openWin','width=345,height=140,resizable=no')
   openWindow.focus( )
   }
...
SQL = "Select combo1.id_combo1,combo1.nome_combo1,combo1.data_combo1 from combo1  ORDER BY nome_combo1"
...
%>
<form  Method="Post" name="Formulario" action="multi_excluir_cidade.asp" >           
...
<input type="checkbox" name="selTodos" onclick="check(true);"></td>
    <td width="95"><% if   session("permissao") = "3" or session("permissao") = "5" or session("permissao") = "6" then %><input name="image" type="image" src="bt_excluir002.jpg" width="95" height="18" border="0"><%else%><img src="bt_excluir002.jpg" width="95" height="18" border="0"></img><%end if%></td>
      <td width="95"><% if   session("permissao") = "3" or session("permissao") = "5" or session("permissao") = "6" then %><a href="javascript:newWindow2('form_incluir_cidade.asp')"><img src="bt_incluir001.jpg" width="95" height="18" border="0"></a><%else%><img src="bt_incluir001.jpg" width="95" height="18" border="0"><%end if%></td>
...
'------------------------------------------------
varCod_cidade = rs("id_combo1")
%>
	<tr>
    <td width="18" bgcolor="<%=color1%>"><input type="checkbox" name="check01" value="<%=rs("id_combo1")%>"></td>
      <td width="95" bgcolor="<%=color1%>"><% if  session("permissao") = "3" or session("permissao") = "5" or session("permissao") = "6"  then %><a href="excluir_cidade.asp?varCod_cidade=<%=varCod_cidade%>"><img src="bt_excluir001.jpg" width="95" height="18" border="0"></img></a><%else%><img src="bt_excluir001.jpg" width="95" height="18" border="0"></img><%end if%></td>
      <td width="95" bgcolor="<%=color1%>"><img src="bt_visualizar002.jpg" width="95" height="18" border="0"></td>
    <td width="120" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;"><div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=rs("nome_combo1")%></font></div></td>
    <td width="120" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;"><div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=rs("data_combo1")%></font></div></td>
...
%>
 ...
 <br>
 <center><% if   session("permissao") = "3" or session("permissao") = "5" or session("permissao") = "6" then %><a href="javascript:newWindow2('form_incluir_cidade.asp')"><img src="bt_incluir001.jpg" width="95" height="18" border="0"></a><%else%><img src="bt_incluir001.jpg" width="95" height="18" border="0"><%end if%></center>
 <br>
 <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif">
<div align="center"I>Não foi encontrada nenhuma cidade.</div>
</font>             
