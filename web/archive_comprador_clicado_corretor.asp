...
<html>
<head>
<title>Compradores clicados</title>
...
<br>
  ...
  compradores clicados por internautas</strong></font> 
</center>
...
'SQL ="SELECT * FROM imovel_clicado ORDER BY cod_clicado DESC" 
	
 

 
if session("permissao") <> "6" then
SQL ="SELECT comprador_clicado.cod_clicado,comprador_clicado.nome,comprador_clicado.telefone,comprador_clicado.codigo_clicado,comprador_clicado.endereco_ip,comprador_clicado.data,comprador_clicado.tipo,comprador_clicado.quartos,comprador_clicado.vagas,comprador_clicado.cidade,comprador_clicado.bairro,comprador_clicado.valor,comprador_clicado.negociacao,comprador_clicado.tarja02,comprador_clicado.origem,comprador_clicado.origem_franquia  FROM comprador_clicado  WHERE origem_franquia like '"&session("vOrigem_Franquia")&"' and atendimento like '"&session("nome_id")&"' ORDER BY cod_clicado DESC" 

else
SQL ="SELECT comprador_clicado.cod_clicado,comprador_clicado.nome,comprador_clicado.telefone,comprador_clicado.codigo_clicado,comprador_clicado.endereco_ip,comprador_clicado.data,comprador_clicado.tipo,comprador_clicado.quartos,comprador_clicado.vagas,comprador_clicado.cidade,comprador_clicado.bairro,comprador_clicado.valor,comprador_clicado.negociacao,comprador_clicado.tarja02,comprador_clicado.origem,comprador_clicado.origem_franquia FROM comprador_clicado WHERE origem_franquia like '"&session("vOrigem_Franquia")&"' ORDER BY cod_clicado DESC" 

end if
 
'SQL ="SELECT comprador_clicado.cod_clicado,comprador_clicado.nome,comprador_clicado.telefone,comprador_clicado.codigo_clicado,comprador_clicado.endereco_ip,comprador_clicado.data,comprador_clicado.tipo,comprador_clicado.quartos,comprador_clicado.vagas,comprador_clicado.cidade,comprador_clicado.bairro,comprador_clicado.valor,comprador_clicado.negociacao,comprador_clicado.tarja02,comprador_clicado.origem FROM comprador_clicado ORDER BY cod_clicado DESC" 
...
<form  Method="Post" name="Formulario" action="multi_excluir_comprador_clicado01.asp?varCodClicado=<%=varCodClicado%>&page=<%=cInt(intPage)%>&SearchFor=<%=SearchFor%>&SearchWhere=<%=SearchWhere%>&varCidade=<%=session("varCidade")%>&varBairro=<%=session("varBairro")%>&varNegociacao=<%=session("varNegociacao")%>&varQuartos=<%=session("varQuartos")%>" >
  <table width="1745" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="97" height="18" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;"> 
        <% if   session("permissao") = "6" then %><input name="image" type="image" src="bt_excluir002.jpg" width="95" height="18" border="0"><%else%><img src="bt_excluir002.jpg" width="95" height="18" border="0"></img><%end if%></td>
   
      <td width="25" bgcolor="#000000" style="border:1px solid #FFFFFF;"></td>
      <td width="60" bgcolor="#000000" style="border:1px solid #FFFFFF;"><div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Origem</strong></font></div></td>
     
	 
	 
	 
	  <td width="110" height="18" bgcolor="#000000" style="border:1px solid #FFFFFF;"> 
	  ...
	  <td width="110" height="18" bgcolor="#000000" style="border:1px solid #FFFFFF;"> 
        <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Telefone 
          do internauta</strong></font></div></td>
      
	  
	   <td width="110" height="18" bgcolor="#000000" style="border:1px solid #FFFFFF;"> 
        <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>c&oacute;digo 
          do cliente clicado</strong></font></div></td>
	  ...
	  <td width="110" height="18" bgcolor="#000000" style="border:1px solid #FFFFFF;"> 
        <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Negocia&ccedil;&atilde;o</strong></font></div></td>
	  ...
	  <td width="110" height="18" bgcolor="#000000" style="border:1px solid #FFFFFF;"> 
        <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong>Quartos</strong></font></div></td>
...
%>
	...
	<% varCodClicado= rs("cod_clicado") %>
   
    <tr> 
      <td width="22" height="18" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;"> 
        <input type="checkbox" name="check01" value="<%=rs("cod_clicado")%>"></td>
   
     
   
      <td width="97" height="18" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;"> 
        <% if  session("permissao") = "6"  then %><a href="excluir_comprador_clicado01.asp?page=<%=cInt(intPage)%>&varCodClicado=<%=varCodClicado%>&SearchFor=<%=SearchFor%>&SearchWhere=<%=SearchWhere%>"><img src="bt_excluir001.jpg" width="95" height="18" border="0"></img></a><%else%><img src="bt_excluir001.jpg" width="95" height="18" border="0"></img><%end if%>
	 
	 <td width="25" bgcolor="<% if rs("tarja02") <> "" then response.write "green" else response.write color1 end if%>" style="border:1px solid #FFFFFF;"></td>
     
	  <td width="60" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;"><div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong><%=rs("origem")%></strong></font></div></td>
     
	 
	  <td width="110" height="18" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;"> 
...
<% end if%>
	   ...
	   <td width="110" height="18" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;"><div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong><a href="javascript:newWindow2('visualizar_compradores33.asp?varCodCompradores=<%=rs("codigo_clicado")%>')"><%=rs("codigo_clicado")%></a></strong></font></div></td> 
	   
      <td width="110" height="18" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;"> 
        <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><%=rs("data")%><strong></strong></font></div></td>
...
'se no cliente ou no servidor.
	...
	strSQL444P = "SELECT compradores.data,compradores.cod_compradores,compradores.telefone,compradores.telefone02,compradores.telefone03 FROM compradores where (telefone like '%"&rs("telefone")&"%' or telefone02 like '%"&rs("telefone")&"%' or telefone03 like '%"&rs("telefone")&"%')"
...
'indica o tipo de cursor utilizado, se somente de leitura ou se de leitura e gravação.
 ...
 %>
	  ...
	  <td width="110" height="18" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;"> 
        <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong><%=rs("negociacao")%></strong></font></div></td>
      ...
      <td width="110" height="18" bgcolor="<%=color1%>" style="border:1px solid #FFFFFF;"> 
        <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">
          <%if rs("tipo") <> "tqualquer" then response.write rs("tipo") else response.write "qualquer um" end if%>
          </font></div></td>
...
%>
<a href="?page=<%=i%>" style="color:#000000"><%if int(intPage) = int(i) then %><font color="#FF0000"><%else%><font color="#000000"><%end if%><%=i%></font>
</a> 
<%next%>
<%end if%>
...
<table width="95" border="0" cellspacing="0" cellpadding="0" align="center">
 ...
 <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif">
<div align="center"I><font color="<%=escuro%>">Compradores não encontrados</font></div>
</font> 
<%
End if
%>
