...
<%
Dim Conexao,strSQL,rs,varCod_tipo,vcheck01,SearchFor




 varCod_tipo = request.form("varCod_tipo")
 vcheck01 = request.form("check01")                                                           
	
	if varCod_tipo = "" and vcheck01 = "" then
	response.Redirect "archive_tipo.asp"
	end if														  
	...
	Conexao.execute"delete from tipo where id_tipo in ("& request.form("check01") &")"
