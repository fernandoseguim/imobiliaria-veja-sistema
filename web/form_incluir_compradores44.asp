			 ...
			 <tr bgcolor="<%=medio%>"> 
			  ...
			  <tr> 
			    ...
			    <tr bgcolor="<%=claro%>"> 
                  <td style="border:1px solid #FFFFFF;"> 
                    <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">StandBy 
                      /im&oacute;vel com proposta</font></div></td>
                  <td style="border:1px solid #FFFFFF;"> 
			   ...
			   <tr bgcolor="<%=medio%>"> 
                  <td style="border:1px solid #FFFFFF;"> 
                    <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Imóvel vendido/suspenso</font></div></td>
                  <td style="border:1px solid #FFFFFF;"> 
...
SqlMarcas3 = "SELECT * FROM combo1 ORDER BY id_combo1 DESC" 
...
SqlCarros3 = "SELECT * FROM combo2 WHERE id_combo1 =" & rsMarcas3("id_combo1")&" order by id_combo2 DESC"
...
'Agora entramos com o banco de dados! Temos que jogar aqui todas as opções de carro!
SqlMarcas33 = "SELECT * FROM combo1 ORDER BY id_combo1 DESC" 
...
'Abrimos todos os carros relativos a essa marca!
SqlCarros33 = "SELECT * FROM combo2 WHERE id_combo1 =" & rsMarcas33("id_combo1")&" order by id_combo2 DESC"
...
'Agora entramos com o banco de dados! Temos que jogar aqui todas as opções de carro!
SqlMarcas999 = "SELECT * FROM combo2 ORDER BY id_combo2 DESC" 
...
'Abrimos todos os carros relativos a essa marca!
SqlCarros999 = "SELECT * FROM combo3 where id_combo2 =" & rsMarcas999("id_combo2")&" order by id_combo3 DESC"
