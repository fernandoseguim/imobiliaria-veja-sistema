...
<table width="590" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="590" height="20"> <div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong><a href="imprimir_imovel22.asp?varCod_imovel=<%=varCod_imovel%>" style="color:#000000">Ficha 
...
<div align="center"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif">Endere&ccedil;o 
  ...
  <tr>
    ...
    <td width="570" height="80"><table width="570" height="80" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="5">&nbsp;</td>
                <td width="480"> <p align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Declaro 
                    ter visitado e que tomei conhecimento da inten&ccedil;&atilde;o 
                    <br>
                    do propriet&aacute;rio em vender o im&oacute;vel de endere&ccedil;o 
                    acima, por<br>
                    interm&eacute;dio e indica&ccedil;&atilde;o da imobili&aacute;ria 
                    Veja Creci 11.676-J</strong></font> 
