...
<form name="doublecombo" onSubmit="return isValidDigitNumber(this);"   method="post" action="incluir_senha.asp">
          ...
          <tr>
            ...
            <td><table width="335" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="235" bgcolor="7B9AB9" style="border:1px solid #FFFFFF;"><input name="txt_nome" type="text" id="txt_nome" size="38" maxlength="50" align="left" class="inputBox" style="HEIGHT: 18px; WIDTH: 235px; background: <%=medio%>"></td>
                </tr>
				<tr>
                  ...
                  <td width="235" bgcolor="<%=claro%>" style="border:1px solid #FFFFFF;"><input name="txt_telefone" type="text" id="txt_telefone" size="38" maxlength="50" align="left" class="inputBox" style="HEIGHT: 18px; WIDTH: 235px; background: <%=claro%>"></td>
                </tr>
				<tr>
                  <td width="100" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;"> 
                    <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">email</font></div></td>
                  <td width="235" bgcolor="7B9AB9" style="border:1px solid #FFFFFF;"><input name="txt_email" type="text" id="txt_email" size="38" maxlength="50" align="left" class="inputBox" style="HEIGHT: 18px; WIDTH: 235px; background: <%=medio%>"></td>
                </tr>
				...
				<tr>
                  ...
                  <td width="235" bgcolor="7B9AB9" style="border:1px solid #FFFFFF;"><input name="txt_id" type="text" id="txt_id" size="38" maxlength="50" align="left" class="inputBox" style="HEIGHT: 18px; WIDTH: 235px; background: <%=claro%>"></td>
                </tr>
				
                <tr>
                  <td width="100" bgcolor="<%=medio%>" style="border:1px solid #FFFFFF;" > 
                    <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Senha</font></div></td>
                  <td width="235" bgcolor="#537497" style="border:1px solid #FFFFFF;"><input name="txt_senha" type="text" id="txt_senha" size="38" maxlength="50" align="left" class="inputBox" style="HEIGHT: 18px; WIDTH: 235px; background: <%=medio%>"></td>
                </tr>
				
				<tr>
                  <td width="100" bgcolor="<%=claro%>" style="border:1px solid #FFFFFF;" > 
                    <div align="center"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Permissão</font></div></td>
